...
/** Spring ↔ OSGi bridge for bulkimport ports. */
@Component
public class BulkImportOsgiServiceRegistrar implements InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() {
        try {
            ...
            final Object bundle = getBundle.invoke(null, BulkImportOsgiServiceRegistrar.class);
            if (bundle == null) {
                return;
            }
            ...
            LOG.warn("Failed to register bulkimport OSGi services: {}", ex.toString());
        }
    }
    ...
    private <T> void register(final Object context, final Class<T> type, final T service) throws ReflectiveOperationException {
        ...
        props.put("provider", "fineract-bulkimport-impl");
