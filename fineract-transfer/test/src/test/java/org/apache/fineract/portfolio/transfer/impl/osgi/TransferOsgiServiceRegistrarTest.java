...
class TransferOsgiServiceRegistrarTest {

    @Test
    @SuppressWarnings("unchecked")
    void afterPropertiesSet_withoutOsgi_doesNotThrow() {
        ObjectProvider<TransferWritePlatformService> w = mock(ObjectProvider.class);
        when(w.getIfAvailable()).thenReturn(null);
        var reg = new TransferOsgiServiceRegistrar(w);
