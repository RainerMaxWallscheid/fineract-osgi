...
public class CustomLoanAccountLockRepositoryImpl implements CustomLoanAccountLockRepository<LoanAccountLock> {
    ...
    public void updateLoanFromAccountLocks() {
        String sql = "UPDATE m_loan SET last_closed_business_date = (select " + databaseSpecificSQLGenerator.subDate("lck.lock_placed_on_cob_business_date", "1", "DAY") + """
    ...
    @java.lang.SuppressWarnings("all")
        public CustomLoanAccountLockRepositoryImpl(final DatabaseSpecificSQLGenerator databaseSpecificSQLGenerator) {
