...
@Service
public class LoanCobJobPortAdapter implements LoanCobJobPort {

    private final AccountLockService<LoanAccountLock> loanAccountLockService;

    public LoanCobJobPortAdapter(final AccountLockService<LoanAccountLock> loanAccountLockService) {
        this.loanAccountLockService = loanAccountLockService;
    }

    @Override
    public Tasklet unlockProcessedLoansTasklet() {
