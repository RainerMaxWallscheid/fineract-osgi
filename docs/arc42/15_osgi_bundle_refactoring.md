...
| **B6** | Optional polish | DS-only for pure extensions; tighten exports | **In progress** — `fineract-calendar-impl` empty catalog port is DS (`Service-Component`); Felix SCR is staged at start level 1. Loan/COB/security stay Spring-in-impl |
