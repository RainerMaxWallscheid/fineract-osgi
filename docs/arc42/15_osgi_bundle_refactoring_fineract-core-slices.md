...
| `fineract-interoperation` | **complete** (api/impl/test); Equinox no port (`InteropService` jakarta.validation + leftover unpublished savings types); `InteropIdentifier` entity residual savings-impl |
