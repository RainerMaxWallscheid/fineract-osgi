...
| infrastructure residual (pure) | jersey JSON converters/serializers, command JSON deserializers, performance sampling stack in core; app bootstrap configs stay on provider |
