...
| Wave 4 follow-up | **loan** + **progressive** + **WC** api/impl/test **complete** (entity residual); next = cob / security — see [15.6](15_osgi_bundle_refactoring.md#suggested-rollout-order-postcommand-pilot) | [ADR-022](decisions/ADR-022-osgi-api-impl-test-bundles-services.md) / [15](15_osgi_bundle_refactoring.md) |
