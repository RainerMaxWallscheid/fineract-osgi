...
| Wave 2 follow-up | **document** + **branch** api/impl/test **complete** (branch residual closed); next = loan-origination — see [15.6](15_osgi_bundle_refactoring.md#suggested-rollout-order-postcommand-pilot) | [ADR-022](decisions/ADR-022-osgi-api-impl-test-bundles-services.md) / [15](15_osgi_bundle_refactoring.md) |
