...
| [ADR-015](#815-adr-015--api-dtos-composition-statt-vererbung) | API-DTO Composition | accepted | Spezialisierte DTOs komponieren Shared-Felder; API bleibt flach |
...
## 8.15 ADR-015 – API-DTOs: Composition statt Vererbung
...
## 8.16 Verworfene / zurückgestellte Großoptionen
...
## 8.17 Entscheidungsmatrix vs. Qualitätsziele
...
## 8.18 Wie neue ADRs aufgenommen werden
...
## 8.19 Offene Entscheidungsbedarfe
...
## 8.20 Verwandte Gherkin-Features (ADR-Tags)
...
| ADR-015 DTO Composition | Unit: `*DtoCompositionTest`; IT: Interop/Deposit-API-Verträge unverändert flach |
