...
| Wave 4 follow-up | Domain Wave 4 **complete**; first **core slice** = businessdate (kernel `BusinessDateType` stays in core) — [core slices](15_osgi_bundle_refactoring_fineract-core-slices.md) | [ADR-022](decisions/ADR-022-osgi-api-impl-test-bundles-services.md) / [15](15_osgi_bundle_refactoring.md) |
