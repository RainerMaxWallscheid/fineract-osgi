...
| Loan → Client | **green** (client id column) |
| Loan → Group | **green** (group id column) |
| Savings → Client | **green** (client id column) |
| Savings → Group | **green** (group id column) |
| WC → Client | **green** (client id column) |
