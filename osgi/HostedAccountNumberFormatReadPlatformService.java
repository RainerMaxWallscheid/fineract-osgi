...
/** Composition-root hosted account-number formats for the Equinox bridge smoke. */
final class HostedAccountNumberFormatReadPlatformService implements AccountNumberFormatReadPlatformService {

    static final long HOSTED_ID = 1L;

    private final AccountNumberFormatData hosted = new AccountNumberFormatData(HOSTED_ID, new EnumOptionData(HOSTED_ID, "accountType.client",
            "CLIENT"), new EnumOptionData(HOSTED_ID, "hosted", "hosted"), "hosted");
    ...
    public AccountNumberFormatData getAccountNumberFormat(final Long id) {
        return Long.valueOf(HOSTED_ID).equals(id) ? hosted : null;
    }
