...
/** Composition-root hosted report-mailing config for the Equinox bridge smoke. */
final class HostedReportMailingJobConfigurationReadPlatformService implements ReportMailingJobConfigurationReadPlatformService {

    static final int HOSTED_ID = 1;
    static final String HOSTED_NAME = "hosted";

    private final ReportMailingJobConfigurationData hosted = ReportMailingJobConfigurationData.newInstance(HOSTED_ID, HOSTED_NAME, "hosted");
    ...
    public ReportMailingJobConfigurationData retrieveReportMailingJobConfiguration(final String name) {
        return HOSTED_NAME.equals(name) ? hosted : null;
    }
}
