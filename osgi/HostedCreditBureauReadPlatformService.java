...
/** Composition-root hosted credit-bureau catalog for the Equinox bridge smoke. */
final class HostedCreditBureauReadPlatformService implements CreditBureauReadPlatformService {

    static final long HOSTED_ID = 1L;

    @Override
    public Collection<CreditBureauData> retrieveCreditBureau() {
        return List.of(CreditBureauData.instance(HOSTED_ID, "hosted", "hosted", "hosted", "hosted", HOSTED_ID));
    }
}
