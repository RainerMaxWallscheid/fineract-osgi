...
**Consumers:** accounting / progressive / loan / WC → `-api` only; investor → no charge dep; savings still `-impl` (assemblers via `ChargeRepositoryWrapper`; account entity is chargeId).
