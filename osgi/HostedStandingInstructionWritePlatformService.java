...
/** Composition-root hosted standing-instruction writes for the Equinox bridge smoke. */
final class HostedStandingInstructionWritePlatformService implements StandingInstructionWritePlatformService {
    ...
    @Override
    public CommandProcessingResult update(final Long standingInstructionId, final JsonCommand command) {
        return CommandProcessingResult.resourceResult(HOSTED_ID);
    }
