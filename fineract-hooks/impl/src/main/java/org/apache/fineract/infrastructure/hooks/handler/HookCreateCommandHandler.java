...
public class HookCreateCommandHandler implements CommandHandler<HookCreateRequest, HookCreateResponse> {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(HookCreateCommandHandler.class);
    ...
    @java.lang.SuppressWarnings("all")
        public HookCreateCommandHandler(final HookWritePlatformService writePlatformService) {
