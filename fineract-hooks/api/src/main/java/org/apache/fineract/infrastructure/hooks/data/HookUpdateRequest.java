...
public class HookUpdateRequest implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
        public static class HookUpdateRequestBuilder {
        @java.lang.SuppressWarnings("all")
                private Long id;
        @java.lang.SuppressWarnings("all")
                private String name;
         ...
         */
        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest.HookUpdateRequestBuilder id(final Long id) {
            this.id = id;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest.HookUpdateRequestBuilder name(final String name) {
            this.name = name;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest.HookUpdateRequestBuilder isActive(final Boolean isActive) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest.HookUpdateRequestBuilder displayName(final String displayName) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest.HookUpdateRequestBuilder templateId(final Long templateId) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest.HookUpdateRequestBuilder events(final List<HookEventData> events) {
            this.events = events;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest.HookUpdateRequestBuilder config(final Map<String, String> config) {
            this.config = config;
            return this;
        }

        @java.lang.SuppressWarnings("all")
                public HookUpdateRequest build() {
            return new HookUpdateRequest(this.id, this.name, this.isActive, this.displayName, this.templateId, this.events, this.config);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
                public java.lang.String toString() {
            return "HookUpdateRequest.HookUpdateRequestBuilder(id=" + this.id + ", name=" + this.name + ", isActive=" + this.isActive + ", displayName=" + this.displayName + ", templateId=" + this.templateId + ", events=" + this.events + ", config=" + this.config + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
        public static HookUpdateRequest.HookUpdateRequestBuilder builder() {
        return new HookUpdateRequest.HookUpdateRequestBuilder();
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (!(o instanceof HookUpdateRequest)) return false;
        final HookUpdateRequest other = (HookUpdateRequest) o;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return other instanceof HookUpdateRequest;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
        return "HookUpdateRequest(id=" + this.getId() + ", name=" + this.getName() + ", isActive=" + this.getIsActive() + ", displayName=" + this.getDisplayName() + ", templateId=" + this.getTemplateId() + ", events=" + this.getEvents() + ", config=" + this.getConfig() + ")";
    }

    @java.lang.SuppressWarnings("all")
        public HookUpdateRequest() {
    }

    @java.lang.SuppressWarnings("all")
        public HookUpdateRequest(final Long id, final String name, final Boolean isActive, final String displayName, final Long templateId, final List<HookEventData> events, final Map<String, String> config) {
        this.id = id;
        this.name = name;
        this.isActive = isActive;
        this.displayName = displayName;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        public static final java.lang.String templateId = "templateId";
