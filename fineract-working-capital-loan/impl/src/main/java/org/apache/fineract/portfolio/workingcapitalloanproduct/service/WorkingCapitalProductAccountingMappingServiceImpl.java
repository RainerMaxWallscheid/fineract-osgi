...
public class WorkingCapitalProductAccountingMappingServiceImpl implements WorkingCapitalProductAccountingMappingService {
    ...
    public Map<String, GLAccountData> fetchAccountMappingDetails(final Long wcLoanProductId, final WorkingCapitalAccountingRuleType accountingRuleType) {
        ...
        final List<ProductToGLAccountMapping> mappings = this.accountMappingRepository.findAllRegularMappings(wcLoanProductId, PortfolioProductType.WORKING_CAPITAL_LOAN.getValue());
        for (final ProductToGLAccountMapping mapping : mappings) {
            ...
            switch (glAccountForLoan) {
                ...
                case TRANSFERS_SUSPENSE -> accountMappingDetails.put(LoanProductAccountingDataParams.TRANSFERS_SUSPENSE.getValue(), glAccountData);
                case INCOME_FROM_DISCOUNT_FEE -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_DISCOUNT_FEE.getValue(), glAccountData);
                case DEFERRED_INCOME_LIABILITY -> accountMappingDetails.put(LoanProductAccountingDataParams.DEFERRED_INCOME_LIABILITY.getValue(), glAccountData);
                case FEES_RECEIVABLE -> accountMappingDetails.put(LoanProductAccountingDataParams.FEES_RECEIVABLE.getValue(), glAccountData);
                case PENALTIES_RECEIVABLE -> accountMappingDetails.put(LoanProductAccountingDataParams.PENALTIES_RECEIVABLE.getValue(), glAccountData);
                case INCOME_FROM_FEES -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_FEES.getValue(), glAccountData);
                case INCOME_FROM_PENALTIES -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_PENALTIES.getValue(), glAccountData);
                case INCOME_FROM_RECOVERY -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_RECOVERY.getValue(), glAccountData);
                case LOSSES_WRITTEN_OFF -> accountMappingDetails.put(LoanProductAccountingDataParams.LOSSES_WRITTEN_OFF.getValue(), glAccountData);
                ...
                case INCOME_FROM_CHARGE_OFF_INTEREST -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_CHARGE_OFF_INTEREST.getValue(), glAccountData);
                case INCOME_FROM_CHARGE_OFF_FEES -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_CHARGE_OFF_FEES.getValue(), glAccountData);
                case INCOME_FROM_CHARGE_OFF_PENALTY -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_CHARGE_OFF_PENALTY.getValue(), glAccountData);
                case CHARGE_OFF_EXPENSE -> accountMappingDetails.put(LoanProductAccountingDataParams.CHARGE_OFF_EXPENSE.getValue(), glAccountData);
                case CHARGE_OFF_FRAUD_EXPENSE -> accountMappingDetails.put(LoanProductAccountingDataParams.CHARGE_OFF_FRAUD_EXPENSE.getValue(), glAccountData);
                case INCOME_FROM_GOODWILL_CREDIT_INTEREST -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_GOODWILL_CREDIT_INTEREST.getValue(), glAccountData);
                case INCOME_FROM_GOODWILL_CREDIT_FEES -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_GOODWILL_CREDIT_FEES.getValue(), glAccountData);
                case INCOME_FROM_GOODWILL_CREDIT_PENALTY -> accountMappingDetails.put(LoanProductAccountingDataParams.INCOME_FROM_GOODWILL_CREDIT_PENALTY.getValue(), glAccountData);
                default -> {
                }
            }
        }
    ...
    @java.lang.SuppressWarnings("all")
        public WorkingCapitalProductAccountingMappingServiceImpl(final WorkingCapitalLoanProductToGLAccountMappingHelper mappingHelper, final ProductToGLAccountMappingRepository accountMappingRepository, final FromJsonHelper fromApiJsonHelper) {
