...
public class StateTransitionWorkingCapitalLoanCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        final CommandProcessingResult commandProcessingResult = workingCapitalLoanApiResource.stateTransitionById(loanId, command, request.getBody());
    ...
    @java.lang.SuppressWarnings("all")
        public StateTransitionWorkingCapitalLoanCommandStrategy(final WorkingCapitalLoanApiResource workingCapitalLoanApiResource, final DefaultToApiJsonSerializer<CommandProcessingResult> toApiJsonSerializer) {
