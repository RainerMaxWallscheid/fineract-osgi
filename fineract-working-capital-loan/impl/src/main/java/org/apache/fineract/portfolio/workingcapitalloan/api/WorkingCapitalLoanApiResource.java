...
public class WorkingCapitalLoanApiResource {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PostWorkingCapitalLoansResponse.class)))})
    public CommandProcessingResult submitLoanApplication(@Parameter(hidden = true) final String apiRequestBodyAsJson) {
        final CommandWrapper commandRequest = new CommandWrapperBuilder().createWorkingCapitalLoanApplication().withJson(apiRequestBodyAsJson).build();
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PutWorkingCapitalLoansLoanIdResponse.class)))})
    public CommandProcessingResult modifyLoanApplicationById(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @QueryParam("command") @Parameter(description = "command") final String commandParam, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.DeleteWorkingCapitalLoansLoanIdResponse.class)))})
    public CommandProcessingResult deleteLoanApplication(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId) {
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PutWorkingCapitalLoansLoanIdRequest.class)))
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PutWorkingCapitalLoansLoanIdResponse.class)))})
    public CommandProcessingResult modifyLoanApplicationByExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId, @QueryParam("command") @Parameter(description = "command") final String commandParam, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.DeleteWorkingCapitalLoansLoanIdResponse.class)))})
    public CommandProcessingResult deleteLoanApplication(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId) {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.GetWorkingCapitalLoanDelinquencyRangeScheduleTagHistoryResponse.class))))})
    public List<WorkingCapitalLoanDelinquencyTagHistoryData> getDelinquencyRangeScheduleTagHistoryById(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @Context final UriInfo uriInfo) {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.GetWorkingCapitalLoanDelinquencyRangeScheduleTagHistoryResponse.class))))})
    public List<WorkingCapitalLoanDelinquencyTagHistoryData> getDelinquencyRangeScheduleTagHistoryById(@PathParam("externalId") @Parameter(description = "externalId", required = true) final String loanExternalId, @Context final UriInfo uriInfo) {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PostWorkingCapitalLoansLoanIdResponse.class)))})
    public CommandProcessingResult stateTransitionById(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @QueryParam("command") @Parameter(description = "command", required = true) final String commandParam, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    private CommandProcessingResult modifyLoanApplication(final Long loanId, final String loanExternalIdStr, final String apiRequestBodyAsJson) {
        ...
        final CommandWrapper commandRequest = new CommandWrapperBuilder().withJson(apiRequestBodyAsJson).withLoanId(resolvedLoanId).updateWorkingCapitalLoanApplication().build();
        return this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    }
    ...
    private CommandProcessingResult deleteLoanApplication(final Long loanId, final String loanExternalIdStr) {
        ...
        final CommandWrapper commandRequest = new CommandWrapperBuilder().withLoanId(resolvedLoanId).deleteWorkingCapitalLoanApplication().build();
        return this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    }

    private CommandProcessingResult handleStateTransition(final Long loanId, final String loanExternalIdStr, final String commandParam, final String apiRequestBodyAsJson) {
        final Long resolvedLoanId = loanId != null ? loanId : readPlatformService.getResolvedLoanId(ExternalIdFactory.produce(loanExternalIdStr));
        if (resolvedLoanId == null) {
            throw new WorkingCapitalLoanNotFoundException(ExternalIdFactory.produce(loanExternalIdStr));
        }
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PutWorkingCapitalLoansLoanIdResponse.class)))})
    public CommandProcessingResult updateDiscountById(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PutWorkingCapitalLoansLoanIdDiscountRequest.class)))
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PutWorkingCapitalLoansLoanIdResponse.class)))})
    public CommandProcessingResult updateDiscountByExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    private CommandProcessingResult updateDiscount(final Long loanId, final String loanExternalIdStr, final String apiRequestBodyAsJson) {
        ...
        final CommandWrapper commandRequest = new CommandWrapperBuilder().withJson(apiRequestBodyAsJson).updateDiscountWorkingCapitalLoanApplication(resolvedLoanId).build();
        return this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    }
    ...
    public CommandProcessingResult updatePeriodPaymentRateById(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = WorkingCapitalLoanApiResourceSwagger.PutWorkingCapitalLoansLoanIdRateRequest.class)))
    public CommandProcessingResult updatePeriodPaymentRateByExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
        return updatePeriodPaymentRate(null, loanExternalId, apiRequestBodyAsJson);
    }

    private CommandProcessingResult updatePeriodPaymentRate(final Long loanId, final String loanExternalIdStr, final String apiRequestBodyAsJson) {
        final Long resolvedLoanId = loanId != null ? loanId : readPlatformService.getResolvedLoanId(ExternalIdFactory.produce(loanExternalIdStr));
        if (resolvedLoanId == null) {
            throw new WorkingCapitalLoanNotFoundException(ExternalIdFactory.produce(loanExternalIdStr));
        }
        final CommandWrapper commandRequest = new CommandWrapperBuilder().withJson(apiRequestBodyAsJson).updatePeriodPaymentRateWorkingCapitalLoanApplication(resolvedLoanId).build();
        return this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
    }
    ...
    @java.lang.SuppressWarnings("all")
        public WorkingCapitalLoanApiResource(final PlatformSecurityContext context, final WorkingCapitalLoanApplicationReadPlatformService readPlatformService, final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService, final WorkingCapitalLoanDelinquencyReadPlatformService workingCapitalLoanDelinquencyReadPlatformService, final WorkingCapitalLoanPeriodPaymentRateChangeReadService rateChangeReadService) {
        ...
        this.rateChangeReadService = rateChangeReadService;
    }
}
