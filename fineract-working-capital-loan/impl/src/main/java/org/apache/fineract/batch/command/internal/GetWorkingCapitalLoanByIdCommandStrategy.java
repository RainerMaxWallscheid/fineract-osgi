...
public class GetWorkingCapitalLoanByIdCommandStrategy implements CommandStrategy {
    ...
    @java.lang.SuppressWarnings("all")
        public GetWorkingCapitalLoanByIdCommandStrategy(final WorkingCapitalLoanApiResource workingCapitalLoanApiResource, final DefaultToApiJsonSerializer<CommandProcessingResult> toApiJsonSerializer) {
