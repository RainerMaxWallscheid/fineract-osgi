...
public class WorkingCapitalLoanTransactionsApiResource {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanTransactionsApiResourceSwagger.GetWorkingCapitalLoanTransactionsResponse.class)))})
    public Page<WorkingCapitalLoanTransactionData> retrieveTransactionsByLoanId(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @Parameter(hidden = true) @Pagination final Pageable pageable) {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanTransactionsApiResourceSwagger.GetWorkingCapitalLoanTransactionsResponse.class)))})
    public Page<WorkingCapitalLoanTransactionData> retrieveTransactionsByExternalLoanId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId, @Parameter(hidden = true) @Pagination final Pageable pageable) {
        this.context.authenticatedUser().validateHasReadPermission(RESOURCE_NAME_FOR_PERMISSIONS);
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanTransactionsApiResourceSwagger.GetWorkingCapitalLoanTransactionIdResponse.class)))})
    public WorkingCapitalLoanTransactionData retrieveTransactionByLoanIdAndTransactionId(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @PathParam("transactionId") @Parameter(description = "transactionId", required = true) final Long transactionId) {
        this.context.authenticatedUser().validateHasReadPermission(RESOURCE_NAME_FOR_PERMISSIONS);
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanTransactionsApiResourceSwagger.GetWorkingCapitalLoanTransactionIdResponse.class)))})
    public WorkingCapitalLoanTransactionData retrieveTransactionByLoanIdAndTransactionExternalId(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @PathParam("externalTransactionId") @Parameter(description = "externalTransactionId", required = true) final String externalTransactionId) {
        this.context.authenticatedUser().validateHasReadPermission(RESOURCE_NAME_FOR_PERMISSIONS);
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanTransactionsApiResourceSwagger.GetWorkingCapitalLoanTransactionIdResponse.class)))})
    public WorkingCapitalLoanTransactionData retrieveTransactionByExternalLoanIdAndTransactionId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId, @PathParam("transactionId") @Parameter(description = "transactionId", required = true) final Long transactionId) {
        this.context.authenticatedUser().validateHasReadPermission(RESOURCE_NAME_FOR_PERMISSIONS);
    ...
    public WorkingCapitalLoanTransactionData retrieveTransactionByExternalLoanIdAndTransactionExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId, @PathParam("externalTransactionId") @Parameter(description = "externalTransactionId", required = true) final String externalTransactionId) {
        this.context.authenticatedUser().validateHasReadPermission(RESOURCE_NAME_FOR_PERMISSIONS);
        return this.transactionReadPlatformService.retrieveTransaction(ExternalIdFactory.produce(loanExternalId), ExternalIdFactory.produce(externalTransactionId));
    }
    ...
    public WorkingCapitalLoanCommandTemplateData retrieveWorkingCapitalLoanTemplate(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @QueryParam("templateType") @Parameter(description = "templateType") final String templateType, @Context final UriInfo uriInfo) {
        this.context.authenticatedUser().validateHasReadPermission(RESOURCE_NAME_FOR_PERMISSIONS);
        return handleLoanTransactionTemplate(loanId, null, templateType);
    }

    private WorkingCapitalLoanCommandTemplateData handleLoanTransactionTemplate(final Long loanId, final String loanExternalIdStr, final String templateType) {
        final Long resolvedLoanId = resolveLoanId(loanId, loanExternalIdStr);
        final WorkingCapitalLoanCommandTemplateData loanTransactionTemplateData = transactionReadPlatformService.retrieveLoanTransactionTemplate(resolvedLoanId, templateType);
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanTransactionsApiResourceSwagger.PostWorkingCapitalLoanTransactionsResponse.class)))})
    public CommandProcessingResult executeLoanTransactionById(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId, @QueryParam("command") @Parameter(description = "command", required = true) final String commandParam, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    private CommandProcessingResult executeTransaction(final Long loanId, final String loanExternalIdStr, final String commandParam, final String apiRequestBodyAsJson) {
        final Long resolvedLoanId = resolveLoanId(loanId, loanExternalIdStr);
    ...
    private Long resolveLoanId(Long loanId, String loanExternalId) {
        final Long resolvedLoanId = loanId != null ? loanId : loanReadPlatformService.getResolvedLoanId(ExternalIdFactory.produce(loanExternalId));
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanTransactionsApiResourceSwagger.ExecuteWorkingCapitalLoanTransactionCommandResponse.class)))})
    ...
    public CommandProcessingResult executeWorkingCapitalLoanTransactionCommandByLoanExternalIdTransactionExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId, @PathParam("transactionExternalId") @Parameter(description = "transactionExternalId", required = true) final String transactionExternalId, @QueryParam("command") @Parameter(description = "command", required = true) final String command, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
        return executeWorkingCapitalLoanTransactionCommand(null, loanExternalId, null, transactionExternalId, command, apiRequestBodyAsJson);
    }

    private CommandProcessingResult executeWorkingCapitalLoanTransactionCommand(Long loanId, String loanExternalId, Long transactionId, String transactionExternalId, String command, String apiRequestBodyAsJson) {
    ...
    private Long resolveTransactionId(Long loanId, Long transactionId, String transactionExternalId) {
        ...
        return transactionRepository.findByWcLoan_IdAndExternalId(loanId, externalId).map(WorkingCapitalLoanTransaction::getId).orElseThrow(() -> new WorkingCapitalLoanTransactionNotFoundException(externalId));
    }

    @java.lang.SuppressWarnings("all")
        public WorkingCapitalLoanTransactionsApiResource(final PlatformSecurityContext context, final WorkingCapitalLoanApplicationReadPlatformService loanReadPlatformService, final WorkingCapitalLoanTransactionReadPlatformService transactionReadPlatformService, final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService, final WorkingCapitalLoanTransactionRepository transactionRepository) {
