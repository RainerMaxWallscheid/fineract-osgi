...
public class GetWorkingCapitalLoanTransactionByLoanIdAndExternalTransactionIdCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        final WorkingCapitalLoanTransactionData workingCapitalLoanTransactionData = workingCapitalLoanTransactionsApiResource.retrieveTransactionByLoanIdAndTransactionExternalId(loanId, transactionExternalId);
    ...
    @java.lang.SuppressWarnings("all")
        public GetWorkingCapitalLoanTransactionByLoanIdAndExternalTransactionIdCommandStrategy(final WorkingCapitalLoanTransactionsApiResource workingCapitalLoanTransactionsApiResource, final DefaultToApiJsonSerializer<CommandProcessingResult> toApiJsonSerializer) {
