...
public class WorkingCapitalLoanChargesApiResource {
    ...
    @ApiResponse(responseCode = "200", description = "OK", useReturnTypeSchema = true)
    public WorkingCapitalLoanChargeData retrieveTemplate(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId) {
    ...
    public CommandProcessingResult createLoanCharge(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = WorkingCapitalLoanChargesApiResourceSwagger.PostLoansLoanIdChargesRequest.class)))
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanChargesApiResourceSwagger.PostLoansLoanIdChargesResponse.class)))
    public CommandProcessingResult executeLoanCharge(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanChargesApiResourceSwagger.PostWorkingCapitalLoansLoanIdChargesChargeIdResponse.class)))
    public CommandProcessingResult adjustLoanChargeByLoanExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @PathParam("loanChargeId") @Parameter(description = "loanChargeId") final Long loanChargeId, @QueryParam("command") @DefaultValue("") @Parameter(description = "command") final String commandParam, @RequestBody(required = true, content = @Content(schema = @Schema(implementation = WorkingCapitalLoanChargesApiResourceSwagger.PostWorkingCapitalLoansLoanIdChargesChargeIdRequest.class))) final String apiRequestBodyAsJson) {
    ...
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = WorkingCapitalLoanChargesApiResourceSwagger.PostWorkingCapitalLoansLoanIdChargesChargeIdResponse.class)))
    public CommandProcessingResult adjustLoanChargeByLoanAndChargeExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @PathParam("loanChargeExternalId") @Parameter(description = "loanChargeExternalId") final String loanChargeExternalId, @QueryParam("command") @DefaultValue("") @Parameter(description = "command") final String commandParam, @RequestBody(required = true, content = @Content(schema = @Schema(implementation = WorkingCapitalLoanChargesApiResourceSwagger.PostWorkingCapitalLoansLoanIdChargesChargeIdRequest.class))) final String apiRequestBodyAsJson) {
    ...
    @ApiResponse(responseCode = "200", description = "OK", useReturnTypeSchema = true)
    public List<WorkingCapitalLoanChargeData> retrieveAllLoanCharges(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId, @Context final UriInfo uriInfo) {
    ...
    @ApiResponse(responseCode = "200", description = "OK", useReturnTypeSchema = true)
    public List<WorkingCapitalLoanChargeData> retrieveAllLoanCharges(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @Context final UriInfo uriInfo) {
    ...
    @Path("{loanId}/charges/{loanChargeId}")
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a Loan Charge", description = "Retrieves Loan Charge according to the Loan ID and Loan Charge ID" + "Example Requests:\n" + "\n" + "/loans/1/charges/1\n" + "\n" + "\n" + "/loans/1/charges/1?fields=name,amountOrPercentage")
    @ApiResponse(responseCode = "200", description = "OK", useReturnTypeSchema = true)
    public WorkingCapitalLoanChargeData retrieveWorkingCapitalLoanCharge(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId, @PathParam("loanChargeId") @Parameter(description = "loanChargeId") final Long loanChargeId) {
    ...
    @Path("{loanId}/charges/external-id/{loanChargeExternalId}")
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a Loan Charge", operationId = "retrieveWorkingCapitalLoanChargeByChargeExternalId", description = "Retrieves Loan Charge according to the Loan ID and Loan Charge External ID" + "Example Requests:\n" + "\n" + "/loans/1/charges/1\n" + "\n" + "\n" + "/loans/1/charges/external-id/1?fields=name,amountOrPercentage")
    @ApiResponse(responseCode = "200", description = "OK", useReturnTypeSchema = true)
    public WorkingCapitalLoanChargeData retrieveWorkingCapitalLoanCharge(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId, @PathParam("loanChargeExternalId") @Parameter(description = "loanChargeExternalId") final String loanChargeExternalId) {
    ...
    @Path("external-id/{loanExternalId}/charges/{loanChargeId}")
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a Loan Charge", operationId = "retrieveWorkingCapitalLoanChargeByLoanExternalId", description = "Retrieves Loan Charge according to the Loan external ID and Loan Charge ID" + "Example Requests:\n" + "\n" + "/loans/1/charges/1\n" + "\n" + "\n" + "/loans/1/charges/1?fields=name,amountOrPercentage")
    @ApiResponse(responseCode = "200", description = "OK", useReturnTypeSchema = true)
    public WorkingCapitalLoanChargeData retrieveWorkingCapitalLoanCharge(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @PathParam("loanChargeId") @Parameter(description = "loanChargeId") final Long loanChargeId) {
    ...
    @Path("external-id/{loanExternalId}/charges/external-id/{loanChargeExternalId}")
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a Loan Charge", operationId = "retrieveWorkingCapitalLoanChargeByLoanAndChargeExternalId", description = "Retrieves Loan Charge according to the Loan External ID and Loan Charge External ID" + "Example Requests:\n" + "\n" + "/loans/1/charges/1\n" + "\n" + "\n" + "/loans/1/charges/1?fields=name,amountOrPercentage")
    @ApiResponse(responseCode = "200", description = "OK", useReturnTypeSchema = true)
    public WorkingCapitalLoanChargeData retrieveWorkingCapitalLoanCharge(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @PathParam("loanChargeExternalId") @Parameter(description = "loanChargeExternalId") final String loanChargeExternalId) {
        return retrieveWorkingCapitalLoanCharge(null, loanExternalId, null, loanChargeExternalId);
    }

    private WorkingCapitalLoanChargeData retrieveWorkingCapitalLoanCharge(final Long loanId, final String loanExternalIdStr, final Long loanChargeId, final String loanChargeExternalIdStr) {
    ...
    private List<WorkingCapitalLoanChargeData> retrieveAllLoanCharges(final Long loanId, final String loanExternalIdStr, final UriInfo uriInfo) {
        securityContext.authenticatedUser().validateHasReadPermission(WorkingCapitalLoanConstants.WCL_RESOURCE_NAME);
        ExternalId loanExternalId = ExternalIdFactory.produce(loanExternalIdStr);
        Long resolvedLoanId = loanId == null ? workingCapitalLoanRepository.findIdByExternalId(loanExternalId) : loanId;
    ...
    private CommandProcessingResult handleExecuteLoanCharge(final Long loanId, final String loanExternalIdStr, final String commandParam, final String apiRequestBodyAsJson) {
        ExternalId loanExternalId = ExternalIdFactory.produce(loanExternalIdStr);
        Long resolvedLoanId = loanId == null ? workingCapitalLoanRepository.findIdByExternalId(loanExternalId) : loanId;
        final CommandWrapper commandRequest = new CommandWrapperBuilder().createWorkingCapitalLoanCharge(resolvedLoanId).withJson(apiRequestBodyAsJson).build();
        return commandsSourceWritePlatformService.logCommandSource(commandRequest);
    }

    private CommandProcessingResult handleExecuteLoanChargeWithChargeId(final Long loanId, final String loanExternalIdStr, final Long loanChargeId, final String loanChargeExternalIdStr, final String commandParam, final String apiRequestBodyAsJson) {
        ...
        final Long resolvedLoanChargeId = loanChargeId == null ? loanChargeRepository.findIdByExternalId(loanChargeExternalId) : loanChargeId;
        if (!CommandParameterUtil.is(commandParam, WorkingCapitalLoanChargeConstants.ADJUSTMENT_LOAN_CHARGE_COMMAND)) {
            throw new UnrecognizedQueryParamException("command", commandParam);
        }
        final CommandWrapper commandRequest = new CommandWrapperBuilder().adjustmentForWorkingCapitalLoanCharge(resolvedLoanId, resolvedLoanChargeId).withJson(apiRequestBodyAsJson).build();
        return commandsSourceWritePlatformService.logCommandSource(commandRequest);
    }

    @java.lang.SuppressWarnings("all")
        public WorkingCapitalLoanChargesApiResource(final WorkingCapitalLoanRepository workingCapitalLoanRepository, final ChargeReadPlatformService chargeReadPlatformService, final PlatformSecurityContext securityContext, final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService, final WorkingCapitalLoanChargeReadPlatformService loanChargeReadPlatformService, final WorkingCapitalLoanChargeRepository loanChargeRepository) {
