...
public class WorkingCapitalLoanDelinquencyActionData {
    ...
    @java.lang.SuppressWarnings("all")
        public WorkingCapitalLoanDelinquencyActionData(final Long id, final DelinquencyAction action, final LocalDate startDate, final LocalDate endDate, final LocalDate effectiveEndDate, final BigDecimal minimumPayment, final DelinquencyMinimumPaymentType minimumPaymentType, final Integer frequency, final DelinquencyFrequencyType frequencyType) {
        this.id = id;
        this.action = action;
