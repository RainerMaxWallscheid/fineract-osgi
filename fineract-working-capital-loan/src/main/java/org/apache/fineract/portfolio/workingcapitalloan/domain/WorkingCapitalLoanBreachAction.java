...
public class WorkingCapitalLoanBreachAction extends AbstractAuditableWithUTCDateTimeCustom<Long> {
    ...
    @java.lang.SuppressWarnings("all")
        public WorkingCapitalLoanBreachActionType getAction() {
        return this.action;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public WorkingCapitalBreachAmountCalculationType getMinimumPaymentType() {
    ...
    @java.lang.SuppressWarnings("all")
        public void setAction(final WorkingCapitalLoanBreachActionType action) {
        this.action = action;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public void setMinimumPaymentType(final WorkingCapitalBreachAmountCalculationType minimumPaymentType) {
    ...
    @java.lang.SuppressWarnings("all")
        public WorkingCapitalLoanBreachAction() {
    }
}
