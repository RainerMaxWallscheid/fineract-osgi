...
public enum WorkingCapitalPaymentAllocationType implements ApiFacingEnum<WorkingCapitalPaymentAllocationType> {
    ...
    @java.lang.SuppressWarnings("all")
        private WorkingCapitalPaymentAllocationType(final DueType dueType, final AllocationType allocationType, final String code, final String humanReadableName) {
