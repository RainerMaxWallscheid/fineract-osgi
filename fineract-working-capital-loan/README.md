...
| `fineract-working-capital-loan-impl` | `impl/` | `org.apache.fineract.workingcapitalloan.impl` | Domain, COB, catch-up residual; Equinox `WorkingCapitalLoanOsgiBundleActivator` |
