...
Feature: Working Capital Loan Credit Balance Refund
  ...
  Scenario: Verify working capital loan credit balance refund - partial refund keeps OVERPAID
    ...
    When Customer makes credit balance refund on "20260103" with 50.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
  ...
  Scenario: Verify working capital loan credit balance refund - non-overpaid loan returns 400
    ...
    When Admin sets the business date to "20260102"
    And Initiating a credit balance refund on "20260102" with 10.0 transaction amount on Working Capital loan results an error with the following data:
  ...
  Scenario: Verify working capital loan credit balance refund - payment details are accepted
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    When Customer makes credit balance refund on "20260103" with 25.0 transaction amount on Working Capital loan with the following payment details:
    ...
    And Customer makes credit balance refund on "20260103" with 25.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
  ...
  Scenario: Verify working capital loan credit balance refund - refund amount greater than overpayment returns 400
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Initiating a credit balance refund on "20260103" with 200.0 transaction amount on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                                                        |
      | 400                | Credit balance refund amount cannot exceed overpayment amount        |
    And Customer makes credit balance refund on "20260103" with 100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
  ...
  Scenario: Verify working capital loan credit balance refund - future transaction date returns 400
    ...
    And Customer makes repayment on "20260102" with 9100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Initiating a credit balance refund on "20260115" with 50.0 transaction amount on Working Capital loan results an error with the following data:
      | HTTP response code | Error message           |
      | 400                | cannot.be.a.future.date |
    And Customer makes credit balance refund on "20260102" with 100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
  ...
  Scenario: Verify that a credit balance refund equal to the exact overpayment amount closes the loan
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260102"
    And Customer makes repayment on "20260102" with 9075.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Customer makes credit balance refund on "20260103" with 75.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
  ...
  Scenario: Verify that multiple partial repayments exceeding total payable accumulate into a single overpayment balance
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260102"
    And Customer makes repayment on "20260102" with 3000.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "ACTIVE"
    And Customer makes repayment on "20260102" with 3000.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "ACTIVE"
    And Customer makes repayment on "20260102" with 3200.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance overpaymentAmount is "200.00"
    When Admin sets the business date to "20260103"
    And Customer makes credit balance refund on "20260103" with 200.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
  ...
  Scenario: Verify that a credit balance refund with a valid classification is persisted and exposes the classification on the transaction
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Customer makes credit balance refund on "20260103" with 50.0 transaction amount on Working Capital loan with valid classification "REFUND_TO_CUSTOMER"
  ...
  Scenario: Verify that a credit balance refund with a non-existent classificationId is rejected
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Initiating a credit balance refund on "20260103" with 50.0 transaction amount on Working Capital loan with classificationId 999999999 results an error with the following data:
      | HTTP response code | Error message                                                                                                     |
  ...
  Scenario Outline: Verify that a credit balance refund cannot be initiated on a non-OVERPAID loan
    ...
    When Admin sets the business date to "20260103"
    And Initiating a credit balance refund on "20260103" with 50.0 transaction amount on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                                            |
      | 400                | Credit balance refund is allowed only for overpaid loans |
    Examples:
      | status                          |
  ...
  Scenario: Verify that a credit balance refund with zero transaction amount is rejected
    ...
    And Customer makes repayment on "20260102" with 9100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Initiating a credit balance refund on "20260102" with 0.0 transaction amount on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                                         |
  ...
  Scenario: Verify that a credit balance refund with transaction date before disbursal date is rejected
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP        | 20260110 | 20260110          | 9000            | 100000       | 18                | 0        |
    And Admin successfully approves the working capital loan on "20260110" with "9000" amount and expected disbursement date on "20260110"
    And Admin successfully disburse the Working Capital loan on "20260110" with "9000" EUR transaction amount
    When Admin sets the business date to "20260111"
    And Customer makes repayment on "20260111" with 9100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Initiating a credit balance refund on "20260109" with 50.0 transaction amount on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                   |
  ...
  Scenario: Verify that a credit balance refund cannot be repeated after the loan has been closed via full refund
    ...
    And Customer makes credit balance refund on "20260103" with 100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
    And Initiating a credit balance refund on "20260103" with 10.0 transaction amount on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                                            |
      | 400                | Credit balance refund is allowed only for overpaid loans |
  ...
  @TestRailId:C76677
    ...
    And Customer makes repayment on "20260102" with 9100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Initiating a credit balance refund on "20260102" with 50.0 transaction amount and note of length 1001 on Working Capital loan results an error with the following data:
      | HTTP response code | Error message      |
  ...
  Scenario: Verify that a credit balance refund with a valid note within the allowed length is accepted
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Customer makes credit balance refund on "20260103" with 50.0 transaction amount on Working Capital loan with note "Partial CBR for customer #123"
    Then Working Capital loan status will be "OVERPAID"
  ...
  Scenario: Verify that the transaction template endpoint for creditBalanceRefund returns the current overpayment as expectedAmount
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260102"
    And Customer makes repayment on "20260102" with 9250.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
  ...
  Scenario: Verify that the credit balance refund transaction is stored with CREDIT_BALANCE_REFUND type and the provided externalId
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Customer makes credit balance refund on "20260103" with 50.0 transaction amount and externalId "wcl-cbr-ext-001" on Working Capital loan
  ...
  Scenario: Verify that reusing an externalId across two working capital loans for credit balance refund is rejected
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Customer makes credit balance refund on "20260103" with 50.0 transaction amount and externalId "wcl-cbr-shared-001" on Working Capital loan
    When Admin sets the business date to "20260101"
    And Admin creates a client with random data
    And Admin creates a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
    ...
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260103"
    And Initiating a credit balance refund on "20260103" with 50.0 transaction amount and externalId "wcl-cbr-shared-001" on Working Capital loan results an error with the following data:
      | HTTP response code | Error message  |
      | 400                | already.exists |
