...
Feature: Reporting
  ...
  Scenario: Verify Transaction Summary Reports contain all buydown fee transaction types
    ...
    And Admin sets the business date to "20240131"
    And Admin runs inline COB job for Loan
    And Admin sets the business date to "20240201"
    And Admin runs inline COB job for Loan
    And Admin adds buy down fee adjustment with "AUTOPAY" payment type to the loan on "20240201" with "10" EUR transaction amount
    And Admin sets the business date to "20240202"
    And Admin adds buy down fee adjustment of buy down fee transaction made on "20240101" with "AUTOPAY" payment type to the loan on "20240110" with "25" EUR transaction amount
    And Admin runs inline COB job for Loan
#    --- Transaction Summary Report ---
    Then Transaction Summary Report for date "20240101" has the following data:
    ...
    And Transaction Summary Report for date "20240131" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
    ...
    And Transaction Summary Report for date "20240201" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name                 | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
...
#   --- Transaction Summary Report with Asset Owner ---
    And Transaction Summary Report with Asset Owner for date "20240101" has the following data:
      ...
      | 2024-01-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Disbursement         |                  |            | 0        | Principal                |                      | 100.0              |                |                     |
      | 2024-01-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Disbursement         |                  |            | 0        | Unallocated Credit (UNC) |                      | 0.0                |                |                     |
    And Transaction Summary Report with Asset Owner for date "20240131" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount | Asset_owner_id | From_asset_owner_id |
      | 2024-01-31      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Apply Charges             |                  |            | 0        | Interest                 |                      |                    |                |                     |
      | 2024-01-31      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Fees                     |                      | 0.0                |                |                     |
      | 2024-01-31      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Interest                 |                      | 0.55               |                |                     |
      ...
      | 2024-01-31      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Principal                |                      | 0.0                |                |                     |
      | 2024-01-31      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Unallocated Credit (UNC) |                      | 0.0                |                |                     |
    And Transaction Summary Report with Asset Owner for date "20240201" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name                 | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount | Asset_owner_id | From_asset_owner_id |
      | 2024-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Apply Charges                        |                  |            | 0        | Interest                 |                      |                    |                |                     |
      | 2024-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Adjustment              | AUTOPAY          |            | 0        | Fees                     |                      | 0.0                |                |                     |
      | 2024-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Adjustment              | AUTOPAY          |            | 0        | Interest                 |                      | -10.0              |                |                     |
...
#    --- Transaction Summary Report with Asset Owner ---
  ...
  Scenario: Verify Transaction Summary Reports with Buydown fee - happy path
    ...
    And Admin creates a fully customized loan with the following data:
      | LoanProduct                                              | submitted on date | with Principal | ANNUAL interest rate % | interest type     | interest calculation period | amortization type  | loanTermFrequency | loanTermFrequencyType | repaymentEvery | repaymentFrequencyType | numberOfRepayments | graceOnPrincipalPayment | graceOnInterestPayment | interest free period | Payment strategy            |
      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | 20260201  | 100            | 7                      | DECLINING_BALANCE | DAILY                       | EQUAL_INSTALLMENTS | 6                 | MONTHS                | 1              | MONTHS                 | 6                  | 0                       | 0                      | 0                    | ADVANCED_PAYMENT_ALLOCATION |
    And Admin successfully approves the loan on "20260201" with "100" amount and expected disbursement date on "20260201"
    And Admin successfully disburse the loan on "20260201" with "100" EUR transaction amount
    And Admin adds buy down fee with "AUTOPAY" payment type to the loan on "20260201" with "50" EUR transaction amount
    And Admin sets the business date to "20260202"
    And Admin runs inline COB job for Loan
    And Admin sets the business date to "20260203"
    And Admin runs inline COB job for Loan
    And Admin adds buy down fee adjustment with "AUTOPAY" payment type to the loan on "20260203" with "25" EUR transaction amount
    And Admin sets the business date to "20260204"
    And Admin runs inline COB job for Loan
    And Admin sets the business date to "20260205"
    And Admin runs inline COB job for Loan
#    --- Transaction Summary Report with Asset Owner ---
    Then Transaction Summary Report with Asset Owner for date "20260201" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
    ...
    And Transaction Summary Report with Asset Owner for date "20260202" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
    ...
    And Transaction Summary Report with Asset Owner for date "20260203" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
...
#    --- Transaction Summary Report ---
    And Transaction Summary Report for date "20260201" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
      | 2026-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee              | AUTOPAY          |            | 0        | Fees                     |                      | 0.0                |
      | 2026-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee              | AUTOPAY          |            | 0        | Interest                 |                      | 50.0               |
      | 2026-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee              | AUTOPAY          |            | 0        | Penalty                  |                      | 0.0                |
      ...
      | 2026-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Disbursement              | AUTOPAY          |            | 0        | Principal                |                      | 100.0              |
      | 2026-02-01      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Disbursement              | AUTOPAY          |            | 0        | Unallocated Credit (UNC) |                      | 0.0                |
    And Transaction Summary Report for date "20260202" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
      | 2026-02-02      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Apply Charges             |                  |            | 0        | Interest                 |                      | 0.02               |
      | 2026-02-02      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Fees                     |                      | 0.0                |
      | 2026-02-02      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Interest                 |                      | 0.27               |
      ...
      | 2026-02-02      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Principal                |                      | 0.0                |
      | 2026-02-02      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization |                  |            | 0        | Unallocated Credit (UNC) |                      | 0.0                |
    And Transaction Summary Report for date "20260203" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
      | 2026-02-03      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Apply Charges             |                  |            | 0        | Interest                 |                      | 0.02               |
      | 2026-02-03      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Adjustment   | AUTOPAY          |            | 0        | Fees                     |                      | 0.0                |
      | 2026-02-03      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Adjustment   | AUTOPAY          |            | 0        | Interest                 |                      | -25.0              |
  ...
  Scenario: Verify Transaction Summary Report with Asset Owner contain correct originator_external_ids column
    ...
    And Admin creates a new default Loan with date: "20250101"
    ...
    Then Transaction Summary Report with Asset Owner for date "20250101" column "Originator_External_Ids" has non-empty value for all rows
    And Transaction Summary Report with Asset Owner for date "20250101" column "From_asset_owner_id" has empty value for all rows
    And Transaction Summary Report with Asset Owner for date "20250101" column "Asset_owner_id" has empty value for all rows
  ...
  Scenario: Verify Transaction Summary Report with Asset Owner - UC01: Buydown fee amortization with multiple buydown fees should not duplicate
    ...
    And Admin creates a fully customized loan with the following data:
      | LoanProduct                                              | submitted on date | with Principal | ANNUAL interest rate % | interest type     | interest calculation period | amortization type  | loanTermFrequency | loanTermFrequencyType | repaymentEvery | repaymentFrequencyType | numberOfRepayments | graceOnPrincipalPayment | graceOnInterestPayment | interest free period | Payment strategy            |
      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | 20260101   | 100            | 12                     | DECLINING_BALANCE | DAILY                       | EQUAL_INSTALLMENTS | 100               | DAYS                  | 25             | DAYS                   | 4                  | 0                       | 0                      | 0                    | ADVANCED_PAYMENT_ALLOCATION |
    ...
    And Admin sets the business date to "20260102"
    And Admin runs inline COB job for Loan
    And Admin adds buy down fee with "AUTOPAY" payment type to the loan on "20260102" with "50" EUR transaction amount
    And Admin sets the business date to "20260103"
    And Admin runs inline COB job for Loan
    And Admin adds buy down fee with "AUTOPAY" payment type to the loan on "20260103" with "25" EUR transaction amount
    And Admin sets the business date to "20260104"
    And Admin runs inline COB job for Loan
    And Admin sets the business date to "20260105"
    And Admin runs inline COB job for Loan
    Then Transaction Summary Report with Asset Owner for date "20260102" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
    ...
    Then Transaction Summary Report with Asset Owner for date "20260103" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
    ...
    Then Transaction Summary Report with Asset Owner for date "20260104" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
  ...
  Scenario: Verify Transaction Summary Report with Asset Owner - UC02: Buydown fee amortization with FEE_INCOME allocation type should not duplicate
    ...
    And Admin creates a fully customized loan with the following data:
      | LoanProduct                                                         | submitted on date | with Principal | ANNUAL interest rate % | interest type     | interest calculation period | amortization type  | loanTermFrequency | loanTermFrequencyType | repaymentEvery | repaymentFrequencyType | numberOfRepayments | graceOnPrincipalPayment | graceOnInterestPayment | interest free period | Payment strategy            |
      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES_FEE_INCOME | 20260101   | 100            | 12                     | DECLINING_BALANCE | DAILY                       | EQUAL_INSTALLMENTS | 100               | DAYS                  | 25             | DAYS                   | 4                  | 0                       | 0                      | 0                    | ADVANCED_PAYMENT_ALLOCATION |
    And Admin successfully approves the loan on "20260101" with "100" amount and expected disbursement date on "20260101"
    And Admin successfully disburse the loan on "20260101" with "100" EUR transaction amount
    And Admin sets the business date to "20260102"
    And Admin runs inline COB job for Loan
  ...
  Scenario: Verify Transaction Summary Report with Asset Owner - UC03: Capitalized income amortization with multiple capitalized income transactions should not duplicate
    ...
    And Admin creates a fully customized loan with the following data:
      | LoanProduct                                                    | submitted on date | with Principal | ANNUAL interest rate % | interest type     | interest calculation period | amortization type  | loanTermFrequency | loanTermFrequencyType | repaymentEvery | repaymentFrequencyType | numberOfRepayments | graceOnPrincipalPayment | graceOnInterestPayment | interest free period | Payment strategy            |
      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_CAPITALIZED_INCOME | 20260101   | 100            | 0                      | DECLINING_BALANCE | DAILY                       | EQUAL_INSTALLMENTS | 100               | DAYS                  | 25             | DAYS                   | 4                  | 0                       | 0                      | 0                    | ADVANCED_PAYMENT_ALLOCATION |
    And Admin successfully approves the loan on "20260101" with "100" amount and expected disbursement date on "20260101"
    And Admin successfully disburse the loan on "20260101" with "25" EUR transaction amount
    And Admin sets the business date to "20260102"
    And Admin runs inline COB job for Loan
    And Admin adds capitalized income with "AUTOPAY" payment type to the loan on "20260102" with "50" EUR transaction amount
    And Admin sets the business date to "20260103"
    And Admin runs inline COB job for Loan
    And Admin adds capitalized income with "AUTOPAY" payment type to the loan on "20260103" with "25" EUR transaction amount
    And Admin sets the business date to "20260104"
    And Admin runs inline COB job for Loan
    And Admin sets the business date to "20260105"
    And Admin runs inline COB job for Loan
...
# --- run Transaction Summary Report with Asset Owner report --- #
    Then Transaction Summary Report with Asset Owner for date "20230501" has originatorId, asset owner externalId and the following data:
    ...
    Then Transaction Summary Report with Asset Owner for date "20230614" has originatorId, asset owner externalId and the following data:
      | TransactionDate | Product      | TransactionType_Name      | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount | asset_owner_id    | from_asset_owner_id        | originator_external_ids |
...
# --- run Trial Balance Summary Report with Asset Owner report --- #
    Then Trial Balance Summary Report with Asset Owner for date "20230501" has originatorId, asset owner externalId and the following data:
    ...
    Then Trial Balance Summary Report with Asset Owner for date "20230614" has originatorId, asset owner externalId and the following data:
      | PostingDate     | Product      | glAcct   | Description               | AssetOwner                 | BeginningBalance | DebitMovement | CreditMovement | EndingBalance | originator_external_ids |
...
# --- run Transaction Summary Report with Asset Owner report --- #
    ...
    Then Trial Balance Summary Report with Asset Owner for date "20230522" has originatorId, asset owner externalId and the following data:
      | PostingDate     | Product      | glAcct   | Description               | AssetOwner                 | BeginningBalance | DebitMovement | CreditMovement | EndingBalance | originator_external_ids |
    ...
    Then Trial Balance Summary Report with Asset Owner for date "20230525" has originatorId, asset owner externalId and the following data:
      | PostingDate     | Product      | glAcct   | Description               | AssetOwner                 | BeginningBalance | DebitMovement | CreditMovement | EndingBalance | originator_external_ids |
    ...
    Then Trial Balance Summary Report with Asset Owner for date "20230526" has originatorId, asset owner externalId and the following data:
      | PostingDate     | Product      | glAcct   | Description               | AssetOwner                 | BeginningBalance | DebitMovement | CreditMovement | EndingBalance | originator_external_ids |
  ...
  Scenario: Verify Transaction Summary Report with Buy Down Fee amortization allocation mappings after loan re-open via repayment reversal - UC1
    ...
    And Loan Amortization Allocation Mapping for "BUY_DOWN_FEE" transaction created on "20260101" contains the following data:
      ...
      | 20260101 | AM   | 0.56   |
      | 20260103 | AM   | 49.44  |
    Then Transaction Summary Report for date "20260101" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name            | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
    ...
    Then Transaction Summary Report for date "20260103" has the following data:
      | TransactionDate | Product                                                  | TransactionType_Name            | PaymentType_Name | chargetype | Reversed | Allocation_Type          | Chargeoff_ReasonCode | Transaction_Amount |
      | 2026-01-03      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Apply Charges                   |                  |            | 0        | Interest                 |                      | 0.04               |
      | 2026-01-03      | LP2_PROGRESSIVE_ADVANCED_PAYMENT_ALLOCATION_BUYDOWN_FEES | Buy Down Fee Amortization       |                  |            | 0        | Fees                     |                      | 0.0                |
