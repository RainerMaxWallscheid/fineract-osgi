...
Feature: Working Capital Goodwill Credit Payment Allocation
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction with fee and penalty added with DUE_FEE_PENALTY_PRINCIPAL allocation - UC1
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes "GOODWILL_CREDIT" transaction on "20260112" with 270.0 transaction amount on Working Capital loan
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260112 | Goodwill Credit | 270.0             | 230.0            | 15.0              | 25.0                  | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction with fee and penalty added with DUE_PENALTY_FEE_PRINCIPAL allocation - UC2
    ...
    When Admin sets the business date to "20260112"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes "GOODWILL_CREDIT" transaction on "20260112" with 30.0 transaction amount on Working Capital loan
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 30.0              | 0.0              | 5.0               | 25.0                  | false    |
    When Admin sets the business date to "20260315"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Admin closes the Working Capital loan with a full repayment on "20260315"
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction with fee and penalty added with DUE_PRINCIPAL_FEE_PENALTY allocation - UC3
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 270.0             | 270.0            | 0.0               | 0.0                   | false    |
    When Admin sets the business date to "20260315"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Admin closes the Working Capital loan with a full repayment on "20260315"
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction with fee and penalty added with DUE_FEE_PRINCIPAL_PENALTY allocation - UC4
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 270.0             | 255.0            | 15.0              | 0.0                   | false    |
    When Admin sets the business date to "20260315"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Admin closes the Working Capital loan with a full repayment on "20260315"
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction with fee and penalty added with IN_ADVANCE_PENALTY_FEE_PRINCIPAL allocation - UC5
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Goodwill Credit | 270.0             | 230.0            | 15.0              | 25.0                  | false    |
    When Admin sets the business date to "20260315"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Admin closes the Working Capital loan with a full repayment on "20260315"
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction that closes loan with fee and penalty added with DUE_PRINCIPAL_FEE_PENALTY allocation - UC6
    ...
    When Admin sets the business date to "20260112"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes "GOODWILL_CREDIT" transaction on "20260112" with 9040.0 transaction amount on Working Capital loan
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 9040.0            | 9000.0           | 15.0              | 25.0                  | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction that overpays loan with following CBR trn and with fee and penalty added with DUE_PRINCIPAL_FEE_PENALTY allocation - UC7
    ...
    When Admin sets the business date to "20260112"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes "GOODWILL_CREDIT" transaction on "20260112" with 9200.0 transaction amount on Working Capital loan
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 9200.0            | 9000.0           | 15.0              | 25.0                  | false    |
# --- make CBR trn to refund overpaid amount --- #
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction allocation with charges has been reprocessed successfully after additional backdated goodwill credit - UC8
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes "GOODWILL_CREDIT" transaction on "20260120" with 100.0 transaction amount on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260120 | Goodwill Credit | 100.0             | 0.0              | 100.0             | 0.0                   | false    |
...
# --- backdated goodwill credit on Jan, 10, 2026 --- #
    ...
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Goodwill Credit | 100.0             | 0.0              | 100.0             | 0.0                   | false    |
      | 20260120 | Goodwill Credit | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
    And Working Capital Loan has charges with the following data:
      | Charge Name              | Due Date        | Amount | Currency | isPenalty | Charge Time Type   | Charge Calculation Type | Charge Payment mode |
      | Working Capital Loan Fee | 20260110 | 100.0  | EUR      | false     | Specified due date | Flat                    | Regular             |
    And Working Capital Loan charge balances has the following data:
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Admin closes the Working Capital loan with a full repayment on "20260125"
  ...
  Scenario: Verify Working Capital Goodwill Credit and fee charge adjustment transaction allocation is processed successfully - UC9
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes "GOODWILL_CREDIT" transaction on "20260111" with 30.0 transaction amount on Working Capital loan
    When Admin makes a charge adjustment for the last added charge with 70.0 amount on working capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type              | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement      | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260111 | Goodwill Credit   | 30.0              | 0.0              | 30.0              | 0.0                   | false    |
    ...
    And Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Outstanding | Fee Paid | Penalty Amount | Penalty Outstanding | Penalty Paid |
      | 100.0      | 0.0             | 100.0    | 0.0            | 0.0                 | 0.0          |
    When Admin sets the business date to "20260220"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Admin closes the Working Capital loan with a full repayment on "20260220"
  ...
  Scenario: Verify Working Capital Goodwill Credit transaction with charge within amortization schedule with DUE_PENALTY_FEE_PRINCIPAL allocation - UC10
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Goodwill Credit | 270.0             | 235.0            | 0.0               | 35.0                  | false    |
    When Admin sets the business date to "20260111"
    And Admin runs inline COB job for Working Capital Loan by loanId
  ...
  Scenario: Verify Working Capital Goodwill Credit with fee and penalty charges within amortization schedule with DUE_FEE_PENALTY_PRINCIPAL allocation - UC11
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 270.0             | 192.0            | 35.0              | 43.0                  | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit (DUE_PRINCIPAL_FEE_PENALTY) and Repayment (DUE_FEE_PENALTY_PRINCIPAL) apply different payment allocation rules on the same loan - UC13
    ...
    And Customer makes repayment on "20260115" with 40.0 transaction amount on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 270.0             | 270.0            | 0.0               | 0.0                   | false    |
      | 20260115 | Repayment       | 40.0              | 0.0              | 15.0              | 25.0                  | false    |
    And Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Outstanding | Fee Paid | Penalty Amount | Penalty Outstanding | Penalty Paid |
      | 15.0       | 0.0             | 15.0     | 25.0           | 0.0                 | 25.0         |
    When Admin sets the business date to "20260220"
...
# --- make CBR transaction to refund overpaid amount --- #
  ...
  Scenario: Verify Working Capital Goodwill Credit falls back to DEFAULT rule (DUE_PRINCIPAL first) and not to REPAYMENT rule (DUE_FEE first) when no GOODWILL_CREDIT rule is configured - UC16
    ...
    And Admin creates a client with random data and creates-approves-disburses a working capital loan with the following data:
      | LoanProduct                 | submittedOnDate | expectedDisbursementDate | principalAmount | totalPayment | periodPaymentRate | discount |
      | WCLP_REPAYMENT_DIFF_DEFAULT | 20260101 | 20260101          | 9000            | 100000       | 18                | 0        |
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260112" due date and 15.0 transaction amount
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_PENALTY" specified due date charge to working capital loan with "20260112" due date and 25.0 transaction amount
...
# --- goodwill credit ignores the REPAYMENT (DUE_FEE first) rule and follows DEFAULT (DUE_PRINCIPAL first): all 100 goes to principal --- #
    And Customer makes "GOODWILL_CREDIT" transaction on "20260112" with 100.0 transaction amount on Working Capital loan
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
...
# --- repayment on the same loan still follows the REPAYMENT (DUE_FEE first) rule: charges are settled, no principal --- #
    When Admin sets the business date to "20260113"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes repayment on "20260113" with 40.0 transaction amount on Working Capital loan
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
      | 9000.0    | 100.0              | 100000.0           | 0.0            | 0.0              | 0.0               |
    And Working Capital Loan charge balances has the following data:
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260113 | Repayment       | 40.0              | 0.0              | 15.0              | 25.0                  | false    |
    When Admin sets the business date to "20260115"
    And Admin runs inline COB job for Working Capital Loan by loanId
...
# --- backdated goodwill credit triggers reprocessing: goodwill keeps its own DUE_PRINCIPAL-first rule (principal 100), repayment keeps DUE_FEE-first (fee 100) --- #
    ...
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260115 | Goodwill Credit | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260120 | Repayment       | 100.0             | 0.0              | 100.0             | 0.0                   | false    |
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
      | 9000.0    | 100.0              | 100000.0           | 0.0            | 0.0              | 0.0               |
...
# --- undo the goodwill credit: the repayment is replayed with its own REPAYMENT (DUE_FEE first) rule and keeps its portions --- #
    When Customer undo "1"th "GOODWILL_CREDIT" transaction made on "20260112" on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260112 | Goodwill Credit | 270.0             | 270.0            | 0.0               | 0.0                   | true     |
      | 20260115 | Repayment       | 40.0              | 0.0              | 15.0              | 25.0                  | false    |
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
      | 9000.0    | 0.0                | 100000.0           | 0.0            | 0.0              | 0.0               |
  ...
  Scenario: Verify Working Capital Goodwill Credit allocates to in advance fee and penalty buckets of the GOODWILL_CREDIT specific rule - UC19
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260120" due date and 15.0 transaction amount
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_PENALTY" specified due date charge to working capital loan with "20260120" due date and 25.0 transaction amount
    When Admin sets the business date to "20260115"
    And Admin runs inline COB job for Working Capital Loan by loanId
# --- charges are due only on 20 Jan: principal is settled first (DUE_PRINCIPAL), then IN_ADVANCE_FEE fully, then IN_ADVANCE_PENALTY partially --- #
    And Customer makes "GOODWILL_CREDIT" transaction on "20260115" with 9020.0 transaction amount on Working Capital loan
    And Working capital loan account has the correct data:
      | principal | totalPaidPrincipal | totalPaymentVolume | realizedIncome | unrealizedIncome | overpaymentAmount |
      | 9000.0    | 9000.0             | 100000.0           | 0.0            | 0.0              | 0.0               |
    And Working Capital Loan charge balances has the following data:
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260115 | Goodwill Credit | 9020.0            | 9000.0           | 15.0              | 5.0                   | false    |
