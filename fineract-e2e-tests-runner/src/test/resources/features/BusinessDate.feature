...
Feature: BusinessDate
  ...
  Scenario: As a user I would like to set the business date
    When Admin sets the business date to "20220710"
    Then Admin checks that the business date is correctly set to "20220710"

  @TestRailId:C41
  Scenario: As a user I would like to change the business date manually
    When Admin sets the business date to "20220710"
    Then Admin checks that the business date is correctly set to "20220710"
    When Admin sets the business date to "20220711"
    Then Admin checks that the business date is correctly set to "20220711"
