...
Feature: Working Capital Loan Goodwill Credit
  ...
  Scenario: Verify working capital loan Goodwill Credit transaction - UC1: simple Goodwill Credit transaction
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260110 | Goodwill Credit | 270.0             | 270.0            | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify working capital loan Goodwill Credit transaction - UC1b: Goodwill Credit with payment details exposes payment type on GET
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Customer makes "GOODWILL_CREDIT" transaction on "20260110" with 270.0 transaction amount on Working Capital loan with the following payment details:
  ...
  Scenario: Verify working capital loan Goodwill Credit transaction - UC2: Goodwill Credit transaction with zero amount results an error (Negative)
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Initiating a "GOODWILL_CREDIT" transaction on "20260110" with 0.0 transaction amount on Working Capital loan results an error with the following data:
  ...
  Scenario: Verify working capital loan Goodwill Credit transaction - UC3: Goodwill Credit transaction with negative amount results an error (Negative)
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Initiating a "GOODWILL_CREDIT" transaction on "20260110" with -100.0 transaction amount on Working Capital loan results an error with the following data:
      | httpCode | errorMessage                                              |
      | 400      | The parameter `transactionAmount` must be greater than 0. |
  ...
  Scenario: Verify working capital loan Goodwill Credit transaction - UC4: Goodwill Credit transaction with future date results an error (Negative)
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    Then Initiating a "GOODWILL_CREDIT" transaction on "20260115" with 270.0 transaction amount on Working Capital loan results an error with the following data:
      | httpCode | errorMessage                                            |
  ...
  Scenario: Verify working capital loan Goodwill Credit transaction - UC5: Goodwill Credit transaction on disbursement day
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260101" with 270.0 transaction amount on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 270.0      | 0.0               | true                  | 0.0              | 0              |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260101 | Goodwill Credit | 270.0             | 270.0            | 0.0               | 0.0                   | false    |
...
#   --- Full expectedAmount paid via goodwill credit ---
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260102" with 270.0 transaction amount on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 270.0      | 0.0               | true                  | 0.0              | 0              |
    And Delinquency Tag History for Working Capital loan has lines:
...
#   --- Full expectedAmount paid via goodwill credit on last day ---
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260130" with 270.0 transaction amount on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 270.0      | 0.0               | true                  | 0.0              | 0              |
    And Delinquency Tag History for Working Capital loan has lines:
...
#   --- Full expectedAmount paid via goodwill credit on first day of next period ---
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260131" with 270.0 transaction amount on Working Capital loan
#   --- Check ---
...
#   --- Full expectedAmount paid via 2 goodwill credits on the same day---
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260102 | Goodwill Credit | 170.0             | 170.0            | 0.0               | 0.0                   | false    |
      | 20260102 | Goodwill Credit | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
...
#   --- Mixed: repayment + goodwill credit in same period ---
    ...
    When Admin sets the business date to "20260110"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260110" with 170.0 transaction amount on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 270.0      | 0.0               | true                  | 0.0              | 0              |
    And Delinquency Tag History for Working Capital loan has lines:
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment       | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260110 | Goodwill Credit | 170.0             | 170.0            | 0.0               | 0.0                   | false    |
...
#   --- Period 2: Goodwill credit ---
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260210" with 270.0 transaction amount on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 270.0      | 0.0               | true                  | 0.0              | 0              |
    ...
    And Working Capital Loan has transactions:
      | transactionDate  | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101  | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260110  | Repayment       | 270.0             | 270.0            | 0.0               | 0.0                   | false    |
      | 20260210 | Goodwill Credit | 270.0             | 270.0            | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify working capital loan Goodwill Credit transaction - UC13: Goodwill Credit transaction after loan creation results an error (Negative)
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP        | 20260101 | 20260101          | 9000            | 100000       | 18                | 0        |
    Then Initiating a "GOODWILL_CREDIT" transaction on "20260101" with 270.0 transaction amount on Working Capital loan results an error with the following data:
      | httpCode | errorMessage                                                                     |
