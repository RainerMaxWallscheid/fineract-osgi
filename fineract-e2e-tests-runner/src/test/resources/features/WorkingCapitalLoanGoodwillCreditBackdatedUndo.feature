...
Feature: Working Capital Loan Goodwill Credit Backdated and Undo
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC1: Verify Working Capital Goodwill Credit backdated/undo - UC1: Backdated goodwill credit clears a delinquent period
    ...
    When Customer makes "GOODWILL_CREDIT" transaction on "20260115" with 270.0 transaction amount on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260115 | Goodwill Credit | 270.0             | 270.0            | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC2: Backdated goodwill credit and its undo recalculate the delinquency and breach schedules
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260105" with 270.0 transaction amount on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 270.0      | 0.0               | true                  | 0.0              | 0              |
    ...
    When Customer undo "1"th "GOODWILL_CREDIT" transaction made on "20260105" on Working Capital loan
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 0.0        | 270.0             | null                  | null             | null           |
    And Working Capital loan breach schedule has the following data:
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC3: Backdated goodwill credit settling the full balance closes the loan and recognizes the discount
    ...
    When Admin sets the business date to "20260110"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260105" with 10000.0 transaction amount on Working Capital loan
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260101 | Disbursement              | 9000.0            | false    |
      | 20260101 | Discount Fee              | 1000.0            | false    |
      | 20260105 | Goodwill Credit           | 10000.0           | false    |
      | 20260105 | Discount Fee Amortization | 1000.0            | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC4: Backdated goodwill credit beyond the outstanding balance moves the loan to overpaid
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260110"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260105" with 9500.0 transaction amount on Working Capital loan
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC5: Goodwill credit posted on an already overpaid loan increases the overpayment
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260106" with 300.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 0.0    |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Goodwill Credit | 9500.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260106 | Goodwill Credit | 300.0             | 0.0              | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC6: Undoing a goodwill credit posts a discount fee amortization adjustment on the next COB
    ...
    And Customer makes "GOODWILL_CREDIT" transaction on "20260102" with 3000.0 transaction amount on Working Capital loan
    ...
    Then Working Capital Loan has transactions:
      ...
      | 20260101 | Disbursement              | 9000.0            | false    |
      | 20260101 | Discount Fee              | 1000.0            | false    |
      | 20260102 | Goodwill Credit           | 3000.0            | false    |
      | 20260102 | Discount Fee Amortization | 498.67            | false    |
    When Customer undo "1"th "GOODWILL_CREDIT" transaction made on "20260102" on Working Capital loan
    ...
    Then Working Capital Loan has transactions:
      ...
      | 20260101 | Disbursement                         | 9000.0            | false    |
      | 20260101 | Discount Fee                         | 1000.0            | false    |
      | 20260102 | Goodwill Credit                      | 3000.0            | true     |
      | 20260102 | Discount Fee Amortization            | 498.67            | false    |
      | 20260103 | Discount Fee Amortization Adjustment | 498.67            | false    |
    And Working Capital loan balance payload contains the following fields:
      | field          | value |
      | realizedIncome | 0.0   |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC7: Undoing the closing goodwill credit re-opens the loan from closed to active
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260105"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260105" with 9000.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
    When Admin sets the business date to "20260106"
    And Customer undo "1"th "GOODWILL_CREDIT" transaction made on "20260105" on Working Capital loan
    Then Working Capital loan status will be "ACTIVE"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Goodwill Credit | 9000.0            | 9000.0           | 0.0               | 0.0                   | true     |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC8: Undoing a goodwill credit that overpaid a closed loan returns it to closed
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260105"
    And Customer makes repayment on "20260105" with 9000 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
    When Admin sets the business date to "20260106"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260106" with 500.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    When Admin sets the business date to "20260107"
    And Customer undo "1"th "GOODWILL_CREDIT" transaction made on "20260106" on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 0.0    |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment       | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260106 | Goodwill Credit | 500.0             | 0.0              | 0.0               | 0.0                   | true     |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC9: Goodwill credit dated before the disbursement date is rejected (Negative)
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP        | 20260101 | 20260105          | 9000            | 100000             | 18                | 0        |
    And Admin successfully approves the working capital loan on "20260101" with "9000" amount and expected disbursement date on "20260105"
    When Admin sets the business date to "20260105"
    And Admin successfully disburse the Working Capital loan on "20260105" with "9000" EUR transaction amount
    Then Working Capital loan status will be "ACTIVE"
    Then Initiating a "GOODWILL_CREDIT" transaction on "20260103" with 270.0 transaction amount on Working Capital loan results an error with the following data:
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC10: Backdated goodwill credit on a loan with a fee re-allocates the later transaction's fee to principal
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260105"
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260105" due date and 5.0 transaction amount
    When Admin sets the business date to "20260110"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260110" with 30.0 transaction amount on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Goodwill Credit | 30.0              | 25.0             | 5.0               | 0.0                   | false    |
    When Admin sets the business date to "20260115"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260105" with 25.0 transaction amount on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Goodwill Credit | 25.0              | 20.0             | 5.0               | 0.0                   | false    |
      | 20260110 | Goodwill Credit | 30.0              | 30.0             | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC11: Undoing a goodwill credit on a loan with a fee re-allocates the remaining transaction's fee portion
    ...
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260105" due date and 5.0 transaction amount
    When Admin sets the business date to "20260105"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260105" with 30.0 transaction amount on Working Capital loan
    When Admin sets the business date to "20260110"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260110" with 25.0 transaction amount on Working Capital loan
    When Customer undo "1"th "GOODWILL_CREDIT" transaction made on "20260105" on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Goodwill Credit | 30.0              | 25.0             | 5.0               | 0.0                   | true     |
      | 20260110 | Goodwill Credit | 25.0              | 20.0             | 5.0               | 0.0                   | false    |
    And Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Paid | Fee Outstanding |
      | 5.0        | 5.0      | 0.0             |
    And Working Capital loan balance payload contains the following fields:
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC12: Backdated goodwill credit posted on a closed loan reprocesses the payments and moves it to overpaid
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 9000 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
    When Admin sets the business date to "20260115"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260105" with 500.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 0.0    |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type            | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Goodwill Credit | 500.0             | 500.0            | 0.0               | 0.0                   | false    |
      | 20260110 | Repayment       | 9000.0            | 8500.0           | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify Working Capital Goodwill Credit backdated/undo - UC13: Goodwill credit settling only a fee on a closed loan keeps the loan closed
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260105"
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260105" due date and 35.0 transaction amount
    And Customer makes repayment on "20260105" with 9000 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
    And Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Paid | Fee Outstanding |
      | 35.0       | 0.0      | 35.0            |
    When Admin sets the business date to "20260110"
    And Customer makes "GOODWILL_CREDIT" transaction on "20260110" with 35.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "CLOSED_OBLIGATIONS_MET"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 0.0    |
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260101 | Disbursement    | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment       | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Goodwill Credit | 35.0              | 0.0              | 35.0              | 0.0                   | false    |
