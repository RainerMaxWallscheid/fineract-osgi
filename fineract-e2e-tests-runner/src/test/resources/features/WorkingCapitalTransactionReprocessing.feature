...
Feature: Working Capital Transaction Reprocessing
  ...
  Scenario: Verify backdated repayment is reflected in balances and existing allocations stay untouched (no charges)
    ...
    And Customer makes repayment on "20260110" with 3000 transaction amount on Working Capital loan
    ...
    And Customer makes repayment on "20260105" with 2000 transaction amount on Working Capital loan
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260105 | Repayment    | 2000.0            | 2000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Repayment    | 3000.0            | 3000.0           | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify backdated repayment that overpays - excess becomes overpayment
    ...
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 7000 transaction amount on Working Capital loan
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 2000.0 |
    # Backdated repayment on day 5 - total repaid (7000 + 5000 = 12000) exceeds principal (9000)
    When Admin sets the business date to "20260115"
    And Customer makes repayment on "20260105" with 5000 transaction amount on Working Capital loan
  ...
  Scenario: Verify multiple backdated repayments accumulate correctly
    ...
    When Admin sets the business date to "20260115"
    And Customer makes repayment on "20260115" with 3000 transaction amount on Working Capital loan
    # Backdated repayment on day 5
    When Admin sets the business date to "20260120"
    And Customer makes repayment on "20260105" with 1000 transaction amount on Working Capital loan
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 5000.0 |
      | totalPaidPrincipal   | 4000.0 |
    # Another backdated repayment on day 10 (between the existing ones)
    And Customer makes repayment on "20260110" with 2000 transaction amount on Working Capital loan
    Then Working Capital loan balance payload contains the following fields:
      | field                | value  |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment    | 1000.0            | 1000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Repayment    | 2000.0            | 2000.0           | 0.0               | 0.0                   | false    |
      | 20260115 | Repayment    | 3000.0            | 3000.0           | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify backdated repayment only settles a charge that is already due on the backdated date
    ...
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260110" due date and 35.0 transaction amount
    And Customer makes repayment on "20260110" with 3000 transaction amount on Working Capital loan
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment    | 2000.0            | 2000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Repayment    | 3000.0            | 2965.0           | 35.0              | 0.0                   | false    |
  ...
  Scenario: Verify a repayment clearing more than one lapsed delinquency period distributes by remaining balance
    ...
    When Admin sets the business date to "20260302"
    And Admin runs inline COB job for Working Capital Loan by loanId
    # Single repayment of 400 covering period 1 fully (270) and period 2 partially (130)
    And Customer makes repayment on "20260302" with 400 transaction amount on Working Capital loan
  ...
  Scenario: Verify backdated repayment re-allocates the later transaction's fee portion to principal
    ...
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 30 transaction amount on Working Capital loan
    # First, Txn#1 allocates 5 fee + 25 principal
    Then Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Repayment    | 30.0              | 25.0             | 5.0               | 0.0                   | false    |
    # Backdated Txn#2 on day 5 takes the fee; Txn#1 is reprocessed to 30 principal
    When Admin sets the business date to "20260115"
    And Customer makes repayment on "20260105" with 25 transaction amount on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment    | 25.0              | 20.0             | 5.0               | 0.0                   | false    |
      | 20260110 | Repayment    | 30.0              | 30.0             | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify reversal of a transaction re-allocates the remaining transaction's fee portion
    ...
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260105" due date and 5.0 transaction amount
    When Admin sets the business date to "20260105"
    And Customer makes repayment on "20260105" with 30 transaction amount on Working Capital loan
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 25 transaction amount on Working Capital loan
    # Reverse Txn#1 (the day-5 repayment) -> Txn#2 must be reprocessed to take the fee
    When Customer undo "1"th "REPAYMENT" transaction made on "20260105" on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment    | 30.0              | 25.0             | 5.0               | 0.0                   | true     |
      | 20260110 | Repayment    | 25.0              | 20.0             | 5.0               | 0.0                   | false    |
    And Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Paid | Fee Outstanding |
      | 5.0        | 5.0      | 0.0             |
    And Working Capital loan balance payload contains the following fields:
  ...
  Scenario: Verify a repayment splits across fee and principal per the product's allocation order
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260110"
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260110" due date and 5.0 transaction amount
    And Customer makes repayment on "20260110" with 30 transaction amount on Working Capital loan
  ...
  Scenario: Verify backdated repayment reprocessing preserves an earlier charge adjustment's settlement
    ...
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 60 transaction amount on Working Capital loan
    Then Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Paid | Fee Outstanding |
      | 100.0      | 100.0    | 0.0             |
    ...
    When Admin sets the business date to "20260115"
    And Customer makes repayment on "20260108" with 50 transaction amount on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type              | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement      | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260106 | Charge Adjustment | 40.0              | 0.0              | 40.0              | 0.0                   | false    |
      | 20260108 | Repayment         | 50.0              | 0.0              | 50.0              | 0.0                   | false    |
      | 20260110 | Repayment         | 60.0              | 50.0             | 10.0              | 0.0                   | false    |
    And Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Paid | Fee Outstanding |
      | 100.0      | 100.0    | 0.0             |
    And Working Capital loan balance payload contains the following fields:
  ...
  Scenario: Verify backdated repayment that overpays redistributes allocations chronologically
   ...
   # chronologically, matching the reprocessing behavior of loans with charges
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment    | 5000.0            | 5000.0           | 0.0               | 0.0                   | false    |
      | 20260110 | Repayment    | 7000.0            | 4000.0           | 0.0               | 0.0                   | false    |
