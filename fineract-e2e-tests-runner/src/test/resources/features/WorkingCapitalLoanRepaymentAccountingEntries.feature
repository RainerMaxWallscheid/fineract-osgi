...
Feature: Working Capital Loan Repayment Accounting Entries
  ...
  Scenario: Verify Working Capital loan repayment GL entries - UC2: multiple payments same day
    ...
    Then Working Capital Loan Transactions tab has 2 "REPAYMENT" transactions with date "20260102" which have the following Journal entries:
      | Type      | Account code | Account name              | Debit | Credit |
  ...
  Scenario: Verify Working Capital loan repayment GL entries - UC3: multiple payments different days
    ...
    Then Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260102" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit | Credit |
      | LIABILITY | 145023       | Suspense/Clearing account | 170.0 |        |
      | ASSET     | 112601       | Loans Receivable          |       | 170.0  |
    And Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260115" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit | Credit |
      | LIABILITY | 145023       | Suspense/Clearing account | 100.0 |        |
      | ASSET     | 112601       | Loans Receivable          |       | 100.0  |
  ...
  Scenario: Verify Working Capital loan repayment GL entries - UC4: repayment with overpayment
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 10000.0 transaction amount on Working Capital loan
    Then Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit   | Credit |
...
#    TODO Add fee here to Working Capital loan
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 320.0 transaction amount on Working Capital loan
    Then Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit | Credit |
...
#    TODO Add penalty here to Working Capital loan
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 300.0 transaction amount on Working Capital loan
    Then Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit | Credit |
...
#    TODO Add fee + penalty here to Working Capital loan
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 10500.0 transaction amount on Working Capital loan
    Then Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit   | Credit |
  ...
  Scenario: Verify Working Capital loan UNDO repayment GL entries - UC1: simple reversal
    ...
    Then Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
      ...
      | LIABILITY | 145023       | Suspense/Clearing account | 270.0 |        |
      | ASSET     | 112601       | Loans Receivable          |       | 270.0  |
    When Customer undo "1"th "Repayment" transaction made on "20260110" on Working Capital loan
  ...
  Scenario: Verify Working Capital loan UNDO repayment GL entries - UC3: reversal with penalties
    ...
    And Admin successfully approves the working capital loan on "20260101" with "9000" amount and expected disbursement date on "20260101"
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_PENALTY" specified due date charge to working capital loan with "20260105" due date and 50.0 transaction amount
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 300.0 transaction amount on Working Capital loan
    When Customer undo "1"th "Repayment" transaction made on "20260110" on Working Capital loan
    Then Working Capital Loan Transactions tab has a reversed "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
  ...
  Scenario: Verify Working Capital loan repayment GL entries - UC9: repayment on already closed loan posts only overpayment credit
    ...
    And Customer makes repayment on "20260111" with 300.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance overpaymentAmount is "300.00"
    And Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260111" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit | Credit |
      | LIABILITY | 145023       | Suspense/Clearing account | 300.0 |        |
  ...
  Scenario: Verify Working Capital loan repayment GL entries - UC10: repayment on already overpaid loan posts only overpayment credit
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 9200.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance overpaymentAmount is "200.00"
    When Admin sets the business date to "20260111"
    And Customer makes repayment on "20260111" with 199.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
  ...
  Scenario: Verify Working Capital loan repayment GL entries - UC11: repayment on already overpaid loan with advanced accounting payment channel fund source mapping
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 9200.0 transaction amount on Working Capital loan with the following payment details:
      | paymentType    | accountNumber | checkNumber | routingCode | receiptNumber | bankNumber |
      | MONEY_TRANSFER |               |             |             |               |            |
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance overpaymentAmount is "200.00"
    When Admin sets the business date to "20260111"
    And Customer makes repayment on "20260111" with 199.0 transaction amount on Working Capital loan with the following payment details:
      | paymentType    | accountNumber | checkNumber | routingCode | receiptNumber | bankNumber |
      | MONEY_TRANSFER |               |             |             |               |            |
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance overpaymentAmount is "399.00"
