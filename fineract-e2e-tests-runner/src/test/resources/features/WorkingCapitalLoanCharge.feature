...
#  ###############################################
  ...
  Scenario: Verify Working Capital Charge on loan account level - UC1: specified due date fee added with business date as due date
    ...
    Then Working Capital Loan has charges with the following data:
      ...
      | Working Capital Loan Fee | 20260110 | 35.0   | EUR      | false     | Specified due date | Flat                    | Regular             |
  ...
  Scenario: Verify Working Capital Charge on loan account level - UC4: specified due date charge added on disbursement date
    ...
    And Admin creates a client with random data and creates-approves-disburses a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPayment | periodPaymentRate | discount |
      | WCLP        | 20260101 | 20260101          | 9000            | 100000       | 18                | 0        |
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260101" due date and 35.0 transaction amount
    Then Working Capital Loan has charges with the following data:
      | Charge Name              | Due Date        | Amount | Currency | isPenalty | Charge Time Type   | Charge Calculation Type | Charge Payment mode |
      | Working Capital Loan Fee | 20260101 | 35.0   | EUR      | false     | Specified due date | Flat                    | Regular             |
    And Admin runs inline COB job for Working Capital Loan by loanId
  ...
  Scenario: Verify Working Capital Charge on loan account level - UC6: multiple charges can be added to the same loan
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260112" due date and 35.0 transaction amount
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_PENALTY" specified due date charge to working capital loan with "20260115" due date and 50.0 transaction amount
    Then Working Capital Loan has charges with the following data:
      | Charge Name                  | Due Date        | Amount | Currency | isPenalty | Charge Time Type   | Charge Calculation Type | Charge Payment mode |
      | Working Capital Loan Fee     | 20260112 | 35.0   | EUR      | false     | Specified due date | Flat                    | Regular             |
      | Working Capital Loan Penalty | 20260115 | 50.0   | EUR      | true      | Specified due date | Flat                    | Regular             |
  ...
  Scenario: Verify Working Capital Charge on loan account level - UC8: charge can be added with minimum amount
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260112" due date and 1.0 transaction amount
    Then Working Capital Loan has charges with the following data:
      | Charge Name              | Due Date        | Amount | Currency | isPenalty | Charge Time Type   | Charge Calculation Type | Charge Payment mode |
      | Working Capital Loan Fee | 20260112 | 1.0    | EUR      | false     | Specified due date | Flat                    | Regular             |
  ...
  Scenario: Verify Working Capital Charge on loan account level - UC9: charge can be added with large amount
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260112" due date and 5000.0 transaction amount
    Then Working Capital Loan has charges with the following data:
      | Charge Name              | Due Date        | Amount | Currency | isPenalty | Charge Time Type   | Charge Calculation Type | Charge Payment mode |
      | Working Capital Loan Fee | 20260112 | 5000.0 | EUR      | false     | Specified due date | Flat                    | Regular             |
  ...
  Scenario: Verify Working Capital Charge on loan account level - UC10: charge balances are correctly calculated (Outstanding only, no repayment)
    ...
    When Admin sets the business date to "20260110"
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260112" due date and 100.0 transaction amount
    Then Working Capital Loan has charges with the following data:
      | Charge Name              | Due Date        | Amount | Currency | isPenalty | Charge Time Type   | Charge Calculation Type | Charge Payment mode |
      | Working Capital Loan Fee | 20260112 | 100.0  | EUR      | false     | Specified due date | Flat                    | Regular             |
    ...
    And Admin runs inline COB job for Working Capital Loan by loanId
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_PENALTY" specified due date charge to working capital loan with "20260112" due date and 50.0 transaction amount
    Then Working Capital Loan has charges with the following data:
      | Charge Name                  | Due Date        | Amount | Currency | isPenalty | Charge Time Type   | Charge Calculation Type | Charge Payment mode |
      | Working Capital Loan Fee     | 20260112 | 100.0  | EUR      | false     | Specified due date | Flat                    | Regular             |
      | Working Capital Loan Penalty | 20260112 | 50.0   | EUR      | true      | Specified due date | Flat                    | Regular             |
    Then Working Capital Loan charge balances has the following data:
      | Fee Amount | Fee Outstanding | Fee Paid | Penalty Amount | Penalty Outstanding | Penalty Paid |
