...
Feature: Working Capital Loan Undo Transaction
  ...
  Scenario: Verify working capital loan undo transaction - UC1: simple repayment undo
    ...
    Then Working Capital Loan Transactions tab has a "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
    ...
    When Customer undo "1"th working capital transaction made on "20260110"
    # Verify reversed transaction and its mirror GL entries (original + reversal rows)
    Then Working Capital Loan Transactions tab has a reversed "REPAYMENT" transaction with date "20260110" which has the following Journal entries:
      | Type      | Account code | Account name              | Debit | Credit |
      | LIABILITY | 145023       | Suspense/Clearing account | 270.0 |        |
      | ASSET     | 112601       | Loans Receivable          |       | 270.0  |
      | LIABILITY | 145023       | Suspense/Clearing account |       | 270.0  |
  ...
  Scenario: Verify working capital loan undo transaction - UC2: repayment undo updates breach schedule
    ...
    Then Working Capital loan delinquency range schedule has the following data:
      | periodNumber | fromDate   | toDate     | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet | delinquentAmount | delinquentDays |
      | 1            | 2026-01-01 | 2026-01-30 | 270.0          | 0.0        | 270.0             | null                  | null             | null           |
    When Customer makes repayment on "20260110" with 270.0 transaction amount on Working Capital loan
    And Admin retrieves the projected amortization schedule
    And The retrieved amortization schedule has payments with the following details in first "11" lines:
      | paymentNo | date       | expectedPaymentAmount | expectedBalance | expectedAmortizationAmount | actualPaymentAmount | actualAmortizationAmount | expectedDiscountFeeBalance | actualBalance | actualDiscountFeeBalance |
      | 0         | 2026-01-01 | -9000.00              | 9000.00         |                            |                     |                          | 0.0                        | 9000.00       | 0.00                     |
  ...
  Scenario: Verify working capital loan undo transaction - UC3: goodwill credit undo
    ...
    When Customer makes "GOODWILL_CREDIT" transaction on "20260110" with 270.0 transaction amount on Working Capital loan
  ...
  Scenario: Verify working capital loan undo transaction - UC4: undo already-reversed transaction returns error (Negative)
    ...
    When Customer tries to undo "1"th "REPAYMENT" transaction made on "20260110" on Working Capital loan and gets error:
  ...
  Scenario: Verify working capital loan undo transaction - UC5: undo disbursement via undo-transaction endpoint returns error (Negative)
    ...
    When Customer tries to undo "1"th "DISBURSEMENT" transaction made on "20260101" on Working Capital loan and gets error:
      | httpCode | errorMessage                                            |
  ...
  Scenario: Verify undo repayment after a credit balance refund does not resurrect the refunded overpayment
    ...
    And Admin adds "WORKING_CAPITAL_SPECIFIED_DUE_DATE_FEE" specified due date charge to working capital loan with "20260105" due date and 100.0 transaction amount
    When Admin sets the business date to "20260106"
    And Customer makes repayment on "20260106" with 100 transaction amount on Working Capital loan
    When Admin sets the business date to "20260107"
    And Customer makes repayment on "20260107" with 9300 transaction amount on Working Capital loan
    ...
    And Customer makes credit balance refund on "20260108" with 100.0 transaction amount on Working Capital loan
    ...
    And Customer undo "1"th "REPAYMENT" transaction made on "20260106" on Working Capital loan
    Then Working Capital Loan has transactions:
      | transactionDate | type                  | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement          | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260106 | Repayment             | 100.0             | 0.0              | 100.0             | 0.0                   | true     |
      | 20260107 | Repayment             | 9300.0            | 9000.0           | 100.0             | 0.0                   | false    |
      | 20260108 | Credit Balance Refund | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
  ...
  Scenario: Verify undo of an early repayment on an overpaid charge-free loan realigns the remaining allocation
    ...
    And Admin successfully disburse the Working Capital loan on "20260101" with "9000" EUR transaction amount
    When Admin sets the business date to "20260105"
    And Customer makes repayment on "20260105" with 3000 transaction amount on Working Capital loan
    When Admin sets the business date to "20260110"
    And Customer makes repayment on "20260110" with 6500 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 0.0    |
    ...
    And Customer undo "1"th "REPAYMENT" transaction made on "20260105" on Working Capital loan
    Then Working Capital loan status will be "ACTIVE"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment    | 3000.0            | 3000.0           | 0.0               | 0.0                   | true     |
      | 20260110 | Repayment    | 6500.0            | 6500.0           | 0.0               | 0.0                   | false    |
  ...
  Scenario: Verify a new repayment on a closed working capital loan is accepted and moves the loan to overpaid
    ...
    When Admin sets the business date to "20260106"
    And Customer makes repayment on "20260106" with 100.0 transaction amount on Working Capital loan
    Then Working Capital loan status will be "OVERPAID"
    And Working Capital loan balance payload contains the following fields:
      | field                | value  |
      | principalOutstanding | 0.0    |
  ...
  Scenario: Verify undo repayment posts a discount fee amortization adjustment on the next COB
    ...
    And Customer makes repayment on "20260102" with 3000 transaction amount on Working Capital loan
    ...
    Then Working Capital Loan has transactions:
      ...
      | 20260102 | Repayment                 | 3000.0            | false    |
    ...
    When Customer undo "1"th "REPAYMENT" transaction made on "20260102" on Working Capital loan
    ...
    Then Working Capital Loan has transactions:
      ...
      | 20260101 | Disbursement                         | 9000.0            | false    |
      | 20260101 | Discount Fee                         | 1000.0            | false    |
      | 20260102 | Repayment                            | 3000.0            | true     |
      | 20260102 | Discount Fee Amortization            | 498.67            | false    |
  ...
  Scenario: Verify undoing the closing repayment re-opens the loan from closed to active
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 9000.0            | 9000.0           | 0.0               | 0.0                   | false    |
      | 20260105 | Repayment    | 9000.0            | 9000.0           | 0.0               | 0.0                   | true     |
  ...
  Scenario: Verify undo of an earlier repayment recomputes the principal split of a later overpaying repayment
    ...
    And Customer makes repayment on "20260130" with 700 transaction amount on Working Capital loan
    ...
    Then WC loan delinquency range schedule periods have specific data:
      ...
      | 2            | 20260131 | 20260301   | 100            | 200        | 0                 | true                  |
    When Customer undo "1"th working capital transaction made on "20260130"
    Then WC loan delinquency range schedule periods have specific data:
      | periodNumber | fromDate        | toDate          | expectedAmount | paidAmount | outstandingAmount | minPaymentCriteriaMet |
