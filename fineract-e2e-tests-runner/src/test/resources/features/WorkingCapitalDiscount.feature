...
# --- add discount after disbursement on diff from same disbursement date should outcome with an error --- #
  ...
  Scenario: Discount update on WCL account on the same as disburse date failed as already added discount before while create loan - UC3
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP        | 20260101 | 20260101          | 100             | 100                | 1                 | 15       |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Submitted and pending approval | 100.0             | 0.0               | 100.0              | 1.0               | 15.0             | null             | null     |
    Then Approving the working capital loan on "20260101" with "100" amount and expected disbursement date on "20260101" with "18" discount amount results an error with the following data:
      | HTTP response code | Error message                         |
      | 400                | amount.cannot.exceed.created.discount |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "14" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Approved | 100.0             | 100.0             | 100.0              | 1.0               | 15.0             | 14.0             | null     |
    Then Disbursing the working capital loan on "20260101" with "100" amount and "15" discount amount results an error with the following data:
      | HTTP response code | Error message                          |
      | 400                | amount.cannot.exceed.approved.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "13" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 13.0              | 13.0             | 0.0               | 0.0                   | false    |
    Then Adding Discount fee with "10" amount on Working Capital loan account results an error with the following data:
      | HTTP response code | Error message                                |
    ...
    And Working Capital Loan has transactions:
      ...
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 13.0              | 13.0             | 0.0               | 0.0                   | false    |
    And WorkingCapitalLoanDiscountFeeTransactionBusinessEvent is raised with amount "13" on "20260101" date
  ...
  Scenario: Discount update on WCL account on the same as disburse date failed as already added discount before while approve loan - UC5
    ...
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "14" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 14.0              | 14.0             | 0.0               | 0.0                   | false    |
    Then Adding Discount fee with "10" amount on Working Capital loan account results an error with the following data:
      | HTTP response code | Error message                                |
      | 400                | Discount was already set before disbursement |
    And Working Capital Loan has transactions:
  ...
  Scenario: Discount is forbidden to be added after disbursement as discount is set on loan product level with WCLP overrides disallowed - UC7
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct                                | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP_DISCOUNT_DISALLOW_ATTRIBUTES_OVERRIDE | 20260101 | 20260101          | 100             | 100                | 1                 |          |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name                               | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    Then Approving the working capital loan on "20260101" with "100" amount and expected disbursement date on "20260101" with "20" discount amount results an error with the following data:
      | HTTP response code | Error message                   |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 50.0              | 50.0             | 0.0               | 0.0                   | false    |
# --- add discount after disbursement is forbidden due to overrides disallowed --- #
  ...
  Scenario: Discount is forbidden to be added after disbursement as NO discount is set on loan product level with WCLP overrides disallowed - UC8
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct                       | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP_DISALLOW_ATTRIBUTES_OVERRIDE | 20260101 | 20260101          | 100             | 100                | 1                 |          |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name                      | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    Then Disbursing the working capital loan on "20260101" with "100" amount and "20" discount amount results an error with the following data:
      | HTTP response code | Error message                   |
      | 400                | override.not.allowed.by.product |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount
    Then Working Capital loan status will be "ACTIVE"
...
# --- add discount after disbursement is forbidden due to overrides disallowed --- #
  ...
  Scenario: Discount is disallowed to be added after disbursement as discount is set and inherited from WC loan product level with WCLP overrides allowed - UC9
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct   | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP_DISCOUNT | 20260101 | 20260101          | 100             | 100                | 1                 |          |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "50" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100               | 100              | 0                 | 0                     | false    |
      | 20260101 | Discount Fee | 50                | 50               | 0                 | 0                     | false    |
 # --- add discount after disbursement is forbidden as discount is already added --- #
  ...
  Scenario: Discount is forbidden to be added after Modify with modified discount amount allowed as discount is set on loan product level with WCLP overrides allowed - UC10
    ...
    When Admin modifies the working capital loan with the following data:
      | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      |                 |                          |                 |                    |                   | 55.0     |
    Then Approving the working capital loan on "20260101" with "100" amount and expected disbursement date on "20260101" with "60" discount amount results an error with the following data:
      | HTTP response code | Error message                         |
      | 400                | amount.cannot.exceed.created.discount |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    ...
    Then Disbursing the working capital loan on "20260101" with "100" amount and "60" discount amount results an error with the following data:
      | HTTP response code | Error message                         |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 50.0              | 50.0             | 0                 | 0                     | false    |
# --- add discount after disbursement is forbidden as discount is already added and updated on disbursement --- #
  ...
  Scenario: Discount is forbidden to be added after Approve with modified discount amount allowed as discount is set on loan product level with WCLP overrides allowed - UC11
    ...
    Then Approving the working capital loan on "20260101" with "100" amount and expected disbursement date on "20260101" with "60" discount amount results an error with the following data:
      | HTTP response code | Error message                         |
      | 400                | amount.cannot.exceed.product.discount |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "40" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP_DISCOUNT | 2026-01-01      | 2026-01-01               | Approved | 100.0             | 100.0             | 100.0              | 1.0               | null             | 40.0             | null     |
    Then Disbursing the working capital loan on "20260101" with "100" amount and "50" discount amount results an error with the following data:
      | HTTP response code | Error message                          |
      | 400                | amount.cannot.exceed.approved.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "40" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 40.0              | 40.0             | 0                 | 0                     | false    |
  # --- add discount after disbursement is forbidden as discount is already added --- #
    Then Adding Discount fee with "10" amount on Working Capital loan account results an error with the following data:
      | HTTP response code | Error message                                |
      | 400                | Discount was already set before disbursement |
  ...
  Scenario: Discount is forbidden to be added after Disburse with modified discount amount allowed as discount is set on loan product level with WCLP overrides allowed - UC12
    ...
    Then Disbursing the working capital loan on "20260101" with "100" amount and "60" discount amount results an error with the following data:
      | HTTP response code | Error message                         |
      | 400                | amount.cannot.exceed.product.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "45" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 45.0              | 45.0             | 0                 | 0                     | false    |
# --- add discount after disbursement is forbidden as discount is already added and updated on disbursement --- #
    Then Adding Discount fee with "10" amount on Working Capital loan account results an error with the following data:
      | HTTP response code | Error message                                |
      | 400                | Discount was already set before disbursement |
  ...
  Scenario: Discount is allowed to be added after disbursement as overridden with NO discount value from defined on WCLP on loan Create with WCLP overrides allowed - UC13
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct   | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP_DISCOUNT | 20260101 | 20260101          | 100             | 100                | 1                 | 0        |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
 ...
 # --- add discount after disbursement is allowed as NO discount is added yet --- #
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 10.0              | 10.0             | 0.0               | 0.0                   | false    |
...
# --- undo working capital disbursal --- #
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | true     |
      | 20260101 | Discount Fee | 10.0              | 10.0             | 0.0               | 0.0                   | true     |
  ...
  Scenario: Working Capital Loan Transaction - Discount added on disbursement on disbursement undo - UC15
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP        | 20260101 | 20260101          | 100.0           | 100.0              | 1.0               | 22.0     |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "11" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | false    |
      | 20260101 | Discount Fee | 11.0              | 11.0             | 0.0               | 0.0                   | false    |
# --- undo working capital disbursal --- #
    And Admin successfully undo Working Capital disbursal by externalId
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | true     |
      | 20260101 | Discount Fee | 11.0              | 11.0             | 0.0               | 0.0                   | true     |
  ...
  Scenario: Discount on Working Capital Loan account added while create WCP, updated while approve loan and check after updo approval - UC1
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP        | 20260101 | 20260101          | 100             | 100                | 1                 | 18       |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Submitted and pending approval | 100.0             | 0.0               | 100.0              | 1.0               | 18.0             | null             | null     |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "17" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital approval --- #
    ...
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Submitted and pending approval | 100.0             | 0.0               | 100.0              | 1.0               | 18.0             | null             | null     |
    Then Approving the working capital loan on "20260101" with "100" amount and expected disbursement date on "20260101" with "19" discount amount results an error with the following data:
      | HTTP response code | Error message                         |
      | 400                | amount.cannot.exceed.created.discount |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
  ...
  Scenario: Discount on Working Capital Loan account added while create WCP, updated while approve/disburse loan and check after undo approval/disbursal - UC2
    ...
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Approved | 100.0             | 100.0             | 100.0              | 1.0               | 18.0             | 17.0             | null     |
    Then Disbursing the working capital loan on "20260101" with "100" amount and "19" discount amount results an error with the following data:
      | HTTP response code | Error message                          |
      | 400                | amount.cannot.exceed.approved.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "16" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital approval --- #
  ...
  Scenario: Discount on Working Capital Loan account added while approve WCP and check after updo approval - UC3
    ...
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Submitted and pending approval | 100.0             | 0.0               | 100.0              | 1.0               | null             | null             | null     |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "15" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital approval --- #
    ...
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Submitted and pending approval | 100.0             | 0.0               | 100.0              | 1.0               | null             | null             | null     |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "19" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
  ...
  Scenario: Discount on Working Capital Loan account added while approve, updated on disbursal and check after updo disbursal/approval with additional update while approve and check after undo disbursal - UC4
    ...
    Then Disbursing the working capital loan on "20260101" with "100" amount and "20" discount amount results an error with the following data:
      | HTTP response code | Error message                          |
      | 400                | amount.cannot.exceed.approved.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "19" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital disbursal --- #
  ...
  Scenario: Discount on Working Capital Loan account added while approve, updated on disbursal and check after updo disbursal/approval with additional update while modify and check after undo disbursal - UC4.1
    ...
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "20" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Approved | 100.0             | 100.0             | 100.0              | 1.0               | 20.0             | 20.0             | null     |
    Then Disbursing the working capital loan on "20260101" with "100" amount and "21" discount amount results an error with the following data:
      | HTTP response code | Error message                          |
      | 400                | amount.cannot.exceed.approved.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "18" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital approval --- #
  ...
  Scenario: Discount on Working Capital Loan account added while create loan, updated on disbursal and check after undo disbursal with additional disburse - UC6
    ...
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
      | WCLP         | 2026-01-01      | 2026-01-01               | Submitted and pending approval | 100.0             | 0.0               | 100.0              | 1.0               | 18.0             | null             | null     |
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "18" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status   | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital disbursal --- #
    ...
    Then Disbursing the working capital loan on "20260101" with "100" amount and "19" discount amount results an error with the following data:
      | HTTP response code | Error message                          |
      | 400                | amount.cannot.exceed.approved.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "17" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital approval --- #
  ...
  Scenario: Discount on Working Capital Loan account added on create loan account with modified discount amount while discount set on loan product level and WCLP overrides allowed after undo disbursal/approve - UC9.1
    ...
    And Admin creates a working capital loan with the following data:
      | LoanProduct   | submittedOnDate | expectedDisbursementDate | principalAmount | totalPaymentVolume | periodPaymentRate | discount |
      | WCLP_DISCOUNT | 20260101 | 20260101          | 100             | 100                | 1                 | 48.0     |
    Then Working capital loan creation was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status                         | proposedPrincipal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital approval --- #
  ...
  Scenario: Discount on Working Capital Loan account added on modify loan account with modified discount amount with discount set on loan product level and WCLP overrides allowed after undo disbursal/approve - UC9.2
    ...
    Then Disbursing the working capital loan on "20260101" with "100" amount and "50" discount amount results an error with the following data:
      | HTTP response code | Error message                          |
      | 400                | amount.cannot.exceed.approved.discount |
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "20" discount amount
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working capital loan account has the correct data:
      | product.name  | submittedOnDate | expectedDisbursementDate | status | principal | approvedPrincipal | totalPaymentVolume | periodPaymentRate | discountProposed | discountApproved | discount |
...
# --- undo working capital disbursal --- #
    ...
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
      | 20260101 | Disbursement | 100.0             | 100.0            | 0.0               | 0.0                   | true     |
      | 20260101 | Discount Fee | 13.0              | 13.0             | 0.0               | 0.0                   | true     |
...
# --- undo working capital approval --- #
  ...
  Scenario: Discount provided during disbursement with user-generated discountExternalId is persisted as-is
    ...
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "14" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    Then Admin successfully disburse the Working Capital loan on "20260101" with "100" EUR transaction amount and "13" discount amount and a random discountExternalId
    Then Working Capital loan status will be "ACTIVE"
    Then Verify Working Capital loan disbursement was successful
    And Working Capital Loan has transactions:
      | transactionDate | type         | transactionAmount | principalPortion | feeChargesPortion | penaltyChargesPortion | reversed |
  ...
  Scenario: Reusing the same discountExternalId across two working capital loans on disburse is rejected
    ...
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "14" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    Then Initiating disbursement on "20260101" with "100" EUR transaction amount and "13" discount amount reusing the previously shared discountExternalId on Working Capital loan results an error with the following data:
      | HTTP response code | Error message  |
      | 400                | already.exists |
  ...
  Scenario: Providing discountExternalId on disburse without discountAmount is rejected
    ...
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "14" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    Then Initiating disbursement on "20260101" with "100" EUR transaction amount and discountExternalId "wcl-disburse-discount-no-amount-001" without discountAmount on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                         |
  ...
  Scenario: Providing discountExternalId on disburse with zero discountAmount is rejected
    ...
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "14" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    Then Initiating disbursement on "20260101" with "100" EUR transaction amount and "0" discount amount and discountExternalId "wcl-disburse-discount-zero-amount-001" on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                         |
      | 400                | not.allowed.without.positive.discount |
  ...
  Scenario: Providing the same externalId for both disburse and discountExternalId is rejected
    ...
    Then Admin successfully approves the working capital loan on "20260101" with "100" amount and "14" discount amount and expected disbursement date on "20260101"
    Then Working capital loan approval was successful
    Then Initiating disbursement on "20260101" with "100" EUR transaction amount and "13" discount amount using "wcl-disburse-shared-ext-id-001" for both externalId and discountExternalId on Working Capital loan results an error with the following data:
      | HTTP response code | Error message                             |
