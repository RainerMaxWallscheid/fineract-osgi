...
| `fineract-loan-origination-impl` | `impl/` | `org.apache.fineract.loanorigination.impl` | JPA, REST, handlers, Avro enrichers; **OSGi** `LoanOriginationOsgiServiceRegistrar` |
