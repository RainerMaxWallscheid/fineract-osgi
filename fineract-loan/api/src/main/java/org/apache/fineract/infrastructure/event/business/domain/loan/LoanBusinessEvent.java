...
public abstract class LoanBusinessEvent extends AbstractBusinessEvent<Object> {

    private static final String CATEGORY = "Loan";

    public LoanBusinessEvent(Object value) {
        super(value);
    }
    ...
    public Long getAggregateRootId() {
        ...
        if (value instanceof LoanEventId id) {
            return id.getId();
        }
        throw new IllegalStateException("Unsupported loan business event payload: " + (value == null ? "null" : value.getClass().getName()));
    }
}
