...
public class LoanDisbursalTransactionBusinessEvent extends LoanTransactionBusinessEvent {
    ...
    public LoanDisbursalTransactionBusinessEvent(Object value) {
        super(value);
    }

    public LoanDisbursalTransactionBusinessEvent(final Object value, final LoanTransactionFlagsData flags) {
        super(value, flags);
    }
