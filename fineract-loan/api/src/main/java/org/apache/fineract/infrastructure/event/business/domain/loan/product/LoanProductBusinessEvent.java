...
public abstract class LoanProductBusinessEvent extends AbstractBusinessEvent<Object> {

    private static final String CATEGORY = "Loan";

    public LoanProductBusinessEvent(Object value) {
        super(value);
    }
    ...
    public Long getAggregateRootId() {
        ...
        throw new IllegalStateException(
                "Unsupported loan-product business event payload: " + (value == null ? "null" : value.getClass().getName()));
    }
}
