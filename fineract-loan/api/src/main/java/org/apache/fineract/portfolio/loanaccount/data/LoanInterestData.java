...
public class LoanInterestData {
    ...
    public LoanInterestData(final BigDecimal interestCharged, final BigDecimal interestPaid, final BigDecimal interestWaived,
            final BigDecimal interestWrittenOff, final BigDecimal interestOutstanding) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (this$interestCharged == null ? other$interestCharged != null : !this$interestCharged.equals(other$interestCharged))
            return false;
        ...
        if (this$interestWrittenOff == null ? other$interestWrittenOff != null : !this$interestWrittenOff.equals(other$interestWrittenOff))
            return false;
        ...
        if (this$interestOutstanding == null ? other$interestOutstanding != null
                : !this$interestOutstanding.equals(other$interestOutstanding))
            return false;
        return true;
    }
    ...
    public java.lang.String toString() {
        return "LoanInterestData(interestCharged=" + this.getInterestCharged() + ", interestPaid=" + this.getInterestPaid()
                + ", interestWaived=" + this.getInterestWaived() + ", interestWrittenOff=" + this.getInterestWrittenOff()
                + ", interestOutstanding=" + this.getInterestOutstanding() + ")";
    }
}
