...
public abstract class LoanChargeBusinessEvent extends AbstractBusinessEvent<Object> {

    private static final String CATEGORY = "Loan";

    public LoanChargeBusinessEvent(Object value) {
        super(value);
    }
    ...
    public Long getAggregateRootId() {
        ...
        throw new IllegalStateException(
                "Unsupported loan-charge business event payload: " + (value == null ? "null" : value.getClass().getName()));
    }
}
