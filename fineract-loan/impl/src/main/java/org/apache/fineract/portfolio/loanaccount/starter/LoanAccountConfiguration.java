...
public class LoanAccountConfiguration {
    ...
    public LoanApplicationWritePlatformService loanApplicationWritePlatformService(PlatformSecurityContext context,
            ...
            LoanRepositoryWrapper loanRepositoryWrapper, NoteWritePlatformService noteWritePlatformService, LoanAssembler loanAssembler,
            ...
            LoanRepository loanRepository, LoanLifecycleStateMachine loanLifecycleStateMachine,
            ...
            LoanOriginatorLinkingService loanOriginatorLinkingService, LoanCollateralPort loanCollateralLifecycleService) {
        return new LoanApplicationWritePlatformServiceJpaRepositoryImpl(context, loanApplicationTransitionValidator,
                loanApplicationValidator, loanRepositoryWrapper, noteWritePlatformService, loanAssembler, calendarRepository,
                calendarInstanceRepository, accountAssociationsRepository, businessEventNotifierService, loanScheduleAssembler,
                loanUtilService, calendarReadPlatformService, entityDatatableChecksWritePlatformService, glimRepository, loanRepository,
                loanLifecycleStateMachine, loanAccrualsProcessingService, loanDownPaymentTransactionValidator, loanScheduleService,
                loanOriginatorLinkingService, loanCollateralLifecycleService);
    }
    ...
    public LoanAssembler loanAssembler(FromJsonHelper fromApiJsonHelper, LoanRepositoryWrapper loanRepository,
        ...
        return new LoanAssemblerImpl(fromApiJsonHelper, loanRepository, loanProductRepository, groupRepository, fundRepository,
                ...
                loanAccrualsProcessingService, loanDisbursementService, loanChargeService, loanOfficerService, loanSchedule);
    }
    ...
    public LoanChargeAssembler loanChargeAssembler(final FromJsonHelper fromApiJsonHelper, final ChargeDefinitionPort chargeDefinitionPort,
        ...
        return new LoanChargeAssembler(fromApiJsonHelper, chargeDefinitionPort, loanChargeRepository, loanProductRepository,
                externalIdFactory, loanChargeService);
    }
    ...
    public LoanChargeWritePlatformService loanChargeWritePlatformService(LoanChargeApiJsonValidator loanChargeApiJsonValidator,
            ...
            LoanAccountDomainService loanAccountDomainService, LoanCollateralPort loanCollateralLifecycleService,
            ...
            PaymentDetailWritePlatformService paymentDetailWritePlatformService, NoteWritePlatformService noteWritePlatformService,
            LoanAccrualsProcessingService loanAccrualsProcessingService,
        ...
        return new LoanChargeWritePlatformServiceImpl(loanChargeApiJsonValidator, loanAssembler, chargeDefinitionPort,
                ...
                loanAccountDomainService, loanCollateralLifecycleService, loanChargeRepository, loanWritePlatformService, loanUtilService,
                loanChargeReadPlatformService, loanLifecycleStateMachine, accountAssociationsReadPlatformService, fromApiJsonHelper,
                configurationDomainService, externalIdFactory, accountTransferDetailRepository, loanChargeAssembler,
                paymentDetailWritePlatformService, noteWritePlatformService, loanAccrualsProcessingService,
                loanDownPaymentTransactionValidator, loanChargeValidator, loanScheduleService, reprocessLoanTransactionsService,
                loanAccountService, loanAdjustmentService, loanChargeService, loanJournalEntryPoster);
    }
    ...
    public LoanWritePlatformService loanWritePlatformService(PlatformSecurityContext context,
            ...
            LoanAccountDomainService loanAccountDomainService, LoanCollateralPort loanCollateralLifecycleService,
            NoteWritePlatformService noteWritePlatformService, LoanTransactionRepository loanTransactionRepository,
            LoanTransactionRelationRepository loanTransactionRelationRepository, LoanAssembler loanAssembler,
            CalendarInstanceLookupPort calendarInstanceRepository, PaymentDetailWritePlatformService paymentDetailWritePlatformService,
            ...
            CodeValueRepositoryWrapper codeValueRepository, CashierTxnValidationPort cashierTxnValidationPort,
        ...
        return new LoanWritePlatformServiceJpaRepositoryImpl(context, loanTransactionValidator, loanUpdateCommandFromApiJsonDeserializer,
                loanRepositoryWrapper, loanAccountDomainService, loanCollateralLifecycleService, noteWritePlatformService,
                ...
                cashierTxnValidationPort, glimRepository, loanRepository, repaymentWithPostDatedChecksAssembler, postDatedChecksRepository,
    ...
    public LoanDisbursementService loanDisbursementService(LoanChargeValidator loanChargeValidator,
            ...
            ConfigurationDomainService configurationDomainService, ChargeDefinitionPort chargeDefinitionPort) {
