...
public class ProgressiveLoanStatusChangePlatformServiceImpl {
    ...
    @java.lang.SuppressWarnings("all")
    public ProgressiveLoanStatusChangePlatformServiceImpl(final BusinessEventNotifierService businessEventNotifierService,
            final CapitalizedIncomePlatformService capitalizedIncomeWritePlatformService) {
