...
public class InterestPauseWritePlatformServiceImpl implements InterestPauseWritePlatformService {
    ...
    private CommandProcessingResult processUpdateInterestPause(Loan loan, Long variationId, String startDateString, String endDateString,
        ...
        //
        //
        new CommandProcessingResultBuilder().withEntityId(updatedVariation.getId())
    ...
    public InterestPauseWritePlatformServiceImpl(final LoanTermVariationsRepository loanTermVariationsRepository,
            final LoanRepositoryWrapper loanRepositoryWrapper, final LoanAssembler loanAssembler,
            final BusinessEventNotifierService businessEventNotifierService, final LoanScheduleService loanScheduleService) {
