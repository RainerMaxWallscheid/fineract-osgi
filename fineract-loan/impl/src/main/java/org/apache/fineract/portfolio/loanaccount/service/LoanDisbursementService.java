...
public class LoanDisbursementService {
    ...
    public void handleDisbursementTransaction(final Loan loan, final LocalDate disbursedOn, final PaymentDetail paymentDetail) {
        ...
        for (final LoanCharge charge : loan.getActiveCharges()) {
            ...
            boolean isDisbursementCharge = charge.getChargeTimeType().equals(ChargeTimeType.DISBURSEMENT)
                    && disbursedOn.equals(actualDisbursementDate) && !charge.isWaived() && !charge.isFullyPaid();
            boolean isTrancheDisbursementCharge = charge.getChargeTimeType().equals(ChargeTimeType.TRANCHE_DISBURSEMENT)
                    && disbursedOn.equals(actualDisbursementDate) && !charge.isWaived() && !charge.isFullyPaid();
            /*
    ...
    @java.lang.SuppressWarnings("all")
    public LoanDisbursementService(final LoanChargeValidator loanChargeValidator, final LoanDisbursementValidator loanDisbursementValidator,
            final LoanChargeService loanChargeService, final LoanBalanceService loanBalanceService,
            final LoanJournalEntryPoster loanJournalEntryPoster, final LoanTransactionRepository loanTransactionRepository,
            final ConfigurationDomainService configurationDomainService, final ChargeDefinitionPort chargeDefinitionPort) {
