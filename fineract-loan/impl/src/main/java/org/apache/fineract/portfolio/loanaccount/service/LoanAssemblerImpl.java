...
public class LoanAssemblerImpl implements LoanAssembler {
    ...
    public Loan assembleFrom(final JsonCommand command) {
        ...
        if (client != null && group != null) {
            ...
            loanApplication = Loan.newIndividualLoanApplication(accountNo, client, loanAccountType, loanProduct, fund, loanOfficer,
                    loanPurpose, transactionProcessingStrategy, loanProductRelatedDetail, loanCharges, fixedEmiAmount, disbursementDetails,
                    maxOutstandingLoanBalance, createStandingInstructionAtDisbursement, isFloatingInterestRate, interestRateDifferential,
                    rates, fixedPrincipalPercentagePerInstallment, externalId, loanApplicationTerms, isEnableInstallmentLevelDelinquency,
                    submittedOnDate, allowFullTermForTranche);
    ...
    private void createAndSetGLIMAccount(BigDecimal totalLoan, Loan loan, AccountNumberFormat accountNumberFormat, Object group,
    ...
    public Map<String, Object> updateFrom(JsonCommand command, Loan loan) {
        ...
        if (loan.getLoanOfficerId() != null) {
            existingLoanOfficerId = loan.getLoanOfficerId();
        }
    ...
    public LoanAssemblerImpl(final FromJsonHelper fromApiJsonHelper, final LoanRepositoryWrapper loanRepository,
            ...
            final WorkingDaysRepositoryWrapper workingDaysRepository, final RateAssembler rateAssembler,
            final ExternalIdFactory externalIdFactory, final AccountNumberFormatRepositoryWrapper accountNumberFormatRepository,
            final GLIMAccountInfoRepository glimRepository, final AccountNumberGenerator accountNumberGenerator,
            ...
            final LoanDisbursementDetailsAssembler loanDisbursementDetailsAssembler, final LoanChargeMapper loanChargeMapper,
            final LoanAccrualsProcessingService loanAccrualsProcessingService, final LoanDisbursementService loanDisbursementService,
            final LoanChargeService loanChargeService, final LoanOfficerService loanOfficerService,
