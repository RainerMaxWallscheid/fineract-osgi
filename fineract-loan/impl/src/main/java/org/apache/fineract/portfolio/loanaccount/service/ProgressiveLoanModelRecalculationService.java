...
public class ProgressiveLoanModelRecalculationService {
    ...
    public ProgressiveLoanModelRecalculationService(final LoanRepaymentScheduleTransactionProcessorFactory transactionProcessorFactory,
            final LoanTransactionRepository loanTransactionRepository, final LoanRepositoryWrapper loanRepositoryWrapper) {
