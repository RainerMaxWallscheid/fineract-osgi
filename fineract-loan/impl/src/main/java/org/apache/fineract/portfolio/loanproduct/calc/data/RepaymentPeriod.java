...
public class RepaymentPeriod {
    ...
    public Money getCreditedPrincipal() {
        return MathUtil.negativeToZero( //
                //
                getInterestPeriods().stream().map(InterestPeriod::getCreditedPrincipal).reduce(getZero(),
                        (value, previous) -> value.plus(previous, getMc())),
                getMc()); //
    }
    ...
    public Money getCreditedInterest() {
        return MathUtil.negativeToZero( //
                //
                getInterestPeriods().stream().map(InterestPeriod::getCreditedInterest).reduce(getZero(),
                        (value, previous) -> value.plus(previous, getMc())),
                getMc()); //
    }
    ...
    public Money getCapitalizedIncomePrincipal() {
        return MathUtil.negativeToZero( //
                //
                getInterestPeriods().stream().map(InterestPeriod::getCapitalizedIncomePrincipal).reduce(getZero(),
                        (value, previous) -> value.plus(previous, getMc())),
                getMc()); //
    }
        ...
        if (outstandingBalanceCalculation == null) {
            outstandingBalanceCalculation = Memo.of(() -> {
                ...
                Money calculatedOutStandingLoanBalance = //
                        ...
                        //
                        //
                        lastInterestPeriod.getOutstandingLoanBalance().plus(lastInterestPeriod.getBalanceCorrectionAmount(), getMc())
                                .plus(lastInterestPeriod.getCapitalizedIncomePrincipal(), getMc())
                                .plus(lastInterestPeriod.getDisbursementAmount(), getMc()).plus(getPaidPrincipal(), getMc())
    ...
    public Money getInitialBalanceForEmiRecalculation() {
        ...
        Money totalDisbursedAmount = //
                //
                getInterestPeriods().stream().map(InterestPeriod::getDisbursementAmount).reduce(getZero(),
                        (m1, m2) -> m1.plus(m2, getMc())); //
    ...
    public Optional<InterestPeriod> findInterestPeriod(@NotNull LocalDate transactionDate) {
        return //
        //
        interestPeriods.stream().filter(interestPeriod -> isInPeriod(transactionDate, interestPeriod.getFromDate(),
                interestPeriod.getDueDate(), isFirstRepaymentPeriod() && interestPeriod.isFirstInterestPeriod())).reduce((one, two) -> two);
    }
    ...
    public java.lang.String toString() {
        return "RepaymentPeriod(fromDate=" + this.getFromDate() + ", dueDate=" + this.getDueDate() + ", interestPeriods="
                + this.getInterestPeriods() + ", emi=" + this.getEmi() + ", originalEmi=" + this.getOriginalEmi() + ", paidPrincipal="
                + this.getPaidPrincipal() + ", paidInterest=" + this.getPaidInterest() + ", futureUnrecognizedInterest="
                + this.getFutureUnrecognizedInterest() + ", mc=" + this.getMc() + ", rateFactorPlus1Calculation="
                + this.rateFactorPlus1Calculation + ", calculatedDueInterestCalculation=" + this.calculatedDueInterestCalculation
                + ", dueInterestCalculation=" + this.dueInterestCalculation + ", outstandingBalanceCalculation="
                + this.outstandingBalanceCalculation + ", isInterestMovedUpward=" + this.isInterestMovedUpward() + ", interestPaymentGrace="
                + this.isInterestPaymentGrace() + ", totalDisbursedAmount=" + this.getTotalDisbursedAmount()
                + ", totalCapitalizedIncomeAmount=" + this.getTotalCapitalizedIncomeAmount() + ", loanProductRelatedDetail="
                + this.getLoanProductRelatedDetail() + ", currency=" + this.getCurrency() + ", creditedPrincipalMovedDueReAge="
                + this.getCreditedPrincipalMovedDueReAge() + ", creditedInterestMovedDueReAge=" + this.getCreditedInterestMovedDueReAge()
                + ", isInterestMovedDownward=" + this.isInterestMovedDownward() + ", reAged=" + this.isReAged()
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (this$interestPeriods == null ? other$interestPeriods != null : !this$interestPeriods.equals(other$interestPeriods))
            return false;
        ...
        if (this$futureUnrecognizedInterest == null ? other$futureUnrecognizedInterest != null
                : !this$futureUnrecognizedInterest.equals(other$futureUnrecognizedInterest))
            return false;
        ...
        if (this$rateFactorPlus1Calculation == null ? other$rateFactorPlus1Calculation != null
                : !this$rateFactorPlus1Calculation.equals(other$rateFactorPlus1Calculation))
            return false;
        ...
        if (this$calculatedDueInterestCalculation == null ? other$calculatedDueInterestCalculation != null
                : !this$calculatedDueInterestCalculation.equals(other$calculatedDueInterestCalculation))
            return false;
        ...
        if (this$dueInterestCalculation == null ? other$dueInterestCalculation != null
                : !this$dueInterestCalculation.equals(other$dueInterestCalculation))
            return false;
        ...
        if (this$outstandingBalanceCalculation == null ? other$outstandingBalanceCalculation != null
                : !this$outstandingBalanceCalculation.equals(other$outstandingBalanceCalculation))
            return false;
        ...
        if (this$totalCapitalizedIncomeAmount == null ? other$totalCapitalizedIncomeAmount != null
                : !this$totalCapitalizedIncomeAmount.equals(other$totalCapitalizedIncomeAmount))
            return false;
        ...
        if (this$creditedPrincipalMovedDueReAge == null ? other$creditedPrincipalMovedDueReAge != null
                : !this$creditedPrincipalMovedDueReAge.equals(other$creditedPrincipalMovedDueReAge))
            return false;
        ...
        if (this$creditedInterestMovedDueReAge == null ? other$creditedInterestMovedDueReAge != null
                : !this$creditedInterestMovedDueReAge.equals(other$creditedInterestMovedDueReAge))
            return false;
