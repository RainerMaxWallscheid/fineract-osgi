...
public class LoanProductAssembler {
    ...
    public LoanProduct assembleFromJson(final Fund fund, final String loanTransactionProcessingStrategy, final List<Long> productChargeIds,
        ...
        return new LoanProduct(fund, loanTransactionProcessingStrategy, loanProductPaymentAllocationRules, loanProductCreditAllocationRules,
                ...
                inArrearsTolerance, productChargeIds, accountingRuleType, includeInBorrowerCycle, startDate, closeDate, externalId,
                ...
                floatingRateId, interestRateDifferential, minDifferentialLendingRate, maxDifferentialLendingRate,
    ...
    public LoanProductAssembler(final LoanProductInterestRecalculationDetailsAssembler interestRecalculationDetailsAssembler,
