...
public class ProgressiveLoanSummaryDataProvider extends CommonLoanSummaryDataProvider {
    ...
    public LoanSummaryData withTransactionAmountsSummary(Long loanId, LoanSummaryData defaultSummaryData,
            LoanScheduleData repaymentSchedule, Collection<? extends LoanTransactionBalanceView> loanTransactionBalances) {
    ...
    @java.lang.SuppressWarnings("all")
    public ProgressiveLoanSummaryDataProvider(final EMICalculator emiCalculator, final LoanRepositoryWrapper loanRepository,
            final InterestScheduleModelRepositoryWrapper modelRepository) {
