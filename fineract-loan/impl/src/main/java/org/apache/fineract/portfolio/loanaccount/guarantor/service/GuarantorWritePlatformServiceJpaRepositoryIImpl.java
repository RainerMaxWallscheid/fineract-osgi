    ...
    private CommandProcessingResult createGuarantor(final Loan loan, final JsonCommand command, final GuarantorCommand guarantorCommand,
        ...
        try {
            ...
            if (guarantorCommand.getSavingsId() != null) {
                ...
                accountAssociations = AccountAssociations.associateLoanToSavings(loan.getId(), guarantorCommand.getSavingsId(),
    ...
    private void validateGuarantorSavingsAccountActivationDateWithLoanSubmittedOnDate(final Loan loan,
        ...
        if (DateUtils.isBefore(loan.getSubmittedOnDate(), savingsActivationDate)) {
            throw new GeneralPlatformDomainRuleException(
                    ...
                    "Guarantor saving account activation date [" + savingsActivationDate + "] is on or before the loan submitted on date ["
