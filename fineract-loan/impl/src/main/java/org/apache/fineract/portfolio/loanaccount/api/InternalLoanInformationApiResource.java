...
public class InternalLoanInformationApiResource implements InitializingBean {
    ...
    @java.lang.SuppressWarnings("all")
    public InternalLoanInformationApiResource(final LoanRepositoryWrapper loanRepositoryWrapper,
            final LoanTransactionRepository loanTransactionRepository, final ApiRequestParameterHelper apiRequestParameterHelper,
            final AdvancedPaymentDataMapper advancedPaymentDataMapper) {
