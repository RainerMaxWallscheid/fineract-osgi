...
public class LoanCapitalizedIncomeApiResource {
    ...
    public LoanCapitalizedIncomeApiResource(final PlatformSecurityContext context,
            final CapitalizedIncomeBalanceReadService capitalizedIncomeBalanceReadService,
            final LoanAmortizationAllocationService loanAmortizationAllocationService,
            final DefaultToApiJsonSerializer<LoanAmortizationAllocationData> toApiJsonSerializer,
