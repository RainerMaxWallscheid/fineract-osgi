...
public class ProgressiveLoanTransactionValidatorImpl implements ProgressiveLoanTransactionValidator {
    ...
    @java.lang.SuppressWarnings("all")
    public ProgressiveLoanTransactionValidatorImpl(final FromJsonHelper fromApiJsonHelper,
            final LoanTransactionValidator loanTransactionValidator, final LoanRepositoryWrapper loanRepositoryWrapper,
            ...
            final LoanTransactionRepository loanTransactionRepository, final LoanMaximumAmountCalculator loanMaximumAmountCalculator) {
