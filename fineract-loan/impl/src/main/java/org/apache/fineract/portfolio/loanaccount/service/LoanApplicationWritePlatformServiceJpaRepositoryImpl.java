...
public class LoanApplicationWritePlatformServiceJpaRepositoryImpl implements LoanApplicationWritePlatformService {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory
            .getLogger(LoanApplicationWritePlatformServiceJpaRepositoryImpl.class);
    ...
    public CommandProcessingResult modifyApplication(final Long loanId, final JsonCommand command) {
        try {
            ...
            //
            //
            new CommandProcessingResultBuilder().withEntityId(loanId).withEntityExternalId(loan.getExternalId())
    ...
    private void updateLinkedAccountAssociation(AccountAssociations accountAssociations, Long savingsAccountId,
    ...
    private void createLinkedAccountAssociation(final Loan loan, final Long savingsAccountId, final Map<String, Object> changes) {
        ...
        final AccountAssociations accountAssociations = AccountAssociations.associateLoanToSavings(loan.getId(), savingsAccountId,
    ...
    public CommandProcessingResult deleteApplication(final Long loanId) {
        ...
        //
        new CommandProcessingResultBuilder().withEntityId(loanId).withEntityExternalId(loan.getExternalId())
                .withOfficeId(loan.getOfficeId()).withClientId(loan.getClientId()).withGroupId(loan.getGroupId()).withLoanId(loan.getId())
                .build();
    }
    ...
    @java.lang.SuppressWarnings("all")
    public LoanApplicationWritePlatformServiceJpaRepositoryImpl(final PlatformSecurityContext context,
            final LoanApplicationTransitionValidator loanApplicationTransitionValidator,
            final LoanApplicationValidator loanApplicationValidator, final LoanRepositoryWrapper loanRepositoryWrapper,
            final NoteWritePlatformService noteWritePlatformService, final LoanAssembler loanAssembler,
            final CalendarRepository calendarRepository, final CalendarInstanceLookupPort calendarInstanceRepository,
            final AccountAssociationsRepository accountAssociationsRepository,
            final BusinessEventNotifierService businessEventNotifierService, final LoanScheduleAssembler loanScheduleAssembler,
            ...
            final LoanLifecycleStateMachine loanLifecycleStateMachine, final LoanAccrualsProcessingService loanAccrualsProcessingService,
            final LoanDownPaymentTransactionValidator loanDownPaymentTransactionValidator, final LoanScheduleService loanScheduleService,
            final LoanOriginatorLinkingService loanOriginatorLinkingService, final LoanCollateralPort loanCollateralLifecycleService) {
