...
public class AccountDetailsReadPlatformServiceJpaRepositoryImpl implements AccountDetailsReadPlatformService {
    ...
    private static final class LoanAccountSummaryDataMapper implements RowMapper<LoanAccountSummaryData> {
        ...
        public String loanAccountSummarySchema() {
            ...
            accountsSummary.append(" l.product_id as productId, lp.name as productName, lp.short_name as shortProductName,")
                    ...
                    .append(" glim.account_number as parentAccountNumber,").append("l.principal_disbursed_derived as originalLoan,")
                    ...
                    .append("curr.name as currencyName, curr.internationalized_name_code as currencyNameCode,")
                    .append("curr.display_symbol as currencyDisplaySymbol,").append(" l.submittedon_date as submittedOnDate,")
    ...
    private static final class GuarantorLoanAccountSummaryDataMapper implements RowMapper<GuarantorAccountSummaryData> {
        ...
        public String guarantorLoanAccountSummarySchema() {
            ...
            accountsSummary.append(" l.product_id as productId, lp.name as productName, lp.short_name as shortProductName,")
                    ...
                    .append("l.total_repayment_derived as amountPaid,").append(" l.loan_product_counter as loanCycle,")
                    .append(" l.submittedon_date as submittedOnDate,").append(" l.rejectedon_date as rejectedOnDate,")
                    .append(" l.withdrawnon_date as withdrawnOnDate,").append(" l.approvedon_date as approvedOnDate,")
                    .append(" l.expected_disbursedon_date as expectedDisbursementDate, l.disbursedon_date as actualDisbursementDate,")
    ...
    private WorkingCapitalLoanAccountSummaryData toWorkingCapitalLoanAccountSummary(
        ...
        return new WorkingCapitalLoanAccountSummaryData(view.id(), view.accountNo(), view.externalId(), view.productId(),
                view.productName(), view.shortProductName(), status, view.currency(), view.loanCycle(), view.timeline(), view.inArrears(),
                view.loanBalance(), view.amountPaid());
    }

    @java.lang.SuppressWarnings("all")
    public AccountDetailsReadPlatformServiceJpaRepositoryImpl(final JdbcTemplate jdbcTemplate,
            final ClientReadPlatformService clientReadPlatformService, final GroupReadPlatformService groupReadPlatformService,
            final ColumnValidator columnValidator, final WorkingCapitalLoanExistencePort workingCapitalLoanExistencePort) {
