...
public class LoanTransactionsApiResource {
    ...
    public LoanTransactionsApiResource(final PlatformSecurityContext context, final LoanReadPlatformService loanReadPlatformService,
            ...
            final PaymentTypeReadService paymentTypeReadPlatformService, final LoanChargePaidByReadService loanChargePaidByReadService,
            final LoanReAgingService loanReAgingService, final LoanReAmortizationService loanReAmortizationService) {
