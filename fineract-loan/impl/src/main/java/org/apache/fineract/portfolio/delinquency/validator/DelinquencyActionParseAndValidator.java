...
public class DelinquencyActionParseAndValidator extends ParseAndValidator {
    ...
    private void validateResumeDoesNotExist(final LoanDelinquencyAction parsedDelinquencyAction,
        ...
        final boolean match = //
                //
                savedDelinquencyActions.stream().filter(action -> DelinquencyAction.RESUME.equals(action.getAction()))
    ...
    public DelinquencyActionParseAndValidator(final FromJsonHelper jsonHelper,
