...
public class LoanScheduleWritePlatformServiceImpl implements LoanScheduleWritePlatformService {
    ...
    public LoanScheduleWritePlatformServiceImpl(final LoanAssembler loanAssembler, final LoanScheduleAssembler loanScheduleAssembler,
            final LoanUtilService loanUtilService, final BusinessEventNotifierService businessEventNotifierService,
            final LoanAccrualsProcessingService loanAccrualsProcessingService, final LoanScheduleService loanScheduleService,
            final LoanAccountService loanAccountService) {
