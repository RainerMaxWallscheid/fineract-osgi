...
public final class LoanReAgeParameterData {
    ...
    LoanReAgeParameterData(final PeriodFrequencyType frequencyType, final Integer frequencyNumber, final LocalDate startDate,
            final Integer numberOfInstallments, final LoanReAgeInterestHandlingType interestHandlingType) {
    ...
    public static class LoanReAgeParameterDataBuilder {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoanReAgeParameterData.LoanReAgeParameterDataBuilder interestHandlingType(
                final LoanReAgeInterestHandlingType interestHandlingType) {
            this.interestHandlingType = interestHandlingType;
            return this;
        }
        ...
        public LoanReAgeParameterData build() {
            return new LoanReAgeParameterData(this.frequencyType, this.frequencyNumber, this.startDate, this.numberOfInstallments,
                    this.interestHandlingType);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
            return "LoanReAgeParameterData.LoanReAgeParameterDataBuilder(frequencyType=" + this.frequencyType + ", frequencyNumber="
                    + this.frequencyNumber + ", startDate=" + this.startDate + ", numberOfInstallments=" + this.numberOfInstallments
                    + ", interestHandlingType=" + this.interestHandlingType + ")";
        }
    }
