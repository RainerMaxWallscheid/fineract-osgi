...
public class ProgressiveLoanModelProcessingService {
    ...
    public ProgressiveLoanModelProcessingService(final LoanRepositoryWrapper loanRepositoryWrapper,
            final ProgressiveLoanModelRecalculationService modelProcessingService,
            final InterestScheduleModelRepositoryWrapper modelRepositoryWrapper,
            final ProgressiveLoanModelRepository progressiveLoanModelRepository) {
