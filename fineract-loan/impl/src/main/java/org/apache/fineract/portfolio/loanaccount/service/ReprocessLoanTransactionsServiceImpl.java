...
public class ReprocessLoanTransactionsServiceImpl implements ReprocessLoanTransactionsService {
    ...
    public ReprocessLoanTransactionsServiceImpl(final LoanAccountService loanAccountService,
            final LoanAccountTransfersService loanAccountTransfersService,
            final ReplayedTransactionBusinessEventService replayedTransactionBusinessEventService,
            final LoanTransactionProcessingService loanTransactionProcessingService,
            final InterestScheduleModelRepositoryWrapper interestScheduleModelRepositoryWrapper,
            final LoanBalanceService loanBalanceService, final LoanTransactionRepository loanTransactionRepository,
            final LoanTransactionService loanTransactionService, final LoanJournalEntryPoster loanJournalEntryPoster,
