...
public class GuarantorFundingTransaction extends AbstractPersistableCustom<Long> {
    ...
    /**
     * On-hold transaction id (no JPA association to leftover {@code DepositAccountOnHoldTransaction} — ADR-021 / charge
     * Step 8).
     */
    ...
    /**
     * Marks this funding transaction reversed. Returns the on-hold id when the reverse is newly applied so callers can
     * reverse the savings on-hold via {@code DepositAccountOnHoldPort}.
     */
