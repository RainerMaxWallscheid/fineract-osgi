...
public class LoanAdjustmentServiceImpl implements LoanAdjustmentService {
    ...
    public CommandProcessingResult adjustLoanTransaction(Loan loan, LoanTransaction transactionToAdjust, LoanAdjustmentParameter parameter,
        ...
        //
        //
        new CommandProcessingResultBuilder().withCommandId(commandId).withEntityId(entityId).withEntityExternalId(entityExternalId)
    ...
    public LoanAdjustmentServiceImpl(final LoanTransactionValidator loanTransactionValidator,
            ...
            final NoteWritePlatformService noteWritePlatformService, final LoanTransactionRepository loanTransactionRepository,
            ...
            final LoanLifecycleStateMachine loanLifecycleStateMachine, final LoanDownPaymentHandlerService loanDownPaymentHandlerService,
            final LoanAccrualsProcessingService loanAccrualsProcessingService, final LoanChargeValidator loanChargeValidator,
            final LoanJournalEntryPoster journalEntryPoster, final LoanBalanceService loanBalanceService,
            final ReprocessLoanTransactionsService reprocessLoanTransactionsService,
