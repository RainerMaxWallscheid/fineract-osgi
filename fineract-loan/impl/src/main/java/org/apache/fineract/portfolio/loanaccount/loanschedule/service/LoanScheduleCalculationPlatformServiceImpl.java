...
public class LoanScheduleCalculationPlatformServiceImpl implements LoanScheduleCalculationPlatformService {
    ...
    public LoanScheduleCalculationPlatformServiceImpl(final LoanScheduleValidator fromApiJsonDeserializer,
            final LoanScheduleAssembler loanScheduleAssembler, final LoanApplicationValidator loanApiJsonDeserializer,
            final LoanRepaymentScheduleTransactionProcessorFactory loanRepaymentScheduleTransactionProcessorFactory,
            final CurrencyReadPlatformService currencyReadPlatformService, final LoanUtilService loanUtilService,
            final LoanRepositoryWrapper loanRepository, final LoanTermVariationsMapper loanTermVariationsMapper) {
