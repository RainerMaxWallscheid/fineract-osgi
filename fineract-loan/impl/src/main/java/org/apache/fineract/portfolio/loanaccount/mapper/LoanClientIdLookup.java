...
@Component
public class LoanClientIdLookup {

    private final ClientActivePort clientActivePort;

    public LoanClientIdLookup(final ClientActivePort clientActivePort) {
        this.clientActivePort = clientActivePort;
    }

    @Named("clientDisplayName")
    public String clientDisplayName(final Long clientId) {
        return clientId == null ? null : this.clientActivePort.displayName(clientId);
    }

    @Named("clientAccountNumber")
    public String clientAccountNumber(final Long clientId) {
