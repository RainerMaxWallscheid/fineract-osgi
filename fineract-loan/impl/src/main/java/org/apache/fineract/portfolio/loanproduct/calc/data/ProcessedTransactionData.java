...
public final class ProcessedTransactionData {
    ...
    ProcessedTransactionData(final LoanTransactionType transactionType, final LocalDate transactionDate,
            final LoanReAgeParameterData reAgeParameter) {
    ...
    public static class ProcessedTransactionDataBuilder {
        ...
        public java.lang.String toString() {
            return "ProcessedTransactionData.ProcessedTransactionDataBuilder(transactionType=" + this.transactionType + ", transactionDate="
                    + this.transactionDate + ", reAgeParameter=" + this.reAgeParameter + ")";
        }
    }
