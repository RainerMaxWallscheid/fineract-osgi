...
public class DefaultLoanScheduleGeneratorFactory implements LoanScheduleGeneratorFactory {
    ...
    public DefaultLoanScheduleGeneratorFactory(final ProgressiveLoanScheduleGenerator progressiveLoanScheduleGenerator,
            final CumulativeFlatInterestLoanScheduleGenerator cumulativeFlatInterestLoanScheduleGenerator,
            final CumulativeDecliningBalanceInterestLoanScheduleGenerator cumulativeDecliningBalanceInterestLoanScheduleGenerator) {
