...
public class LoanTransactionValidatorImpl implements LoanTransactionValidator {
    ...
    public LoanTransactionValidatorImpl(final FromJsonHelper fromApiJsonHelper, final LoanApplicationValidator fromApiJsonDeserializer,
            final LoanRepository loanRepository, final LoanRepositoryWrapper loanRepositoryWrapper,
            final ApplicationCurrencyRepository applicationCurrencyRepository, final LoanUtilService loanUtilService,
            final LoanCollateralPort loanCollateralPort,
