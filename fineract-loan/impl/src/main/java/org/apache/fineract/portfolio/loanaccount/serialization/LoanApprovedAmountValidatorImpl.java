...
public final class LoanApprovedAmountValidatorImpl implements LoanApprovedAmountValidator {
    ...
    public LoanApprovedAmountValidatorImpl(final FromJsonHelper fromApiJsonHelper, final LoanRepository loanRepository,
            final LoanApplicationValidator loanApplicationValidator) {
