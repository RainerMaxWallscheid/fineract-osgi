...
public class InterestScheduleModelServiceGsonContext {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (this$installmentAmountInMultipliesOf == null ? other$installmentAmountInMultipliesOf != null
                : !this$installmentAmountInMultipliesOf.equals(other$installmentAmountInMultipliesOf))
            return false;
    ...
    public java.lang.String toString() {
        return "InterestScheduleModelServiceGsonContext(currency=" + this.getCurrency() + ", mc=" + this.getMc()
                + ", loanProductRelatedDetail=" + this.getLoanProductRelatedDetail() + ", prev=" + this.getPrev()
                + ", installmentAmountInMultipliesOf=" + this.getInstallmentAmountInMultipliesOf() + ")";
    }

    @java.lang.SuppressWarnings("all")
    public InterestScheduleModelServiceGsonContext(final MonetaryCurrency currency, final MathContext mc,
            final ILoanConfigurationDetails loanProductRelatedDetail, final Integer installmentAmountInMultipliesOf) {
