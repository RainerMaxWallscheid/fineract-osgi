...
public class ProgressiveLoanInterestScheduleModel {
    ...
    private BigDecimal findInterestRate(final LocalDate effectiveDate) {
        ...
        //
        //
        interestRates.stream().filter(ir -> !DateUtils.isAfter(ir.effectiveFrom(), effectiveDate)).map(InterestRate::interestRate)
    ...
    public Optional<RepaymentPeriod> changeOutstandingBalanceAndUpdateInterestPeriods(final LocalDate balanceChangeDate,
        ...
        return //
        //
        findRepaymentPeriodForBalanceChange(balanceChangeDate).stream().peek(
                updateInterestPeriodOnRepaymentPeriod(balanceChangeDate, disbursedAmount, correctionAmount, capitalizedIncomePrincipal))
                .findFirst();//
    }
    ...
    public Optional<RepaymentPeriod> updateInterestPeriodsForInterestPause(final LocalDate fromDate, final LocalDate endDate) {
        ...
        final List<RepaymentPeriod> affectedPeriods = //
                ...
                repaymentPeriods.stream()
                        .filter(period -> period.getFromDate().isBefore(endDate) && !period.getDueDate().isBefore(fromDate)).toList();
    ...
    private Optional<InterestPeriod> findInterestPeriodForBalanceChange(final RepaymentPeriod repaymentPeriod,
        ...
        return //
        //
        repaymentPeriod.getInterestPeriods().stream().filter(interestPeriod -> balanceChangeDate.isEqual(interestPeriod.getDueDate()))
                .findFirst();
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (this$installmentAmountInMultiplesOf == null ? other$installmentAmountInMultiplesOf != null
                : !this$installmentAmountInMultiplesOf.equals(other$installmentAmountInMultiplesOf))
            return false;
        ...
        if (this$repaymentPeriods == null ? other$repaymentPeriods != null : !this$repaymentPeriods.equals(other$repaymentPeriods))
            return false;
        ...
        if (this$loanProductRelatedDetail == null ? other$loanProductRelatedDetail != null
                : !this$loanProductRelatedDetail.equals(other$loanProductRelatedDetail))
            return false;
        ...
        if (this$lastOverdueBalanceChange == null ? other$lastOverdueBalanceChange != null
                : !this$lastOverdueBalanceChange.equals(other$lastOverdueBalanceChange))
            return false;
        ...
        if (this$overdueCorrections == null ? other$overdueCorrections != null : !this$overdueCorrections.equals(other$overdueCorrections))
            return false;
        return true;
    }
    ...
    public java.lang.String toString() {
        return "ProgressiveLoanInterestScheduleModel(repaymentPeriods=" + this.repaymentPeriods() + ", interestRates="
                + this.interestRates() + ", loanProductRelatedDetail=" + this.loanProductRelatedDetail()
                + ", installmentAmountInMultiplesOf=" + this.installmentAmountInMultiplesOf() + ", mc=" + this.mc() + ", zero="
                + this.zero() + ", modifiers=" + this.modifiers() + ", lastOverdueBalanceChange=" + this.lastOverdueBalanceChange()
                + ", overdueCorrections=" + this.overdueCorrections() + ")";
    }

    @java.lang.SuppressWarnings("all")
    public ProgressiveLoanInterestScheduleModel(final List<RepaymentPeriod> repaymentPeriods, final TreeSet<InterestRate> interestRates,
            final ILoanConfigurationDetails loanProductRelatedDetail, final Integer installmentAmountInMultiplesOf, final MathContext mc,
            final Money zero, final Map<LoanInterestScheduleModelModifiers, Boolean> modifiers, final LocalDate lastOverdueBalanceChange,
            final List<OverdueBalanceCorrection> overdueCorrections) {
