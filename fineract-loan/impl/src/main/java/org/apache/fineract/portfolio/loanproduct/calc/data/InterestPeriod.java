...
public class InterestPeriod implements Comparable<InterestPeriod> {
    ...
    public BigDecimal getCalculatedDueInterest(InterestMethod method, long lengthTillPeriodDueDate) {
        ...
        //
        //
        baseAmount.multiply(getRateFactorTillPeriodDueDate(), getMc()).divide(BigDecimal.valueOf(lengthTillPeriodDueDate), getMc())
        ...
        if (isFirstInterestPeriod()) {
            ...
            if (previousRepaymentPeriod.isPresent()) {
                ...
                this.outstandingLoanBalance = MathUtil.negativeToZero(//
                        ...
                        //
                        //
                        previousInterestPeriod.getOutstandingLoanBalance().plus(previousInterestPeriod.getDisbursementAmount(), getMc())
                                ...
                                .plus(previousRepaymentPeriod.get().getPaidPrincipal(), getMc()),
                        getMc());//
            }
        } else {
            ...
            this.outstandingLoanBalance = MathUtil.negativeToZero( //
                    //
                    //
                    previousInterestPeriod.getOutstandingLoanBalance().plus(previousInterestPeriod.getBalanceCorrectionAmount(), getMc())
                            .plus(previousInterestPeriod.getCapitalizedIncomePrincipal(), getMc())
    ...
    public java.lang.String toString() {
        return "InterestPeriod(fromDate=" + this.getFromDate() + ", dueDate=" + this.getDueDate() + ", rateFactor=" + this.getRateFactor()
                + ", rateFactorTillPeriodDueDate=" + this.getRateFactorTillPeriodDueDate() + ", creditedPrincipal="
                + this.getCreditedPrincipal() + ", creditedInterest=" + this.getCreditedInterest() + ", disbursementAmount="
                + this.getDisbursementAmount() + ", balanceCorrectionAmount=" + this.getBalanceCorrectionAmount()
                + ", outstandingLoanBalance=" + this.getOutstandingLoanBalance() + ", capitalizedIncomePrincipal="
                + this.getCapitalizedIncomePrincipal() + ", mc=" + this.getMc() + ", isPaused=" + this.isPaused() + ")";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (this$rateFactorTillPeriodDueDate == null ? other$rateFactorTillPeriodDueDate != null
                : !this$rateFactorTillPeriodDueDate.equals(other$rateFactorTillPeriodDueDate))
            return false;
        ...
        if (this$creditedPrincipal == null ? other$creditedPrincipal != null : !this$creditedPrincipal.equals(other$creditedPrincipal))
            return false;
        ...
        if (this$creditedInterest == null ? other$creditedInterest != null : !this$creditedInterest.equals(other$creditedInterest))
            return false;
        ...
        if (this$disbursementAmount == null ? other$disbursementAmount != null : !this$disbursementAmount.equals(other$disbursementAmount))
            return false;
        ...
        if (this$balanceCorrectionAmount == null ? other$balanceCorrectionAmount != null
                : !this$balanceCorrectionAmount.equals(other$balanceCorrectionAmount))
            return false;
        ...
        if (this$outstandingLoanBalance == null ? other$outstandingLoanBalance != null
                : !this$outstandingLoanBalance.equals(other$outstandingLoanBalance))
            return false;
        ...
        if (this$capitalizedIncomePrincipal == null ? other$capitalizedIncomePrincipal != null
                : !this$capitalizedIncomePrincipal.equals(other$capitalizedIncomePrincipal))
            return false;
     ...
     * @param creditedPrincipal
     *            Stores credited principals. Related transactions: Chargeback or Credit Balance Refound
     * @param creditedInterest
     *            Stores credited interest. Related transaction: Chargeback
     ...
     */
    @java.lang.SuppressWarnings("all")
    protected InterestPeriod(final RepaymentPeriod repaymentPeriod, final LocalDate fromDate, final LocalDate dueDate,
            final BigDecimal rateFactor, final BigDecimal rateFactorTillPeriodDueDate, final Money creditedPrincipal,
            final Money creditedInterest, final Money disbursementAmount, final Money balanceCorrectionAmount,
            final Money outstandingLoanBalance, final Money capitalizedIncomePrincipal, final MathContext mc, final boolean isPaused) {
