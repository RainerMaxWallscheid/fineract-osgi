...
public class LoanProduct extends AbstractPersistableCustom<Long> implements LoanEventId {
    ...
    public LoanProduct(final Fund fund, final String transactionProcessingStrategyCode,
            ...
            final BigDecimal inArrearsTolerance, final List<Long> chargeIds, final AccountingRuleType accountingRuleType,
            ...
            Boolean isLinkedToFloatingInterestRates, Long floatingRateId, BigDecimal interestRateDifferential,
        ...
        if (isLinkedToFloatingInterestRate) {
            this.floatingRates = new LoanProductFloatingRates(floatingRateId, this, interestRateDifferential, minDifferentialLendingRate,
