...
public class AccountTransferStandingInstruction extends AbstractPersistableCustom<Long> {
    ...
    private void validateDependencies(final DataValidatorBuilder baseDataValidator) {
        ...
        if (this.accountTransferDetails.toSavingsAccountId() != null) {
        ...
        if (this.accountTransferDetails.transferType().isAccountTransfer() && (this.accountTransferDetails.fromSavingsAccountId() == null
                || this.accountTransferDetails.toSavingsAccountId() == null)) {
            errorCode = "not.account.transfer";
        } else if (this.accountTransferDetails.transferType().isLoanRepayment()
                && (this.accountTransferDetails.fromSavingsAccountId() == null || this.accountTransferDetails.toLoanAccount() == null)) {
