...
public class BuyDownFeeWritePlatformServiceImpl implements BuyDownFeePlatformService {
    ...
    public CommandProcessingResult makeLoanBuyDownFee(final Long loanId, final JsonCommand command) {
        ...
        //
        //
        new CommandProcessingResultBuilder().withClientId(loan.getClientId()).withOfficeId(loan.getOfficeId()).withLoanId(loan.getId())
                .withEntityId(buyDownFeeTransaction.getId()).withEntityExternalId(buyDownFeeTransaction.getExternalId()).build();
    }
    ...
    public CommandProcessingResult buyDownFeeAdjustment(final Long loanId, final Long buyDownFeeTransactionId, final JsonCommand command) {
        ...
        //
        //
        new CommandProcessingResultBuilder().withEntityId(savedBuyDownFeeAdjustment.getId())
    ...
    @java.lang.SuppressWarnings("all")
    public BuyDownFeeWritePlatformServiceImpl(final ProgressiveLoanTransactionValidator loanTransactionValidator,
