...
public class LoanAccrualsProcessingServiceImpl implements LoanAccrualsProcessingService {
    ...
    private void createIncomePostingAndAccrualTransactionOnLoanClosure(Loan loan, LocalDate closedDate, BigDecimal interestToPost,
        ...
        if (loan.isPeriodicAccrualAccountingEnabledOnLoanProduct()) {
            final LocalDate lastAccruedDate = //
                    loanTransactionRepository.findLastNonReversedTransactionDateByLoanAndTypes(loan, ACCRUAL_TYPES)
    ...
    @java.lang.SuppressWarnings("all")
    public LoanAccrualsProcessingServiceImpl(final ExternalIdFactory externalIdFactory,
            ...
            final LoanRepositoryWrapper loanRepositoryWrapper, final LoanTransactionRepository loanTransactionRepository,
            ...
            final TransactionTemplate transactionTemplate, final LoanChargeService loanChargeService,
            final LoanBalanceService loanBalanceService, final LoanChargePaidByRepository loanChargePaidByRepository,
