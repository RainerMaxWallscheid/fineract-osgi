...
| `fineract-rates-impl` | `impl/` | `org.apache.fineract.rates.impl` | JPA, handlers, REST, Spring; **Export-Package** registrar only (`…floatingrates.impl.osgi`); Equinox DS `OSGI-INF/rates.xml` |
