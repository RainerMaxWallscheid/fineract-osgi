...
@Service
public class GLAccountAssociationBridge {

    public GLAccountAssociationBridge(final GLAccountPersistablePort port) {
        GLAccountAssociation.setPersistablePort(port);
    }
}
