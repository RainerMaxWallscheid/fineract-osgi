...
public class AccountingAccrualConfiguration {
    ...
    public AccrualAccountingWritePlatformService accrualAccountingWritePlatformService(
            LoanPeriodicAccrualPort loanPeriodicAccrualPort, AccrualAccountingDataValidator accountingDataValidator) {
        return new AccrualAccountingWritePlatformServiceImpl(loanPeriodicAccrualPort, accountingDataValidator);
    }
}
