...
public class ClientCollateralManagementWriteServiceImpl implements ClientCollateralManagementWriteService {
    ...
    public ClientCollateralCreateResponse createClientCollateralProduct(final ClientCollateralCreateRequest request) {
        ...
        if (!this.clientActivePort.exists(request.getClientId())) {
        ...
        final ClientCollateralManagement clientCollateralManagement = ClientCollateralManagement.createNew(request.getQuantity(), request.getClientId(), collateralManagementData);
        this.clientCollateralManagementRepositoryWrapper.saveAndFlush(clientCollateralManagement);
        return ClientCollateralCreateResponse.builder().resourceId(clientCollateralManagement.getId()).clientId(request.getClientId()).build();
    }

    @Override
    public ClientCollateralUpdateResponse updateClientCollateralProduct(final ClientCollateralUpdateRequest request) {
        validateForUpdate(request);
        final ClientCollateralManagement collateral = this.clientCollateralManagementRepositoryWrapper.getCollateral(request.getCollateralId());
        ...
        ClientCollateralUpdateResponse.ClientCollateralUpdateResponseBuilder builder = ClientCollateralUpdateResponse.builder().resourceId(request.getCollateralId()).clientId(request.getClientId());
        if (changed) {
            builder.changes(ClientCollateralUpdateResponse.Changes.builder().quantity(request.getQuantity()).locale(request.getLocale()).build());
        }
    ...
    public ClientCollateralDeleteResponse deleteClientCollateralProduct(final ClientCollateralDeleteRequest request) {
        final ClientCollateralManagement clientCollateralManagement = this.clientCollateralManagementRepositoryWrapper.getCollateral(request.getCollateralId());
    ...
    public ClientCollateralManagementWriteServiceImpl(
            ...
            final CollateralManagementRepositoryWrapper collateralManagementRepositoryWrapper, final ClientActivePort clientActivePort) {
