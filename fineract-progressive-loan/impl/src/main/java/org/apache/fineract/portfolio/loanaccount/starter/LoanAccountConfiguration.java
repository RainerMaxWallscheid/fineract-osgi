...
public class LoanAccountConfiguration {
    ...
    public LoanAssembler loanAssembler(FromJsonHelper fromApiJsonHelper, LoanRepositoryWrapper loanRepository,
            ...
            LoanCollateralPort loanCollateralPort,
        ...
        return new LoanAssemblerImpl(fromApiJsonHelper, loanRepository, loanProductRepository, groupRepository,
                fundRepository, staffRepository, codeValueRepository, loanScheduleAssembler, loanChargeAssembler, loanCollateralPort,
                ...
                glimAccountInfoWritePlatformService, calculationPlatformService, loanDisbursementDetailsAssembler,
                loanChargeMapper, loanAccrualsProcessingService, loanDisbursementService, loanChargeService,
    ...
    public LoanChargeWritePlatformService loanChargeWritePlatformService(LoanChargeApiJsonValidator loanChargeApiJsonValidator,
            ...
            LoanAccountDomainService loanAccountDomainService, LoanCollateralPort loanCollateralLifecycleService, LoanChargeRepository loanChargeRepository,
        ...
        return new LoanChargeWritePlatformServiceImpl(loanChargeApiJsonValidator, loanAssembler, chargeDefinitionPort,
                ...
                loanAccountDomainService, loanCollateralLifecycleService, loanChargeRepository, loanWritePlatformService, loanUtilService, loanChargeReadPlatformService,
                loanLifecycleStateMachine, accountAssociationsReadPlatformService, fromApiJsonHelper, configurationDomainService,
                externalIdFactory, accountTransferDetailRepository, loanChargeAssembler, paymentDetailWritePlatformService, noteWritePlatformService,
    ...
    public LoanWritePlatformService loanWritePlatformService(PlatformSecurityContext context,
            ...
            LoanAccountDomainService loanAccountDomainService, LoanCollateralPort loanCollateralLifecycleService, NoteWritePlatformService noteWritePlatformService,
        ...
        return new LoanWritePlatformServiceJpaRepositoryImpl(context, loanTransactionValidator, loanUpdateCommandFromApiJsonDeserializer,
                loanRepositoryWrapper, loanAccountDomainService, loanCollateralLifecycleService, noteWritePlatformService, loanTransactionRepository,
                ...
                entityDatatableChecksWritePlatformService, codeValueRepository, cashierTxnValidationPort, glimRepository,
