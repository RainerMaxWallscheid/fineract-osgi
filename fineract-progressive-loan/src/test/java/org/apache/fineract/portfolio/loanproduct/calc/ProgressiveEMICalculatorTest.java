...
class ProgressiveEMICalculatorTest {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ProgressiveEMICalculatorTest.class);
    ...
    private BigDecimal getRateFactorsByMonth(final DaysInYearType daysInYearType, final DaysInMonthType daysInMonthType, final BigDecimal interestRate, LoanRepaymentScheduleInstallment period) {
        ...
        return emiCalculator.rateFactorByRepaymentEveryMonth(interestRate, BigDecimal.ONE, daysInMonth, daysInYear, daysInPeriod, daysInPeriod, mc);
    }
    ...
    public void test_rateFactorByRepaymentEveryMonthMethod_DayInYear365_DaysInMonthActual() {
        ...
        final String[] expectedValues = new String[] {"0.008053375342", "0.007533802740", "0.008053375342", "0.007793589041", "0.008053375342", "0.007793589041"};
        // Then
    ...
    public void test_rateFactorByRepaymentEveryMonthMethod_DayInYearActual_DaysInMonthActual() {
        ...
        final DaysInMonthType daysInMonthType = DaysInMonthType.ACTUAL;
        final String[] expectedValues = new String[] {"0.008031371585", "0.007513218579", "0.008031371585", "0.007772295082", "0.008031371585", "0.007772295082"};
        // Then
        for (LoanRepaymentScheduleInstallment period : periods) {
            BigDecimal rateFactor = getRateFactorsByMonth(daysInYearType, daysInMonthType, interestRate, period);
            Assertions.assertEquals(expectedValues[period.getInstallmentNumber() - 1], rateFactor.toString());
    ...
    public void test_fnValueFunction_RepayEvery1Month_DayInYear365_DaysInMonthActual() {
        ...
        final DaysInYearType daysInYearType = DaysInYearType.DAYS_365;
        final DaysInMonthType daysInMonthType = DaysInMonthType.ACTUAL;
        final String[] expectedValues = new String[] {"1.00000000000", "2.00753380274", "3.02370122596", "4.04726671069", "5.07986086861", "6.11945121660"};
        final List<BigDecimal> fnValuesCalculated = new ArrayList<>();
        BigDecimal previousFnValue = BigDecimal.ZERO;
        for (LoanRepaymentScheduleInstallment period : periods) {
            BigDecimal rateFactorPlus1 = getRateFactorsByMonth(daysInYearType, daysInMonthType, interestRate, period).add(BigDecimal.ONE, MoneyHelper.getMathContext());
    ...
    public void test_generateInterestScheduleModel() {
        ...
        Mockito.when(loanProductRelatedDetail.getCurrencyData()).thenReturn(currency);
        final ProgressiveLoanInterestScheduleModel interestScheduleModel = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
    ...
    public void test_emi_calculator_performance() {
        ...
        final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
    ...
    public void test_emiAdjustment_newCalculatedEmiNotBetterThanOriginal() {
        ...
        checkPeriod(interestSchedule, 2, 0, 17.43, 0.013315561644, 0.899066722202, 0.9, 16.53, 50.99);
    ...
    public void test_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 2, 0, 17.13, 0.007901833333, 0.530924181643, 0.53, 16.6, 50.59);
        checkPeriod(interestSchedule, 3, 0, 17.13, 0.007901833333, 0.399753748317, 0.4, 16.73, 33.86);
        checkPeriod(interestSchedule, 4, 0, 17.13, 0.007901833333, 0.267556076655, 0.27, 16.86, 17.0);
        checkPeriod(interestSchedule, 5, 0, 17.13, 0.007901833333, 0.134331166661, 0.13, 17.0, 0.0);
    }
    ...
    public void test_reschedule_interest_on0201_4per_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 1, 0, 16.88, 0.003333333333, 0.278566666639, 0.28, 16.6, 66.97);
        checkPeriod(interestSchedule, 2, 0, 16.88, 0.003333333333, 0.223233333311, 0.22, 16.66, 50.31);
        checkPeriod(interestSchedule, 3, 0, 16.88, 0.003333333333, 0.167699999983, 0.17, 16.71, 33.6);
    ...
    public void test_reschedule_interest_on0201_2nd_EMI_not_changeable_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        Mockito.when(loanProductRelatedDetail.getCurrencyData()).thenReturn(currency);
        threadLocalContextUtil.when(ThreadLocalContextUtil::getBusinessDate).thenReturn(LocalDate.of(2024, 2, 14));
        final ProgressiveLoanInterestScheduleModel interestModel = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
        final Money disbursedAmount = toMoney(100.0);
        emiCalculator.addDisbursement(interestModel, LocalDate.of(2024, 1, 1), disbursedAmount);
        emiCalculator.payInterest(interestModel, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), toMoney(0.58));
        emiCalculator.payPrincipal(interestModel, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), toMoney(16.43));
        emiCalculator.payPrincipal(interestModel, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 2, 1), toMoney(16.9));
        final BigDecimal interestRateNewValue = BigDecimal.valueOf(4.0);
        final LocalDate interestChangeDate = LocalDate.of(2024, 2, 2);
    ...
    public void test_reschedule_interest_on0120_adjsLst_dsbAmt100_dayInYears360_daysInMonth30_rpEvery1M() {
        ...
        final Money disbursedAmount = toMoney(100.0);
        emiCalculator.addDisbursement(interestModel, LocalDate.of(2024, 1, 1), disbursedAmount);
        emiCalculator.payPrincipal(interestModel, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 1, 15), toMoney(17.01));
        final BigDecimal interestRateNewValue = BigDecimal.valueOf(4.0);
        final LocalDate interestChangeDate = LocalDate.of(2024, 1, 20);
        emiCalculator.changeInterestRate(interestModel, interestChangeDate, interestRateNewValue);
        checkPeriod(interestModel, 0, 0, 16.8, 0.0, 0.0, 0.44, 16.36, 66.63);
        checkPeriod(interestModel, 0, 1, 16.8, 0.002634408602, 0.2634408602, 0.44, 16.36, 66.63);
        checkPeriod(interestModel, 0, 2, 16.8, 7.52688172E-4, 0.0624655913944, 0.44, 16.36, 66.63);
        checkPeriod(interestModel, 0, 3, 16.8, 0.001397849462, 0.116007526851, 0.44, 16.36, 66.63);
        checkPeriod(interestModel, 1, 0, 16.8, 0.003333333333, 0.222099999978, 0.22, 16.58, 50.05);
        checkPeriod(interestModel, 2, 0, 16.8, 0.003333333333, 0.166833333317, 0.17, 16.63, 33.42);
        checkPeriod(interestModel, 3, 0, 16.8, 0.003333333333, 0.111399999989, 0.11, 16.69, 16.73);
    ...
    public void test_reschedule_interest_on0215_4per_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.01, 0.0, 0.0, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.5833333333, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 1, 0, 16.9, 0.002614942529, 0.218530747114, 0.37, 16.53, 67.04);
        checkPeriod(interestSchedule, 1, 1, 16.9, 0.00183908046, 0.153691954042, 0.37, 16.53, 67.04);
        checkPeriod(interestSchedule, 2, 0, 16.9, 0.003333333333, 0.223466666644, 0.22, 16.68, 50.36);
        checkPeriod(interestSchedule, 3, 0, 16.9, 0.003333333333, 0.16786666665, 0.17, 16.73, 33.63);
        checkPeriod(interestSchedule, 4, 0, 16.9, 0.003333333333, 0.112099999989, 0.11, 16.79, 16.84);
        checkPeriod(interestSchedule, 5, 0, 16.9, 0.003333333333, 0.0561333333276, 0.06, 16.84, 0.0);
    }
    ...
    public void test_balance_correction_on0215_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        PeriodDueDetails dueAmounts = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 1, 1));
        ...
        dueAmounts = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 1));
        ...
        final PeriodDueDetails repaymentDetails1st = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 2, 1), op1stCorrectionPeriodDueDate, op1stCorrectionDate);
        ...
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 2, 1), op1stCorrectionPeriodDueDate, op1stCorrectionDate, op1stCorrectionAmount);
        emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 2, 1), op1stCorrectionPeriodDueDate, op1stCorrectionDate, toMoney(0.24));
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.5833333333, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 1, 0, 17.01, 0.002816091954, 0.235340804584, 0.24, 16.77, 66.8);
        checkPeriod(interestSchedule, 1, 1, 17.01, 0.003017241379, 0.201551724117, 0.24, 16.77, 66.8);
        ...
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.196349999989, 0.2, 16.81, 16.85);
        checkPeriod(interestSchedule, 5, 0, 16.95, 0.005833333333, 0.098291666661, 0.1, 16.85, 0.0);
        ...
        // get remaining balance and dues for a date
        final PeriodDueDetails repaymentDetails2st = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 3, 1), op2ndCorrectionPeriodDueDate, op2ndCorrectionDate);
        Assertions.assertEquals(16.81, toDouble(repaymentDetails2st.getDuePrincipal()));
        Assertions.assertEquals(0.2, toDouble(repaymentDetails2st.getDueInterest()));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 3, 1), op2ndCorrectionPeriodDueDate, op2ndCorrectionDate, op2ndCorrectionAmount);
        emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 3, 1), op2ndCorrectionPeriodDueDate, op2ndCorrectionDate, toMoney(0.49));
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.5833333333, 0.58, 16.43, 83.57);
        ...
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.195766666655, 0.2, 16.81, 16.75);
        checkPeriod(interestSchedule, 5, 0, 16.85, 0.005833333333, 0.0977083333278, 0.1, 16.75, 0.0);
        ...
        final PeriodDueDetails repaymentDetails3rd = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 6, 1), periodDueDate, payDate);
        ...
        final PeriodDueDetails repaymentDetails4th = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 6, 1), periodDueDate, payDate);
    ...
    public void test_payoff_on0215_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        PeriodDueDetails details = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 1));
        ...
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), op1stCorrectionDate, op1stCorrectionAmount);
        details = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 1));
        Assertions.assertEquals(16.52, toDouble(details.getDuePrincipal()));
        Assertions.assertEquals(0.49, toDouble(details.getDueInterest()));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 15), toMoney(1.43));
        emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 15), toMoney(0.58));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 2, 15), toMoney(16.77));
        emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 2, 15), toMoney(0.24));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), LocalDate.of(2024, 2, 15), toMoney(17.01));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 4, 1), LocalDate.of(2024, 5, 1), LocalDate.of(2024, 2, 15), toMoney(17.01));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 5, 1), LocalDate.of(2024, 6, 1), LocalDate.of(2024, 2, 15), toMoney(17.01));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 2, 15), toMoney(15.77));
    ...
    public void test_payoff_on0115_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        PeriodDueDetails dueAmounts = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1));
        ...
        dueAmounts = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 1, 15));
        ...
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 1, 15), toMoney(16.75));
        emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 1, 15), toMoney(0.26));
        // check again numbers are zero
        // dueAmounts = emiCalculator.getdueAmounts(interestSchedule, LocalDate.of(2024, 2, 1),
        // LocalDate.of(2024, 2, 1));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 1, 15), toMoney(17.01));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), LocalDate.of(2024, 1, 15), toMoney(17.01));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 4, 1), LocalDate.of(2024, 5, 1), LocalDate.of(2024, 1, 15), toMoney(17.01));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 5, 1), LocalDate.of(2024, 6, 1), LocalDate.of(2024, 1, 15), toMoney(17.01));
        dueAmounts = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 7, 1));
        ...
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 1, 15), toMoney(15.21));
        // check periods in model
    ...
    public void test_multiDisbursedAmt300InSamePeriod_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 4, 0, 51.33, 0.007901833333, 0.801720009967, 0.8, 50.53, 50.93);
        checkPeriod(interestSchedule, 5, 0, 51.33, 0.007901833333, 0.40244037165, 0.4, 50.93, 0.0);
    }
    ...
    public void test_multiDisbursedAmt200InDifferentPeriod_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.13, 0.0, 0.0, 0.79, 16.34, 83.66);
        checkPeriod(interestSchedule, 0, 1, 17.13, 0.007901833333, 0.790183333301, 0.79, 16.34, 83.66);
        checkPeriod(interestSchedule, 1, 0, 37.53, 0.003814678161, 0.31913597493, 1.07, 36.46, 147.2);
        checkPeriod(interestSchedule, 1, 1, 37.53, 0.004087155172, 0.75064691889, 1.07, 36.46, 147.2);
    ...
    public void test_multiDisbursedAmt150InSamePeriod_dayInYears360_daysInMonth30_repayEvery1Month_backdated_disbursement() {
        ...
        checkPeriod(interestSchedule, 0, 0, 29.94, 0.001019591398, 0.0, 1.15, 28.79, 146.21);
        checkPeriod(interestSchedule, 0, 1, 29.94, 7.64693548E-4, 0.0764693548332, 1.15, 28.79, 146.21);
        ...
        checkPeriod(interestSchedule, 3, 0, 29.94, 0.007901833333, 0.698680103304, 0.7, 29.24, 59.18);
    ...
    public void test_disbursedAmt100_dayInYearsActual_daysInMonthActual_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.13, 0.0, 0.0, 0.8, 16.33, 83.67);
        checkPeriod(interestSchedule, 0, 1, 17.13, 0.008044857759, 0.8044857759, 0.8, 16.33, 83.67);
        checkPeriod(interestSchedule, 1, 0, 17.13, 0.008031371585, 0.671984860516, 0.67, 16.46, 67.21);
        checkPeriod(interestSchedule, 2, 0, 17.13, 0.007513218579, 0.504963420695, 0.5, 16.63, 50.58);
    ...
    public void test_multidisbursement_total_repay1st_dayInYears360_daysInMonth30_repayEvery1Month() {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1)), periodData(LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1)), periodData(LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1)), periodData(LocalDate.of(2024, 4, 1), LocalDate.of(2024, 5, 1)), periodData(LocalDate.of(2024, 5, 1), LocalDate.of(2024, 6, 1)), periodData(LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1)));
        final BigDecimal interestRate = BigDecimal.valueOf(7.0);
        final Integer installmentAmountInMultiplesOf = null;
        Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
        Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.DAYS_360.getValue());
        ...
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 1, 1), toMoney(51.03));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 1, 1), toMoney(51.03));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), LocalDate.of(2024, 1, 1), toMoney(51.03));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 4, 1), LocalDate.of(2024, 5, 1), LocalDate.of(2024, 1, 1), toMoney(51.03));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 5, 1), LocalDate.of(2024, 6, 1), LocalDate.of(2024, 1, 1), toMoney(51.03));
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 1, 1), toMoney(44.85));
    ...
    public void test_disbursedAmt1000_NoInterest_repayEvery1Month() {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1)), periodData(LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1)), periodData(LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1)), periodData(LocalDate.of(2024, 4, 1), LocalDate.of(2024, 5, 1)));
    ...
    public void test_disbursedAmt100_dayInYears364_daysInMonthActual_repayEvery1Week() {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 1, 8)), periodData(LocalDate.of(2024, 1, 8), LocalDate.of(2024, 1, 15)), periodData(LocalDate.of(2024, 1, 15), LocalDate.of(2024, 1, 22)), periodData(LocalDate.of(2024, 1, 22), LocalDate.of(2024, 1, 29)), periodData(LocalDate.of(2024, 1, 29), LocalDate.of(2024, 2, 5)), periodData(LocalDate.of(2024, 2, 5), LocalDate.of(2024, 2, 12)));
        final BigDecimal interestRate = BigDecimal.valueOf(9.4822);
        final Integer installmentAmountInMultiplesOf = null;
        Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
        ...
        checkPeriod(interestSchedule, 0, 1, 16.77, 0.0018235, 0.18235, 0.18, 16.59, 83.41);
        checkPeriod(interestSchedule, 1, 0, 16.77, 0.0018235, 0.152098135, 0.15, 16.62, 66.79);
        checkPeriod(interestSchedule, 2, 0, 16.77, 0.0018235, 0.121791565, 0.12, 16.65, 50.14);
        checkPeriod(interestSchedule, 3, 0, 16.77, 0.0018235, 0.09143029, 0.09, 16.68, 33.46);
        checkPeriod(interestSchedule, 4, 0, 16.77, 0.0018235, 0.06101431, 0.06, 16.71, 16.75);
        checkPeriod(interestSchedule, 5, 0, 16.78, 0.0018235, 0.030543625, 0.03, 16.75, 0.0);
    }

    @Test
    public void test_disbursedAmt100_dayInYears364_daysInMonthActual_repayEvery2Week() {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 1, 15)), periodData(LocalDate.of(2024, 1, 15), LocalDate.of(2024, 1, 29)), periodData(LocalDate.of(2024, 1, 29), LocalDate.of(2024, 2, 12)));
        final BigDecimal interestRate = BigDecimal.valueOf(9.4822);
        final Integer installmentAmountInMultiplesOf = null;
        Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
        Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.DAYS_364.getValue());
        ...
        checkPeriod(interestSchedule, 0, 1, 33.57, 0.003647, 0.3647, 0.36, 33.21, 66.79);
        checkPeriod(interestSchedule, 1, 0, 33.57, 0.003647, 0.24358313, 0.24, 33.33, 33.46);
        checkPeriod(interestSchedule, 2, 0, 33.58, 0.003647, 0.12202862, 0.12, 33.46, 0.0);
    }

    @Test
    public void test_disbursedAmt100_dayInYears360_daysInMonthDoesntMatter_repayEvery15Days() {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 1, 16)), periodData(LocalDate.of(2024, 1, 16), LocalDate.of(2024, 1, 31)), periodData(LocalDate.of(2024, 1, 31), LocalDate.of(2024, 2, 15)), periodData(LocalDate.of(2024, 2, 15), LocalDate.of(2024, 3, 1)), periodData(LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 16)), periodData(LocalDate.of(2024, 3, 16), LocalDate.of(2024, 3, 31)));
        final BigDecimal interestRate = BigDecimal.valueOf(9.4822);
        final Integer installmentAmountInMultiplesOf = null;
        Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
        Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.DAYS_360.getValue());
        ...
        final Money disbursedAmount = toMoney(100.0);
        emiCalculator.addDisbursement(interestSchedule, LocalDate.of(2024, 1, 1), disbursedAmount);
        checkPeriod(interestSchedule, 0, 0, 16.9, 0.0, 0.0, 0.4, 16.5, 83.5);
        checkPeriod(interestSchedule, 0, 1, 16.9, 0.003950916667, 0.3950916667, 0.4, 16.5, 83.5);
        checkPeriod(interestSchedule, 1, 0, 16.9, 0.003950916667, 0.329901541694, 0.33, 16.57, 66.93);
        checkPeriod(interestSchedule, 2, 0, 16.9, 0.003950916667, 0.264434852522, 0.26, 16.64, 50.29);
        checkPeriod(interestSchedule, 3, 0, 16.9, 0.003950916667, 0.198691599183, 0.2, 16.7, 33.59);
        checkPeriod(interestSchedule, 4, 0, 16.9, 0.003950916667, 0.132711290845, 0.13, 16.77, 16.82);
    ...
    public void test_disbursedAmt1000_actual_actual_repayEvery1Month_verify_due_principal_amounts() {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1)), periodData(LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1)), periodData(LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1)), periodData(LocalDate.of(2024, 4, 1), LocalDate.of(2024, 5, 1)), periodData(LocalDate.of(2024, 5, 1), LocalDate.of(2024, 6, 1)), periodData(LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1)), periodData(LocalDate.of(2024, 7, 1), LocalDate.of(2024, 8, 1)), periodData(LocalDate.of(2024, 8, 1), LocalDate.of(2024, 9, 1)), periodData(LocalDate.of(2024, 9, 1), LocalDate.of(2024, 10, 1)), periodData(LocalDate.of(2024, 10, 1), LocalDate.of(2024, 11, 1)), periodData(LocalDate.of(2024, 11, 1), LocalDate.of(2024, 12, 1)), periodData(LocalDate.of(2024, 12, 1), LocalDate.of(2025, 1, 1)));
    ...
    public void test_dailyInterest_disbursedAmt1000_dayInYears360_daysInMonth30_repayIn1Month() {
        ...
        checkDailyInterest(interestModel, dueDate, startDay, 17, 0.19, 3.2);
    ...
    public void test_dailyInterest_disbursedAmt2000_dayInYears360_daysInMonth30_repayIn2Month() {
        ...
        checkDailyInterest(interestModel, dueDate, startDay, 28, 0.37, 7.9);
    ...
    public void test_singleInterestPauseAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.01, 0.0, 0.0, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.5833333333, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 1, 0, 17.01, 6.03448276E-4, 0.0504301724109, 0.39, 16.62, 66.95);
    ...
    public void test_interestPauseFirstDayOfMonthAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 2, 17.01, 1.88172043E-4, 0.0, 0.56, 16.45, 83.55);
        checkPeriod(interestSchedule, 1, 0, 17.01, 8.04597701E-4, 0.0, 0.42, 16.59, 66.96);
    ...
    public void test_interestPauseLastDayOfMonthAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 3, 17.01, 1.88172043E-4, 0.0188172043, 0.17, 16.84, 83.16);
    ...
    public void test_interestPauseWholeMonthAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 1, 1, 17.01, 2.01149425E-4, 0.0168060344588, 0.02, 16.99, 66.56);
    ...
    public void test_interestPauseTwoWholeMonthsAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 2, 1, 17.01, 1.88172043E-4, 0.0125209677412, 0.01, 17.0, 49.54);
    ...
    public void test_interestPauseAndExistedMultipleInterestPeriodsAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.01, 0.0, 0.0, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.5833333333, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 1, 0, 17.01, 6.03448276E-4, 0.0504301724109, 0.3, 16.71, 66.86);
    ...
    public void test_interestPauseBetweenRepaymentPeriodsAndExistedMultipleInterestPeriods_Amt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.01, 0.0, 0.0, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.5833333333, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 1, 0, 17.01, 8.04597701E-4, 0.0672402298812, 0.13, 16.88, 66.69);
        checkPeriod(interestSchedule, 1, 1, 17.01, 8.04597701E-4, 0.0672402298824, 0.13, 16.88, 66.69);
        checkPeriod(interestSchedule, 1, 2, 17.01, 0.002212643678, 0.0, 0.13, 16.88, 66.69);
        checkPeriod(interestSchedule, 2, 0, 17.01, 7.52688172E-4, 0.0, 0.28, 16.73, 49.96);
        // interest period from 2024-03-05 to 2024-03-10
        checkPeriod(interestSchedule, 2, 1, 17.01, 9.40860215E-4, 0.0, 0.28, 16.73, 49.96);
        checkPeriod(interestSchedule, 3, 0, 17.01, 0.005833333333, 0.291433333317, 0.29, 16.72, 33.24);
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.193899999989, 0.19, 16.82, 16.42);
        checkPeriod(interestSchedule, 5, 0, 16.52, 0.005833333333, 0.095783333328, 0.1, 16.42, 0.0);
    }
    ...
    public void test_interestPauseOnTheFirstAndThirdRepaymentPeriodAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.01, 0.0, 0.0, 0.0, 17.01, 82.99); //
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.0, 0.0, 17.01, 82.99); //
        checkPeriod(interestSchedule, 1, 0, 17.01, 0.005833333333, 0.484108333307, 0.48, 16.53, 66.46); //
        checkPeriod(interestSchedule, 2, 0, 17.01, 0.005833333333, 0.0, 0.0, 17.01, 49.45); //
        ...
        checkPeriod(interestSchedule, 5, 0, 16.0, 0.005833333333, 0.0928083333279, 0.09, 15.91, 0.0); //
    }
    ...
    public void test_interestPauseOnTheFirstDayOfFirstPeriodAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 2, 17.01, 0.004139784946, 0.4139784946, 0.41, 16.6, 83.4);
        checkPeriod(interestSchedule, 1, 0, 17.01, 0.005833333333, 0.486499999972, 0.49, 16.52, 66.88); //
        checkPeriod(interestSchedule, 2, 0, 17.01, 0.005833333333, 0.39013333331, 0.39, 16.62, 50.26); //
        checkPeriod(interestSchedule, 3, 0, 17.01, 0.005833333333, 0.293183333317, 0.29, 16.72, 33.54); //
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.195649999989, 0.2, 16.81, 16.73); //
        checkPeriod(interestSchedule, 5, 0, 16.83, 0.005833333333, 0.0975916666611, 0.1, 16.73, 0.0); //
    }
    ...
    public void test_reschedule_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 3, 0, 17.01, 0.005833333333, 0.29761666665, 0.3, 16.71, 34.31);
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.200141666655, 0.2, 16.81, 17.5);
        checkPeriod(interestSchedule, 5, 0, 19.85, 0.005833333333, 2.34791666667, 2.35, 17.5, 0.0);
    }
    ...
    public void test_two_reschedules_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 3, 0, 17.01, 0.005833333333, 0.299949999983, 0.3, 16.71, 34.71);
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.202474999988, 0.2, 16.81, 17.9);
        checkPeriod(interestSchedule, 5, 0, 20.41, 0.005833333333, 2.506, 2.51, 17.9, 0.0);
    }
    ...
    public void test_reschedule_partial_period_disbursedAmt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 0, 0, 17.01, 0.0, 0.0, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 0, 1, 17.01, 0.005833333333, 0.5833333333, 0.58, 16.43, 83.57);
        checkPeriod(interestSchedule, 1, 0, 17.01, 0.005833333333, 1.20247944445, 1.2, 15.81, 67.76);
        checkPeriod(interestSchedule, 2, 0, 17.01, 0.005833333333, 0.395266666644, 0.4, 16.61, 51.15);
        checkPeriod(interestSchedule, 3, 0, 17.01, 0.005833333333, 0.298374999983, 0.3, 16.71, 34.44);
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.200899999989, 0.2, 16.81, 17.63);
    ...
    public void test_actual_actual_repayment_schedule_across_multiple_years() {
        ...
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2023, 11, 13), LocalDate.of(2023, 12, 13)), periodData(LocalDate.of(2023, 12, 13), LocalDate.of(2024, 1, 13)), periodData(LocalDate.of(2024, 1, 13), LocalDate.of(2024, 2, 13)), periodData(LocalDate.of(2024, 2, 13), LocalDate.of(2024, 3, 13)), periodData(LocalDate.of(2024, 3, 13), LocalDate.of(2024, 4, 13)), periodData(LocalDate.of(2024, 4, 13), LocalDate.of(2024, 5, 13)));
        ...
        emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2023, 11, 13), LocalDate.of(2023, 12, 13), LocalDate.of(2023, 12, 10), Money.of(currency, BigDecimal.valueOf(820.76)));
        emiCalculator.payInterest(interestSchedule, LocalDate.of(2023, 11, 13), LocalDate.of(2023, 12, 13), LocalDate.of(2023, 12, 10), Money.of(currency, BigDecimal.valueOf(36.95)));
    ...
    public void test_360_30_repayment_schedule_disbursement_month_end() {
        MathContext mc = new MathContext(12, RoundingMode.HALF_UP);
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2023, 10, 31), LocalDate.of(2023, 11, 30)), periodData(LocalDate.of(2023, 11, 30), LocalDate.of(2023, 12, 31)), periodData(LocalDate.of(2023, 12, 31), LocalDate.of(2024, 1, 31)), periodData(LocalDate.of(2024, 1, 31), LocalDate.of(2024, 2, 29)), periodData(LocalDate.of(2024, 2, 29), LocalDate.of(2024, 3, 31)), periodData(LocalDate.of(2024, 3, 31), LocalDate.of(2024, 4, 30)));
        final BigDecimal interestRate = BigDecimal.valueOf(9.99);
        final Integer installmentAmountInMultiplesOf = null;
        Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
        Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.DAYS_360.getValue());
        ...
        emiCalculator.addDisbursement(interestSchedule, disbursementDate, disbursedAmount);
        checkPeriod(interestSchedule, 0, 420.31, 20.4, 399.91, 2050.09, false);
        checkPeriod(interestSchedule, 1, 420.31, 17.07, 403.24, 1646.85, false);
        checkPeriod(interestSchedule, 2, 420.31, 13.71, 406.6, 1240.25, false);
        checkPeriod(interestSchedule, 3, 420.31, 10.33, 409.98, 830.27, false);
        checkPeriod(interestSchedule, 4, 420.31, 6.91, 413.4, 416.87, false);
        checkPeriod(interestSchedule, 5, 420.34, 3.47, 416.87, 0.0, false);
    }

    @Test
    public void test_360_30_repayment_schedule_disbursement_near_month_end() {
        MathContext mc = new MathContext(12, RoundingMode.HALF_UP);
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2023, 10, 30), LocalDate.of(2023, 11, 30)), periodData(LocalDate.of(2023, 11, 30), LocalDate.of(2023, 12, 30)), periodData(LocalDate.of(2023, 12, 30), LocalDate.of(2024, 1, 30)), periodData(LocalDate.of(2024, 1, 30), LocalDate.of(2024, 2, 29)), periodData(LocalDate.of(2024, 2, 29), LocalDate.of(2024, 3, 30)), periodData(LocalDate.of(2024, 3, 30), LocalDate.of(2024, 4, 30)));
        ...
        emiCalculator.addDisbursement(interestSchedule, disbursementDate, disbursedAmount);
        checkPeriod(interestSchedule, 0, 1892.12, 375.0, 1517.12, 8482.88, false);
        ...
        checkPeriod(interestSchedule, 5, 1892.13, 68.39, 1823.74, 0.0, false);
    }

    @Test
    public void test_360_30_repayment_schedule_disbursement_repay_every_2_months() {
        MathContext mc = new MathContext(12, RoundingMode.HALF_UP);
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2023, 10, 29), LocalDate.of(2023, 12, 29)), periodData(LocalDate.of(2023, 12, 29), LocalDate.of(2024, 2, 29)), periodData(LocalDate.of(2024, 2, 29), LocalDate.of(2024, 4, 29)), periodData(LocalDate.of(2024, 4, 29), LocalDate.of(2024, 6, 29)), periodData(LocalDate.of(2024, 6, 29), LocalDate.of(2024, 8, 29)), periodData(LocalDate.of(2024, 8, 29), LocalDate.of(2024, 10, 29)));
        ...
        emiCalculator.addDisbursement(interestSchedule, disbursementDate, disbursedAmount);
        checkPeriod(interestSchedule, 0, 622.04, 111.04, 511.0, 2822.0, false);
        ...
        checkPeriod(interestSchedule, 5, 622.07, 20.06, 602.01, 0.0, false);
    }
    ...
    public void test_actual_actual_repayment_schedule_disbursement_month_end() {
        ...
        checkPeriod(interestSchedule, 5, 46343.25, 1648.57, 44694.68, 0.0, false);
    }

    @Test
    public void test_actual_actual_repayment_schedule_disbursement_near_month_end() {
        MathContext mc = new MathContext(12, RoundingMode.HALF_UP);
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2021, 10, 30), LocalDate.of(2021, 11, 30)), periodData(LocalDate.of(2021, 11, 30), LocalDate.of(2021, 12, 30)), periodData(LocalDate.of(2021, 12, 30), LocalDate.of(2022, 1, 30)), periodData(LocalDate.of(2022, 1, 30), LocalDate.of(2022, 2, 28)), periodData(LocalDate.of(2022, 2, 28), LocalDate.of(2022, 3, 30)), periodData(LocalDate.of(2022, 3, 30), LocalDate.of(2022, 4, 30)));
        final BigDecimal interestRate = BigDecimal.valueOf(9.4822);
        final Integer installmentAmountInMultiplesOf = null;
        Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
        Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.ACTUAL.getValue());
        ...
        checkPeriod(interestSchedule, 3, 256.95, 5.72, 251.23, 507.9, false);
        checkPeriod(interestSchedule, 4, 256.95, 3.96, 252.99, 254.91, false);
        checkPeriod(interestSchedule, 5, 256.96, 2.05, 254.91, 0.0, false);
    }

    @Test
    public void test_actual_actual_repayment_schedule_disbursement_near_month_end_repay_every_2_months() {
        MathContext mc = new MathContext(12, RoundingMode.HALF_UP);
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2022, 10, 29), LocalDate.of(2022, 12, 29)), periodData(LocalDate.of(2022, 12, 29), LocalDate.of(2023, 2, 28)), periodData(LocalDate.of(2023, 2, 28), LocalDate.of(2023, 4, 29)), periodData(LocalDate.of(2023, 4, 29), LocalDate.of(2023, 6, 29)), periodData(LocalDate.of(2023, 6, 29), LocalDate.of(2023, 8, 29)), periodData(LocalDate.of(2023, 8, 29), LocalDate.of(2023, 10, 29)));
        final BigDecimal interestRate = BigDecimal.valueOf(7);
        final Integer installmentAmountInMultiplesOf = null;
        Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
        Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.ACTUAL.getValue());
        ...
        checkPeriod(interestSchedule, 2, 867.68, 38.8, 828.88, 2543.28, false);
        ...
        checkPeriod(interestSchedule, 5, 867.65, 10.03, 857.62, 0.0, false);
    }
    ...
    public void test_actual_actual_fraction_period_calculation_with_interestRecognitionFromDisbursementDate_false() {
        ...
        Mockito.when(loanProductRelatedDetail.getRepayEvery()).thenReturn(1);
        Mockito.when(loanProductRelatedDetail.getCurrencyData()).thenReturn(currency);
        final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, null, mc);
        ...
        checkPeriod(interestSchedule, 3, 857.71, 20.04, 837.67, 1694.14, false);
        checkPeriod(interestSchedule, 4, 857.71, 14.33, 843.38, 850.76, false);
        checkPeriod(interestSchedule, 5, 857.73, 6.97, 850.76, 0.0, false);
    }
    ...
    public void test_actual_actual_fraction_period_calculation_with_interestRecognitionFromDisbursementDate_true() {
        ...
        checkPeriod(interestSchedule, 5, 857.69, 6.97, 850.72, 0.0, false);
    }
    ...
    class ChargeBackPrincipalAmt100DayInYears360DaysInMonth30RepayEvery1MonthTests {
        ...
        public void test_S1_full_chargeback_on_due_date_before_maturity_date() {
            ...
            checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.196641666655, 0.2, 16.81, 16.9);
            checkPeriod(interestSchedule, 5, 0, 17.0, 0.005833333333, 0.0985833333276, 0.1, 16.9, 0.0);
            // repay 1st period
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), toMoney(16.43));
            emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), toMoney(0.58));
            // repay 2nd period
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 1), toMoney(16.52));
            emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 1), toMoney(0.49));
            ...
            checkPeriod(interestSchedule, 5, 0, 17.1, 0.005833333333, 0.0991666666611, 0.1, 17.0, 0.0);
        }
        ...
        public void test_S2_S3_partial_and_full_chargeback_on_due_date_before_maturity_date() {
            ...
            checkPeriod(interestSchedule, 3, 0, 17.01, 0.005833333333, 0.294699999983, 0.29, 16.72, 33.8);
            ...
            checkPeriod(interestSchedule, 5, 0, 17.2, 0.005833333333, 0.0997499999943, 0.1, 17.1, 0.0);
        }
    ...
    public void test_chargeback_principalAndInterest_Amt100_dayInYears360_daysInMonth30_repayEvery1Month__() {
        ...
        emiCalculator.creditPrincipal(interestSchedule, txnDate, toMoney(16.52));
        emiCalculator.creditInterest(interestSchedule, txnDate, toMoney(0.49));
        checkPeriod(interestSchedule, 5, 0, 17.0, 0.005833333333, 0.0985833333276, 0.59, 33.42, 0.0);
    }
    ...
    public void test_multi_chargeback_Amt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        checkPeriod(interestSchedule, 3, 0, 17.01, 0.005833333333, 0.295224999983, 0.3, 16.71, 33.9);
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.197749999989, 0.2, 16.81, 17.09);
        checkPeriod(interestSchedule, 5, 0, 17.19, 0.005833333333, 0.0996916666611, 0.1, 17.09, 0.0);
    }
    ...
    class LeapYear366OnlyForPeriodWith29thOfFebruaryTest {
        ...
        public void test_leap_year_only_actual_for_loan_S1() {
            ...
            Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
            Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.ACTUAL.getValue());
            Mockito.when(loanProductRelatedDetail.getDaysInYearCustomStrategy()).thenReturn(DaysInYearCustomStrategyType.FEB_29_PERIOD_ONLY);
            Mockito.when(loanProductRelatedDetail.getDaysInMonthType()).thenReturn(DaysInMonthType.ACTUAL.getValue());
            Mockito.when(loanProductRelatedDetail.getRepaymentPeriodFrequencyType()).thenReturn(PeriodFrequencyType.MONTHS);
            Mockito.when(loanProductRelatedDetail.getRepayEvery()).thenReturn(1);
            Mockito.when(loanProductRelatedDetail.getCurrencyData()).thenReturn(currency);
            ...
            checkPeriod(interestSchedule, 2, 1713.21, 50.5, 1662.71, 5058.78, false);
            ...
            checkPeriod(interestSchedule, 5, 1713.18, 13.69, 1699.49, 0.0, false);
        }
        ...
        public void test_leap_year_only_actual_for_loan_S2() {
            final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 7, 23), LocalDate.of(2024, 8, 23)), periodData(LocalDate.of(2024, 8, 23), LocalDate.of(2024, 9, 23)), periodData(LocalDate.of(2024, 9, 23), LocalDate.of(2024, 10, 23)), periodData(LocalDate.of(2024, 10, 23), LocalDate.of(2024, 11, 23)));
            ...
            checkPeriod(interestSchedule, 1, 3845.41, 115.24, 3730.17, 7577.3, false);
            checkPeriod(interestSchedule, 2, 3845.41, 74.74, 3770.67, 3806.63, false);
            checkPeriod(interestSchedule, 3, 3845.43, 38.8, 3806.63, 0.0, false);
        }
        ...
        public void test_leap_year_only_actual_for_loan_S3() {
            ...
            checkPeriod(interestSchedule, 5, 46348.36, 1653.11, 44695.25, 0.0, false);
        }
        ...
        public void test_leap_year_only_actual_for_loan_S4() {
            final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2024, 10, 31), LocalDate.of(2024, 11, 30)), periodData(LocalDate.of(2024, 11, 30), LocalDate.of(2024, 12, 31)), periodData(LocalDate.of(2024, 12, 31), LocalDate.of(2025, 1, 31)), periodData(LocalDate.of(2025, 1, 31), LocalDate.of(2025, 2, 28)), periodData(LocalDate.of(2025, 2, 28), LocalDate.of(2025, 3, 31)), periodData(LocalDate.of(2025, 3, 31), LocalDate.of(2025, 4, 30)));
            final BigDecimal interestRate = BigDecimal.valueOf(9.99);
            final Integer installmentAmountInMultiplesOf = null;
            Mockito.when(loanProductRelatedDetail.getAnnualNominalInterestRate()).thenReturn(interestRate);
            Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.ACTUAL.getValue());
            ...
            checkPeriod(interestSchedule, 4, 420.24, 7.04, 413.2, 416.83, false);
            checkPeriod(interestSchedule, 5, 420.25, 3.42, 416.83, 0.0, false);
        }
        ...
        public void test_feb29_period_only_cross_year_quarterly_period_containing_feb29() {
            final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = List.of(periodData(LocalDate.of(2023, 9, 1), LocalDate.of(2023, 12, 1)), periodData(LocalDate.of(2023, 12, 1), LocalDate.of(2024, 3, 1)), periodData(LocalDate.of(2024, 3, 1), LocalDate.of(2024, 6, 1)), periodData(LocalDate.of(2024, 6, 1), LocalDate.of(2024, 9, 1)));
            final BigDecimal interestRate = BigDecimal.valueOf(12.0);
            final Integer installmentAmountInMultiplesOf = null;
            ...
            Mockito.when(loanProductRelatedDetail.getCurrencyData()).thenReturn(currency);
            Mockito.when(loanProductRelatedDetail.isAllowFullTermForTranche()).thenReturn(false);
            final ProgressiveLoanInterestScheduleModel feb29Schedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            ...
            final ProgressiveLoanInterestScheduleModel fullLeapSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            ...
            Assertions.assertEquals(toDouble(fullLeapPeriod1.getDueInterest()), toDouble(feb29Period1.getDueInterest()), "Cross-year period containing Feb 29 should use 366 days for both strategies");
            ...
            Assertions.assertNotEquals(toDouble(fullLeapPeriod2.getDueInterest()), toDouble(feb29Period2.getDueInterest()), "Period without Feb 29 should differ between strategies (365 vs 366 days)");
        }
    ...
    public void test_s5_chargeback_in_period_Amt100_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        emiCalculator.creditPrincipal(interestSchedule, txnDate, toMoney(16.52));
        emiCalculator.creditInterest(interestSchedule, txnDate, toMoney(0.49));
        PeriodDueDetails dueAmounts = emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), txnDate);
        ...
        checkPeriod(interestSchedule, 4, 0, 17.01, 0.005833333333, 0.196933333322, 0.2, 16.81, 16.95);
        checkPeriod(interestSchedule, 5, 0, 17.05, 0.005833333333, 0.0988749999945, 0.1, 16.95, 0.0);
    }
    ...
    public void test_interest_schedule_model_service_serialization() {
        ...
        Mockito.when(loanProductRelatedDetail.getRepayEvery()).thenReturn(1);
        Mockito.when(loanProductRelatedDetail.getCurrencyData()).thenReturn(currency);
        final ProgressiveLoanInterestScheduleModel interestScheduleExpected = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
        final Money disbursedAmount = toMoney(100.0);
        ...
        interestScheduleActual = copyJson(interestScheduleExpected);
        verifyAllPeriods(interestScheduleExpected, interestScheduleActual);
        PeriodDueDetails dueAmountsExpected = emiCalculator.getDueAmounts(interestScheduleExpected, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), txnDate);
        PeriodDueDetails dueAmountsActual = emiCalculator.getDueAmounts(interestScheduleActual, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), txnDate);
    ...
    public class InterestTypeFlatAndCalculationPeriodDaily {
        ...
        public void testFlatDaily_1_Month_Actual_Actual() {
            ...
            checkPeriod(interestSchedule, 3, 181.95, 6.89, 175.06, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 3, 259.91, 9.84, 250.07, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 3, 519.83, 19.67, 500.16, 0.0, false); //
        }
        ...
        public void testFlatDaily_1_Month_360_30() {
            ...
            checkPeriod(interestSchedule, 0, 195.0, 7.5, 187.5, 562.5, false); //
            checkPeriod(interestSchedule, 1, 195.0, 7.5, 187.5, 375.0, false); //
            checkPeriod(interestSchedule, 2, 195.0, 7.5, 187.5, 187.5, false); //
            checkPeriod(interestSchedule, 3, 195.0, 7.5, 187.5, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(250.0));
            checkPeriod(interestSchedule, 0, 260.0, 10.0, 250.0, 750.0, false); //
            checkPeriod(interestSchedule, 1, 260.0, 10.0, 250.0, 500.0, false); //
            checkPeriod(interestSchedule, 2, 260.0, 10.0, 250.0, 250.0, false); //
            checkPeriod(interestSchedule, 3, 260.0, 10.0, 250.0, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 2, 345.69, 12.5, 333.19, 333.19, false); //
            checkPeriod(interestSchedule, 3, 345.69, 12.5, 333.19, 0.0, false); //
        }
        ...
        public void testFlatDaily_1_week_Actual_Actual() {
            ...
            checkPeriod(interestSchedule, 0, 151.38, 1.38, 150.0, 450.0, false); //
            checkPeriod(interestSchedule, 1, 151.38, 1.38, 150.0, 300.0, false); //
            checkPeriod(interestSchedule, 2, 151.38, 1.38, 150.0, 150.0, false); //
            checkPeriod(interestSchedule, 3, 151.38, 1.38, 150.0, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(400.0));
            checkPeriod(interestSchedule, 0, 252.3, 2.3, 250.0, 750.0, false); //
            checkPeriod(interestSchedule, 1, 252.3, 2.3, 250.0, 500.0, false); //
            checkPeriod(interestSchedule, 2, 252.3, 2.3, 250.0, 250.0, false); //
            checkPeriod(interestSchedule, 3, 252.3, 2.3, 250.0, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 3, 504.36, 4.59, 499.77, 0.0, false); //
        }
        ...
        public void testFlatDaily_30_Days_Actual_Actual() {
            ...
            final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(400.0));
            checkPeriod(interestSchedule, 0, 103.93, 3.93, 100.0, 300.0, false); //
            checkPeriod(interestSchedule, 1, 103.93, 3.93, 100.0, 200.0, false); //
            checkPeriod(interestSchedule, 2, 103.93, 3.93, 100.0, 100.0, false); //
            checkPeriod(interestSchedule, 3, 103.93, 3.93, 100.0, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(600.0));
            checkPeriod(interestSchedule, 0, 259.84, 9.84, 250.0, 750.0, false); //
            checkPeriod(interestSchedule, 1, 259.84, 9.84, 250.0, 500.0, false); //
            checkPeriod(interestSchedule, 2, 259.84, 9.84, 250.0, 250.0, false); //
            checkPeriod(interestSchedule, 3, 259.84, 9.84, 250.0, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate.plusDays(15), toMoney(500.0));
            checkPeriod(interestSchedule, 0, 389.14, 12.3, 376.84, 1123.16, false); //
            ...
            checkPeriod(interestSchedule, 3, 389.13, 14.75, 374.38, 0.0, false); //
        }
    }
    ...
    public class InterestTypeFlatAndCalculationPeriodSameAsRepaymentPeriod {
        ...
        public void setupTestDefaults() {
            ...
            Mockito.when(loanProductRelatedDetail.getDaysInYearType()).thenReturn(DaysInYearType.ACTUAL.getValue());
            Mockito.when(loanProductRelatedDetail.getDaysInMonthType()).thenReturn(DaysInMonthType.ACTUAL.getValue());
            Mockito.when(loanProductRelatedDetail.getInterestCalculationPeriodMethod()).thenReturn(InterestCalculationPeriodMethod.SAME_AS_REPAYMENT_PERIOD);
            Mockito.when(loanProductRelatedDetail.isAllowPartialPeriodInterestCalculation()).thenReturn(true);
        }
        ...
        void test_sameAsRepayment_days_repay_every_6_periods_5() {
            ...
            final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(1000.0));
            checkPeriod(interestSchedule, 0, 202.0, 2.0, 200.0, 800.0, false); //
            checkPeriod(interestSchedule, 1, 202.0, 2.0, 200.0, 600.0, false); //
            checkPeriod(interestSchedule, 2, 202.0, 2.0, 200.0, 400.0, false); //
            checkPeriod(interestSchedule, 3, 202.0, 2.0, 200.0, 200.0, false); //
            checkPeriod(interestSchedule, 4, 202.0, 2.0, 200.0, 0.0, false); //
        }
        ...
        void test_sameAsRepayment_week_repay_every_1_periods_10() {
            ...
            final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(1000.0));
            checkPeriod(interestSchedule, 0, 101.0, 1.0, 100.0, 900.0, false); //
            checkPeriod(interestSchedule, 1, 101.0, 1.0, 100.0, 800.0, false); //
            checkPeriod(interestSchedule, 2, 101.0, 1.0, 100.0, 700.0, false); //
            checkPeriod(interestSchedule, 3, 101.0, 1.0, 100.0, 600.0, false); //
            checkPeriod(interestSchedule, 4, 101.0, 1.0, 100.0, 500.0, false); //
            checkPeriod(interestSchedule, 5, 101.0, 1.0, 100.0, 400.0, false); //
            checkPeriod(interestSchedule, 6, 101.0, 1.0, 100.0, 300.0, false); //
            checkPeriod(interestSchedule, 7, 101.0, 1.0, 100.0, 200.0, false); //
            checkPeriod(interestSchedule, 8, 101.0, 1.0, 100.0, 100.0, false); //
            checkPeriod(interestSchedule, 9, 101.0, 1.0, 100.0, 0.0, false); //
        }
        ...
        void test_sameAsRepayment_month_repay_every_2_periods_8() {
            ...
            final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(1000.0));
            checkPeriod(interestSchedule, 0, 145.0, 20.0, 125.0, 875.0, false); //
            checkPeriod(interestSchedule, 1, 145.0, 20.0, 125.0, 750.0, false); //
            checkPeriod(interestSchedule, 2, 145.0, 20.0, 125.0, 625.0, false); //
            checkPeriod(interestSchedule, 3, 145.0, 20.0, 125.0, 500.0, false); //
            checkPeriod(interestSchedule, 4, 145.0, 20.0, 125.0, 375.0, false); //
            checkPeriod(interestSchedule, 5, 145.0, 20.0, 125.0, 250.0, false); //
            checkPeriod(interestSchedule, 6, 145.0, 20.0, 125.0, 125.0, false); //
            checkPeriod(interestSchedule, 7, 145.0, 20.0, 125.0, 0.0, false); //
        }
        ...
        void test_sameAsRepayment_month_repay_every_1_periods_3_second_disbursement_on_repayment_due_date_allow_partial() {
            ...
            final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(1000.0));
            checkPeriod(interestSchedule, 0, 343.33, 10.0, 333.33, 666.67, false); //
            checkPeriod(interestSchedule, 1, 343.33, 10.0, 333.33, 333.34, false); //
            checkPeriod(interestSchedule, 2, 343.34, 10.0, 333.34, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate.plusMonths(1), toMoney(250.0));
            checkPeriod(interestSchedule, 0, 343.33, 10.0, 333.33, 916.67, false); //
            checkPeriod(interestSchedule, 1, 470.84, 12.5, 458.34, 458.33, false); //
            checkPeriod(interestSchedule, 2, 470.83, 12.5, 458.33, 0.0, false); //
        }
        ...
        void test_sameAsRepayment_month_repay_every_1_periods_3() {
            ...
            checkPeriod(interestSchedule, 1, 429.06, 12.5, 416.56, 416.56, false); //
            checkPeriod(interestSchedule, 2, 429.06, 12.5, 416.56, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate.plusDays(4), toMoney(250.0));
            checkPeriod(interestSchedule, 0, 514.78, 14.35, 500.43, 999.57, false); //
            checkPeriod(interestSchedule, 1, 514.78, 15.0, 499.78, 499.79, false); //
            checkPeriod(interestSchedule, 2, 514.79, 15.0, 499.79, 0.0, false); //
        }
        ...
        void test_sameAsRepayment_month_repay_every_1_periods_20() {
            ...
            final ProgressiveLoanInterestScheduleModel interestSchedule = emiCalculator.generatePeriodInterestScheduleModel(expectedRepaymentPeriods, loanProductRelatedDetail, installmentAmountInMultiplesOf, mc);
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(1000.0));
            checkPeriod(interestSchedule, 0, 60.0, 10.0, 50.0, 950.0, false); //
            checkPeriod(interestSchedule, 1, 60.0, 10.0, 50.0, 900.0, false); //
            checkPeriod(interestSchedule, 2, 60.0, 10.0, 50.0, 850.0, false); //
            checkPeriod(interestSchedule, 3, 60.0, 10.0, 50.0, 800.0, false); //
            checkPeriod(interestSchedule, 4, 60.0, 10.0, 50.0, 750.0, false); //
            checkPeriod(interestSchedule, 5, 60.0, 10.0, 50.0, 700.0, false); //
            checkPeriod(interestSchedule, 6, 60.0, 10.0, 50.0, 650.0, false); //
            checkPeriod(interestSchedule, 7, 60.0, 10.0, 50.0, 600.0, false); //
            checkPeriod(interestSchedule, 8, 60.0, 10.0, 50.0, 550.0, false); //
            checkPeriod(interestSchedule, 9, 60.0, 10.0, 50.0, 500.0, false); //
            checkPeriod(interestSchedule, 10, 60.0, 10.0, 50.0, 450.0, false); //
            checkPeriod(interestSchedule, 11, 60.0, 10.0, 50.0, 400.0, false); //
            checkPeriod(interestSchedule, 12, 60.0, 10.0, 50.0, 350.0, false); //
            checkPeriod(interestSchedule, 13, 60.0, 10.0, 50.0, 300.0, false); //
            checkPeriod(interestSchedule, 14, 60.0, 10.0, 50.0, 250.0, false); //
            checkPeriod(interestSchedule, 15, 60.0, 10.0, 50.0, 200.0, false); //
            checkPeriod(interestSchedule, 16, 60.0, 10.0, 50.0, 150.0, false); //
            checkPeriod(interestSchedule, 17, 60.0, 10.0, 50.0, 100.0, false); //
            checkPeriod(interestSchedule, 18, 60.0, 10.0, 50.0, 50.0, false); //
            checkPeriod(interestSchedule, 19, 60.0, 10.0, 50.0, 0.0, false); //
        }
        ...
        void test_sameAsRepayment_month_repay_every_1_periods_24() {
            ...
            checkPeriod(interestSchedule, 0, 516.67, 100.0, 416.67, 9583.33, false); //
            checkPeriod(interestSchedule, 1, 516.67, 100.0, 416.67, 9166.66, false); //
            checkPeriod(interestSchedule, 2, 516.67, 100.0, 416.67, 8749.99, false); //
            checkPeriod(interestSchedule, 3, 516.67, 100.0, 416.67, 8333.32, false); //
            checkPeriod(interestSchedule, 4, 516.67, 100.0, 416.67, 7916.65, false); //
            checkPeriod(interestSchedule, 5, 516.67, 100.0, 416.67, 7499.98, false); //
            checkPeriod(interestSchedule, 6, 516.67, 100.0, 416.67, 7083.31, false); //
            checkPeriod(interestSchedule, 7, 516.67, 100.0, 416.67, 6666.64, false); //
            checkPeriod(interestSchedule, 8, 516.67, 100.0, 416.67, 6249.97, false); //
            checkPeriod(interestSchedule, 9, 516.67, 100.0, 416.67, 5833.3, false); //
            checkPeriod(interestSchedule, 10, 516.67, 100.0, 416.67, 5416.63, false); //
            checkPeriod(interestSchedule, 11, 516.67, 100.0, 416.67, 4999.96, false); //
            checkPeriod(interestSchedule, 12, 516.67, 100.0, 416.67, 4583.29, false); //
            checkPeriod(interestSchedule, 13, 516.67, 100.0, 416.67, 4166.62, false); //
            checkPeriod(interestSchedule, 14, 516.67, 100.0, 416.67, 3749.95, false); //
            checkPeriod(interestSchedule, 15, 516.67, 100.0, 416.67, 3333.28, false); //
            checkPeriod(interestSchedule, 16, 516.67, 100.0, 416.67, 2916.61, false); //
            checkPeriod(interestSchedule, 17, 516.67, 100.0, 416.67, 2499.94, false); //
            checkPeriod(interestSchedule, 18, 516.67, 100.0, 416.67, 2083.27, false); //
            checkPeriod(interestSchedule, 19, 516.67, 100.0, 416.67, 1666.6, false); //
            checkPeriod(interestSchedule, 20, 516.67, 100.0, 416.67, 1249.93, false); //
            checkPeriod(interestSchedule, 21, 516.67, 100.0, 416.67, 833.26, false); //
            checkPeriod(interestSchedule, 22, 516.67, 100.0, 416.67, 416.59, false); //
            checkPeriod(interestSchedule, 23, 516.59, 100.0, 416.59, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 4, 574.22, 110.0, 464.22, 8820.22, false); //
            checkPeriod(interestSchedule, 5, 574.22, 110.0, 464.22, 8356.0, false); //
            checkPeriod(interestSchedule, 6, 574.22, 110.0, 464.22, 7891.78, false); //
            checkPeriod(interestSchedule, 7, 574.22, 110.0, 464.22, 7427.56, false); //
            checkPeriod(interestSchedule, 8, 574.22, 110.0, 464.22, 6963.34, false); //
            checkPeriod(interestSchedule, 9, 574.22, 110.0, 464.22, 6499.12, false); //
            checkPeriod(interestSchedule, 10, 574.22, 110.0, 464.22, 6034.9, false); //
            checkPeriod(interestSchedule, 11, 574.22, 110.0, 464.22, 5570.68, false); //
            checkPeriod(interestSchedule, 12, 574.22, 110.0, 464.22, 5106.46, false); //
            checkPeriod(interestSchedule, 13, 574.22, 110.0, 464.22, 4642.24, false); //
            checkPeriod(interestSchedule, 14, 574.22, 110.0, 464.22, 4178.02, false); //
            checkPeriod(interestSchedule, 15, 574.22, 110.0, 464.22, 3713.8, false); //
            checkPeriod(interestSchedule, 16, 574.22, 110.0, 464.22, 3249.58, false); //
            checkPeriod(interestSchedule, 17, 574.22, 110.0, 464.22, 2785.36, false); //
            checkPeriod(interestSchedule, 18, 574.22, 110.0, 464.22, 2321.14, false); //
            checkPeriod(interestSchedule, 19, 574.22, 110.0, 464.22, 1856.92, false); //
            checkPeriod(interestSchedule, 20, 574.22, 110.0, 464.22, 1392.7, false); //
            checkPeriod(interestSchedule, 21, 574.22, 110.0, 464.22, 928.48, false); //
            checkPeriod(interestSchedule, 22, 574.22, 110.0, 464.22, 464.26, false); //
            checkPeriod(interestSchedule, 23, 574.26, 110.0, 464.26, 0.0, false); //
        }
        ...
        void test_sameAsRepayment_month_repay_every_1_periods_3__not_calculate_exact_days() {
            ...
            checkPeriod(interestSchedule, 2, 343.34, 10.0, 333.34, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate.plusDays(4), toMoney(250.0));
            checkPeriod(interestSchedule, 0, 429.17, 12.5, 416.67, 833.33, false); //
            checkPeriod(interestSchedule, 1, 429.17, 12.5, 416.67, 416.66, false); //
            checkPeriod(interestSchedule, 2, 429.16, 12.5, 416.66, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate.plusDays(17), toMoney(250.0));
            checkPeriod(interestSchedule, 0, 515.0, 15.0, 500.0, 1000.0, false); //
            checkPeriod(interestSchedule, 1, 515.0, 15.0, 500.0, 500.0, false); //
            checkPeriod(interestSchedule, 2, 515.0, 15.0, 500.0, 0.0, false); //
        }
    }
    ...
    public class DecliningBalanceSameAsRepaymentPeriod {
        ...
        void test_3_of_1_month_period_multi_disbursement__exact_days() {
            ...
            checkPeriod(interestSchedule, 0, 170.01, 5.0, 165.01, 334.99, false); //
            checkPeriod(interestSchedule, 1, 170.01, 3.35, 166.66, 168.33, false); //
            checkPeriod(interestSchedule, 2, 170.01, 1.68, 168.33, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate, toMoney(500.0));
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 669.98, false); //
            checkPeriod(interestSchedule, 1, 340.02, 6.7, 333.32, 336.66, false); //
            checkPeriod(interestSchedule, 2, 340.03, 3.37, 336.66, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 2, 466.34, 4.62, 461.72, 0.0, false); //
        }
        ...
        void test_3_of_1_month_period_multi_disbursement__exact_days__on_period_due_date() {
            ...
            emiCalculator.addDisbursement(interestSchedule, disbursementDate2, toMoney(250.0));
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 919.98, false); //
            checkPeriod(interestSchedule, 1, 466.9, 9.2, 457.7, 462.28, false); //
            checkPeriod(interestSchedule, 2, 466.9, 4.62, 462.28, 0.0, false); //
        }
        ...
        void test_3_of_1_month_period_multi_disbursement__NOT_exact_days__different_days() {
            ...
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 719.98, false); //
            checkPeriod(interestSchedule, 1, 365.4, 7.2, 358.2, 361.78, false); //
            checkPeriod(interestSchedule, 2, 365.4, 3.62, 361.78, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate3, toMoney(50.0));
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 769.98, false); //
            checkPeriod(interestSchedule, 1, 390.77, 7.7, 383.07, 386.91, false); //
            checkPeriod(interestSchedule, 2, 390.78, 3.87, 386.91, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate3, toMoney(50.0));
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 819.98, false); //
            checkPeriod(interestSchedule, 1, 416.15, 8.2, 407.95, 412.03, false); //
            checkPeriod(interestSchedule, 2, 416.15, 4.12, 412.03, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate4, toMoney(50.0));
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 869.98, false); //
            checkPeriod(interestSchedule, 1, 441.53, 8.7, 432.83, 437.15, false); //
            checkPeriod(interestSchedule, 2, 441.52, 4.37, 437.15, 0.0, false); //
            emiCalculator.addDisbursement(interestSchedule, disbursementDate4, toMoney(50.0));
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 919.98, false); //
            checkPeriod(interestSchedule, 1, 466.9, 9.2, 457.7, 462.28, false); //
            checkPeriod(interestSchedule, 2, 466.9, 4.62, 462.28, 0.0, false); //
        ...
        void test_3_of_1_month_period_multi_disbursement__NOT_exact_days() {
            ...
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 799.98, false); //
            checkPeriod(interestSchedule, 1, 406.0, 8.0, 398.0, 401.98, false); //
            checkPeriod(interestSchedule, 2, 406.0, 4.02, 401.98, 0.0, false); //
    ...
    public class RescheduleInstallmentExtendRepaymentPeriod {
        ...
        public void testExtraTermsDecliningBalance() {
            ...
            checkPeriod(interestSchedule, 0, 340.02, 10.0, 330.02, 669.98, false); //
            checkPeriod(interestSchedule, 1, 227.81, 6.7, 221.11, 448.87, false); //
            checkPeriod(interestSchedule, 2, 227.81, 4.49, 223.32, 225.55, false); //
            checkPeriod(interestSchedule, 3, 227.81, 2.26, 225.55, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 5, 115.03, 1.14, 113.89, 0.0, false); //
        }
        ...
        public void testExtraTermsFlat() {
            ...
            emiCalculator.addRepaymentPeriods(interestSchedule, LocalDate.of(2024, 7, 2), 1, List.of());
            checkPeriod(interestSchedule, 0, 343.33, 10.0, 333.33, 666.67, false); //
            checkPeriod(interestSchedule, 1, 232.22, 10.0, 222.22, 444.45, false); //
            checkPeriod(interestSchedule, 2, 232.22, 10.0, 222.22, 222.23, false); //
            checkPeriod(interestSchedule, 3, 232.23, 10.0, 222.23, 0.0, false); //
            emiCalculator.addRepaymentPeriods(interestSchedule, LocalDate.of(2024, 8, 2), 2, List.of());
            checkPeriod(interestSchedule, 0, 343.33, 10.0, 333.33, 666.67, false); //
            checkPeriod(interestSchedule, 1, 232.22, 10.0, 222.22, 444.45, false); //
            checkPeriod(interestSchedule, 2, 121.11, 10.0, 111.11, 333.34, false); //
            checkPeriod(interestSchedule, 3, 121.11, 10.0, 111.11, 222.23, false); //
            checkPeriod(interestSchedule, 4, 121.11, 10.0, 111.11, 111.12, false); //
            checkPeriod(interestSchedule, 5, 121.12, 10.0, 111.12, 0.0, false); //
        }
        ...
        public void testExtraTermsDecliningBalanceWithFullyRepaidPeriods() {
            ...
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 9, 1), LocalDate.of(2024, 10, 1), LocalDate.of(2024, 6, 1), Money.of(currency, BigDecimal.valueOf(256.29)));
            // simulate early repayment on day 0
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 6, 1), Money.of(currency, BigDecimal.valueOf(256.28)));
            // verify 1st and 4th installments are fully repaid
            checkPeriod(interestSchedule, 0, 256.28, 0.0, 256.28, 487.43, true); //
            checkPeriod(interestSchedule, 1, 256.28, 9.74, 246.54, 240.89, false); //
            checkPeriod(interestSchedule, 2, 243.3, 2.41, 240.89, 0.0, false); //
            checkPeriod(interestSchedule, 3, 256.29, 0.0, 256.29, 0.0, true); //
            // add extra repayment period 1
            ...
            // period
            checkPeriod(interestSchedule, 0, 256.28, 0.0, 256.28, 487.43, true); //
            checkPeriod(interestSchedule, 1, 206.04, 9.74, 196.3, 291.13, false); //
            checkPeriod(interestSchedule, 2, 206.04, 2.91, 203.13, 88.0, false); //
            checkPeriod(interestSchedule, 3, 256.29, 0.0, 256.29, 88.0, true); //
            checkPeriod(interestSchedule, 4, 89.76, 1.76, 88.0, 0.0, false); //
            ...
            checkPeriod(interestSchedule, 2, 126.91, 3.7, 123.21, 247.05, false); //
            checkPeriod(interestSchedule, 3, 256.29, 0.0, 256.29, 247.05, true); //
            checkPeriod(interestSchedule, 4, 126.91, 4.94, 121.97, 125.08, false); //
            checkPeriod(interestSchedule, 5, 126.33, 1.25, 125.08, 0.0, false); //
            checkPeriod(interestSchedule, 6, 0.0, 0.0, 0.0, 0.0, true); //
        }
        ...
        public void testExtraTermsFlatWithFullyRepaidPeriods() {
            ...
            checkPeriod(interestSchedule, 3, 260.0, 10.0, 250.0, 0.0, false); //
            // simulate merchant issued refund allocated on last installment ( fully repaid ) on first date
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 9, 1), LocalDate.of(2024, 10, 1), LocalDate.of(2024, 6, 1), Money.of(currency, BigDecimal.valueOf(250.0)));
            emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 9, 1), LocalDate.of(2024, 10, 1), LocalDate.of(2024, 6, 1), Money.of(currency, BigDecimal.valueOf(10.0)));
            checkPeriod(interestSchedule, 0, 260.0, 10.0, 250.0, 500.0, false); //
            checkPeriod(interestSchedule, 1, 260.0, 10.0, 250.0, 250.0, false); //
            checkPeriod(interestSchedule, 2, 260.0, 10.0, 250.0, 0.0, false); //
            checkPeriod(interestSchedule, 3, 260.0, 10.0, 250.0, 0.0, true); //
            // simulate early repayment on day 0
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 6, 1), Money.of(currency, BigDecimal.valueOf(250.0)));
            emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 6, 1), Money.of(currency, BigDecimal.valueOf(10.0)));
            // verify 1st and 4th installments are fully repaid
            checkPeriod(interestSchedule, 0, 260.0, 10.0, 250.0, 500.0, true); //
            checkPeriod(interestSchedule, 1, 260.0, 10.0, 250.0, 250.0, false); //
            checkPeriod(interestSchedule, 2, 260.0, 10.0, 250.0, 0.0, false); //
            checkPeriod(interestSchedule, 3, 260.0, 10.0, 250.0, 0.0, true); //
            // add extra repayment period 1
            ...
            // period
            checkPeriod(interestSchedule, 0, 260.0, 10.0, 250.0, 500.0, true); //
            checkPeriod(interestSchedule, 1, 210.0, 10.0, 200.0, 300.0, false); //
            checkPeriod(interestSchedule, 2, 210.0, 10.0, 200.0, 100.0, false); //
            checkPeriod(interestSchedule, 3, 260.0, 10.0, 250.0, 100.0, true); //
            checkPeriod(interestSchedule, 4, 110.0, 10.0, 100.0, 0.0, false); //
            // add extra repayment period 2
            emiCalculator.addRepaymentPeriods(interestSchedule, LocalDate.of(2024, 6, 15), 2, List.of());
            // verify 1st and 4th installments are not modified, additional principal paid are substract from last
            // periods
            checkPeriod(interestSchedule, 0, 260.0, 10.0, 250.0, 500.0, true); //
            checkPeriod(interestSchedule, 1, 152.86, 10.0, 142.86, 357.14, false); //
            checkPeriod(interestSchedule, 2, 152.86, 10.0, 142.86, 214.28, false); //
            checkPeriod(interestSchedule, 3, 260.0, 10.0, 250.0, 214.28, true); //
            checkPeriod(interestSchedule, 4, 152.86, 10.0, 142.86, 71.42, false); //
            checkPeriod(interestSchedule, 5, 81.42, 10.0, 71.42, 0.0, false); //
            checkPeriod(interestSchedule, 6, 10.0, 10.0, 0.0, 0.0, false); //
        }
    }
    ...
    public class ReAgeEqualAmortization {
        ...
        public void test_chargeBackOn2ndRP_ReAgeingOn1stRPsDueDate_EQUAL_AMORTIZATION_FULL_INTEREST() {
            ...
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), Money.of(currency, BigDecimal.valueOf(16.1)));
            emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), Money.of(currency, BigDecimal.valueOf(1.33)));
            ...
            OutstandingDetails outstandingAmountsTillDate = emiCalculator.getOutstandingAmountsTillDate(interestSchedule, interestSchedule.getMaturityDate());
            LoanReAgeParameterData reageParameter = LoanReAgeParameterData.of(PeriodFrequencyType.MONTHS, 1, reAgingStartDate, 6, LoanReAgeInterestHandlingType.EQUAL_AMORTIZATION_FULL_INTEREST);
            // Update the existing model with re-aged periods
            emiCalculator.reAgeEqualAmortization(interestSchedule, transactionDate, reageParameter, Money.zero(currency), new EqualAmortizationValues(Money.zero(currency), 6, Money.zero(currency), Money.zero(currency)));
            OutstandingDetails outstandingAmountsTillDateAfterReage = emiCalculator.getOutstandingAmountsTillDate(interestSchedule, interestSchedule.getMaturityDate());
            Assertions.assertEquals(outstandingAmountsTillDate.getOutstandingInterest().getAmount(), outstandingAmountsTillDateAfterReage.getOutstandingInterest().getAmount());
            Assertions.assertEquals(outstandingAmountsTillDate.getOutstandingPrincipal().getAmount(), outstandingAmountsTillDateAfterReage.getOutstandingPrincipal().getAmount());
        }
        ...
        public void test_transactionInMiddleOfPeriod_EQUAL_AMORTIZATION_FULL_INTEREST() {
            ...
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 2, 1), LocalDate.of(2024, 3, 1), LocalDate.of(2024, 2, 1), Money.of(currency, BigDecimal.valueOf(17.43)));
            // repay 20 for last installment on first period due date -- ie MIR
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 6, 1), LocalDate.of(2024, 7, 1), LocalDate.of(2024, 2, 1), Money.of(currency, BigDecimal.valueOf(17.43)));
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 5, 1), LocalDate.of(2024, 6, 1), LocalDate.of(2024, 2, 1), Money.of(currency, BigDecimal.valueOf(2.57)));
            emiCalculator.addBalanceCorrection(interestSchedule, LocalDate.of(2024, 4, 1), emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), LocalDate.of(2024, 4, 1)).getDuePrincipal());
            emiCalculator.addBalanceCorrection(interestSchedule, LocalDate.of(2024, 4, 15), emiCalculator.getDueAmounts(interestSchedule, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 4, 1), LocalDate.of(2024, 4, 1)).getDuePrincipal().negated());
            LocalDate reAgingStartDate = LocalDate.of(2024, 4, 20);
            LocalDate transactionDate = LocalDate.of(2024, 4, 15);
            OutstandingDetails outstandingAmountsTillDate = emiCalculator.getOutstandingAmountsTillDate(interestSchedule, interestSchedule.getMaturityDate());
            LoanReAgeParameterData reageParameter = LoanReAgeParameterData.of(PeriodFrequencyType.MONTHS, 1, reAgingStartDate, 6, LoanReAgeInterestHandlingType.EQUAL_AMORTIZATION_FULL_INTEREST);
        ...
        public void test_chargeback_transactionInMiddleOfPeriod_EQUAL_EQUAL_AMORTIZATION_PAYABLE_INTEREST() {
            ...
            emiCalculator.addDisbursement(interestSchedule, LocalDate.of(2024, 1, 1), disbursedAmount);
            // repay EMI on first period due date
            emiCalculator.payPrincipal(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), Money.of(currency, BigDecimal.valueOf(16.43)));
            emiCalculator.payInterest(interestSchedule, LocalDate.of(2024, 1, 1), LocalDate.of(2024, 2, 1), LocalDate.of(2024, 2, 1), Money.of(currency, BigDecimal.valueOf(0.58)));
            // chargeback
            ...
            LoanReAgeParameterData reageParameter = LoanReAgeParameterData.of(PeriodFrequencyType.MONTHS, 1, reAgingStartDate, 6, LoanReAgeInterestHandlingType.EQUAL_AMORTIZATION_PAYABLE_INTEREST);
            // Update the existing model with re-aged periods
            emiCalculator.reAgeEqualAmortization(interestSchedule, transactionDate, reageParameter, Money.zero(currency), new EqualAmortizationValues(Money.zero(currency), 6, Money.zero(currency), Money.zero(currency)));
            OutstandingDetails outstandingAmountsTillDateAfterReage = emiCalculator.getOutstandingAmountsTillDate(interestSchedule, interestSchedule.getMaturityDate());
            Assertions.assertEquals(outstandingAmountsTillDate.getOutstandingInterest().getAmount(), outstandingAmountsTillDateAfterReage.getOutstandingInterest().getAmount());
    ...
    public class EqualAmortizationValue {
        ...
        public void test_AmortizationTotalIsLessThanInstallmentNumber() {
            EqualAmortizationValues actual = emiCalculator.calculateEqualAmortizationValues(Money.of(currency, BigDecimal.valueOf(0.04)), 6, null, MonetaryCurrency.fromCurrencyData(currency));
        ...
        public void test_AmortizationIsJustBiggerThanInstallmentNumber() {
            EqualAmortizationValues actual = emiCalculator.calculateEqualAmortizationValues(Money.of(currency, BigDecimal.valueOf(0.07)), 6, null, MonetaryCurrency.fromCurrencyData(currency));
            Assertions.assertEquals(0.01, actual.calculateValueBigDecimal(0).doubleValue());
            Assertions.assertEquals(0.01, actual.calculateValueBigDecimal(1).doubleValue());
            Assertions.assertEquals(0.01, actual.calculateValueBigDecimal(2).doubleValue());
            Assertions.assertEquals(0.01, actual.calculateValueBigDecimal(3).doubleValue());
        ...
        public void test_AmortizationNonEdgeCase() {
            EqualAmortizationValues actual = emiCalculator.calculateEqualAmortizationValues(Money.of(currency, BigDecimal.valueOf(0.59)), 6, null, MonetaryCurrency.fromCurrencyData(currency));
    ...
    private List<LoanScheduleModelRepaymentPeriod> generateExpectedRepaymentPeriods(LocalDate disbursementDate) {
        return switch (loanProductRelatedDetail.getRepaymentPeriodFrequencyType()) {
            case MONTHS -> expectedRepaymentsMonthly(disbursementDate, loanProductRelatedDetail.getNumberOfRepayments(), loanProductRelatedDetail.getRepayEvery());
            case WEEKS -> expectedRepaymentWeeks(disbursementDate, loanProductRelatedDetail.getNumberOfRepayments(), loanProductRelatedDetail.getRepayEvery());
            case DAYS -> expectedRepaymentDays(disbursementDate, loanProductRelatedDetail.getNumberOfRepayments(), loanProductRelatedDetail.getRepayEvery());
    ...
    List<LoanScheduleModelRepaymentPeriod> expectedRepaymentDays(final LocalDate disbursementDate, final int periods, final int length) {
        ...
        IntStream.range(0, periods).forEach(i -> expectedRepaymentPeriods.add(periodData(disbursementDate.plusDays((long) i * length), disbursementDate.plusDays((long) (i + 1) * length))));
        return expectedRepaymentPeriods;
    }

    List<LoanScheduleModelRepaymentPeriod> expectedRepaymentsMonthly(final LocalDate disbursementDate, final int periods, final int length) {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = new ArrayList<>(periods);
        IntStream.range(0, periods).forEach(i -> expectedRepaymentPeriods.add(periodData(disbursementDate.plusMonths((long) i * length), disbursementDate.plusMonths((long) (i + 1) * length))));
        return expectedRepaymentPeriods;
    }
    ...
    List<LoanScheduleModelRepaymentPeriod> expectedRepaymentWeeks(final LocalDate disbursementDate, final int periods, final int length) {
        final List<LoanScheduleModelRepaymentPeriod> expectedRepaymentPeriods = new ArrayList<>(periods);
        IntStream.range(0, periods).forEach(i -> expectedRepaymentPeriods.add(periodData(disbursementDate.plusWeeks((long) i * length), disbursementDate.plusWeeks((long) (i + 1) * length))));
        return expectedRepaymentPeriods;
    }
    ...
    private static void checkDailyInterest(final ProgressiveLoanInterestScheduleModel interestModel, final LocalDate repaymentPeriodDueDate, final LocalDate interestStartDay, final int dayOffset, final double dailyInterest, final double interest) {
        Money previousInterest = emiCalculator.getPeriodInterestTillDate(interestModel, interestStartDay, repaymentPeriodDueDate, interestStartDay.plusDays(dayOffset - 1), true, true);
        Money currentInterest = emiCalculator.getPeriodInterestTillDate(interestModel, interestStartDay, repaymentPeriodDueDate, interestStartDay.plusDays(dayOffset), true, true);
    ...
    private static void checkEmi(final ProgressiveLoanInterestScheduleModel interestScheduleModel, final int repaymentIdx, final double emiValue) {
        Assertions.assertEquals(emiValue, toDouble(interestScheduleModel.repaymentPeriods().get(repaymentIdx).getEmi()));
    }

    private static void checkTotalInterestDue(final ProgressiveLoanInterestScheduleModel interestScheduleModel, final double totalInterestDue) {
        Assertions.assertEquals(totalInterestDue, toDouble(interestScheduleModel.getTotalDueInterest()));
    }

    private static void checkPeriod(final ProgressiveLoanInterestScheduleModel interestScheduleModel, final int repaymentIdx, final int interestIdx, final double emiValue, final double rateFactor, final double interestDue, final double principalDue, final double remaingBalance) {
        checkPeriod(interestScheduleModel, repaymentIdx, interestIdx, emiValue, rateFactor, interestDue, interestDue, principalDue, remaingBalance);
    }

    private static void checkPeriod(final ProgressiveLoanInterestScheduleModel interestScheduleModel, final int repaymentIdx, final double emiValue, final double interestDueCumulated, final double principalDue, final double remainingBalance, final boolean fullyRepaid) {
    ...
    private static void checkPeriod(final ProgressiveLoanInterestScheduleModel interestScheduleModel, final int repaymentIdx, final int interestIdx, final double emiValue, final double rateFactor, final double interestDue, final double interestDueCumulated, final double principalDue, final double remaingBalance) {
    ...
    private static void verifyAllPeriods(final ProgressiveLoanInterestScheduleModel expectedModel, final ProgressiveLoanInterestScheduleModel actualModel) {
        for (int repInd = 0; repInd < expectedModel.repaymentPeriods().size(); repInd++) {
            ...
            for (int interestPeriodIndex = 0; interestPeriodIndex < repaymentPeriod.getInterestPeriods().size(); interestPeriodIndex++) {
                ...
                checkPeriod(actualModel, repInd, interestPeriodIndex, toDouble(repaymentPeriod.getEmi()), toDouble(applyMathContext(interestPeriod.getRateFactor())), toDouble(interestPeriod.getCalculatedDueInterest()), toDouble(repaymentPeriod.getDueInterest()), toDouble(repaymentPeriod.getDuePrincipal()), toDouble(repaymentPeriod.getOutstandingLoanBalance()));
            }
        }
    }
    ...
    private ProgressiveLoanInterestScheduleModel copyJson(ProgressiveLoanInterestScheduleModel toCopy) {
        ...
        return interestScheduleModelService.fromJson(json, toCopy.loanProductRelatedDetail(), toCopy.mc(), toCopy.installmentAmountInMultiplesOf());
    }
    ...
    public void test_principalGraceForProgressiveSchedule() {
        ...
        checkPeriod(interestSchedule, 4, 25.37, 0.29, 25.08, 25.2, false);
        checkPeriod(interestSchedule, 5, 25.35, 0.15, 25.2, 0.0, false);
    }
    ...
    public void test_interestGraceForProgressiveSchedule() {
        ...
        checkPeriod(interestSchedule, 4, 17.01, 0.2, 16.81, 16.88, false);
        checkPeriod(interestSchedule, 5, 16.98, 0.1, 16.88, 0.0, false);
    }
    ...
    public void test_fullTermTranche_disbursedAmt200_2ndOnDueDate_dayInYears360_daysInMonth30_repayEvery1Month() {
        ...
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(0).getEmi()), 0.01, "Period 0 EMI after first disbursement");
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(1).getEmi()), 0.01, "Period 1 EMI after first disbursement");
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(2).getEmi()), 0.01, "Period 2 EMI after first disbursement");
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(3).getEmi()), 0.01, "Period 3 EMI after first disbursement");
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(4).getEmi()), 0.01, "Period 4 EMI after first disbursement");
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(5).getEmi()), 0.01, "Period 5 EMI after first disbursement");
        Assertions.assertEquals(0.0, toDouble(interestSchedule.repaymentPeriods().get(6).getEmi()), 0.01, "Period 6 EMI after first disbursement (should be 0)");
        ...
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(0).getEmi()), 0.01, "Period 0 EMI (single tranche)");
        ...
        Assertions.assertEquals(17.13, toDouble(interestSchedule.repaymentPeriods().get(6).getEmi()), 0.01, "Period 6 EMI (single tranche)");
    }
}
