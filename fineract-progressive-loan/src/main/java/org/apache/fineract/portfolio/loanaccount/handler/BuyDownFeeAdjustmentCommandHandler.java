...
public class BuyDownFeeAdjustmentCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        try {
            ...
            dataIntegrityErrorHandler.handleDataIntegrityIssues(command, dve.getMostSpecificCause(), dve, "loan.buy.down.fee", "Buy Down Fee");
            return CommandProcessingResult.empty();
        }
    }

    @java.lang.SuppressWarnings("all")
        public BuyDownFeeAdjustmentCommandHandler(final BuyDownFeePlatformService buyDownFeePlatformService, final DataIntegrityErrorHandler dataIntegrityErrorHandler) {
        this.buyDownFeePlatformService = buyDownFeePlatformService;
