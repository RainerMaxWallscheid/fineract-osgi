...
public class LoanBuyDownFeeApiResource {
    ...
    public List<BuyDownFeeAmortizationDetails> retrieveLoanBuyDownFeeAmortizationDetails(@PathParam("loanId") @Parameter(description = "loanId", required = true) final Long loanId) {
    ...
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = BuyDownFeeAmortizationDetails.class))))
    public List<BuyDownFeeAmortizationDetails> retrieveLoanBuyDownFeeAmortizationDetailsByExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId", required = true) final String loanExternalId) {
        this.context.authenticatedUser().validateHasReadPermission(RESOURCE_NAME_FOR_PERMISSIONS);
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a BuyDown Fees allocation data", description = "Retrieves BuyDown Fees allocation data according to the Loan ID and Loan Transaction ID" + "Example Requests:\n" + "\n" + "/loans/1/buydown-fees/1\n" + "\n" + "\n" + "/loans/1/buydown-fees/1?fields=baseLoanTransaction,unrecognizedAmount")
    ...
    public String retrieveBuyDownFeesAllocationData(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId, @PathParam("loanTransactionId") @Parameter(description = "loanTransactionId") final Long loanTransactionId, @Context final UriInfo uriInfo) {
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a BuyDown Fees allocation data", description = "Retrieves BuyDown Fees allocation data according to the Loan external ID and Loan Transaction ID" + "Example Requests:\n" + "\n" + "/loans/external-id/1/buydown-fees/1\n" + "\n" + "\n" + "/loans/external-id/1/buydown-fees/1?fields=baseLoanTransaction,unrecognizedAmount")
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = LoanAmortizationAllocationApiResourceSwagger.LoanAmortizationAllocationResponse.class)))
    public String getBuyDownFeesAllocationDataByLoanExternalId(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @PathParam("loanTransactionId") @Parameter(description = "loanTransactionId") final Long loanTransactionId, @Context final UriInfo uriInfo) {
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a BuyDown Fees allocation data", description = "Retrieves BuyDown Fees allocation data according to the Loan ID and Loan Transaction external ID" + "Example Requests:\n" + "\n" + "/loans/1/buydown-fees/external-id/1\n" + "\n" + "\n" + "/loans/1/buydown-fees/external-id/1?fields=baseLoanTransaction,unrecognizedAmount")
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = LoanAmortizationAllocationApiResourceSwagger.LoanAmortizationAllocationResponse.class)))
    public String getBuyDownFeesAllocationDataByTransactionExternalId(@PathParam("loanId") @Parameter(description = "loanId") final Long loanId, @PathParam("loanTransactionExternalId") @Parameter(description = "loanTransactionExternalId") final String loanTransactionExternalId, @Context final UriInfo uriInfo) {
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @Operation(summary = "Retrieve a BuyDown Fees allocation data", description = "Retrieves BuyDown Fees allocation data according to the Loan external ID and Loan Transaction external ID" + "Example Requests:\n" + "\n" + "/loans/external-id/1/buydown-fees/1\n" + "\n" + "\n" + "/loans/external-id/1/buydown-fees/1?fields=baseLoanTransaction,unrecognizedAmount")
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = LoanAmortizationAllocationApiResourceSwagger.LoanAmortizationAllocationResponse.class)))
    public String getBuyDownFeesAllocationDataByExternalIds(@PathParam("loanExternalId") @Parameter(description = "loanExternalId") final String loanExternalId, @PathParam("loanTransactionExternalId") @Parameter(description = "loanTransactionExternalId") final String loanTransactionExternalId, @Context final UriInfo uriInfo) {
        return retrieveBuyDownFeesAllocationData(null, loanExternalId, null, loanTransactionExternalId, uriInfo);
    }

    private String retrieveBuyDownFeesAllocationData(final Long loanId, final String loanExternalIdStr, final Long loanTransactionId, final String loanTransactionExternalIdStr, final UriInfo uriInfo) {
        ...
        final LoanAmortizationAllocationData loanAmortizationAllocationData = loanAmortizationAllocationService.retrieveLoanAmortizationAllocationsForBuyDownFeeTransaction(resolvedLoanTransactionId, resolvedLoanId);
    ...
    @java.lang.SuppressWarnings("all")
        public LoanBuyDownFeeApiResource(final PlatformSecurityContext context, final BuyDownFeeReadPlatformService buyDownFeeReadPlatformService, final LoanAmortizationAllocationService loanAmortizationAllocationService, final DefaultToApiJsonSerializer<LoanAmortizationAllocationData> toApiJsonSerializer, final ApiRequestParameterHelper apiRequestParameterHelper, final LoanReadPlatformService loanReadPlatformService) {
        this.context = context;
        this.buyDownFeeReadPlatformService = buyDownFeeReadPlatformService;
