...
public class LoanSchedulePlan {
    ...
    public static LoanSchedulePlan from(LoanScheduleModel model) {
        ...
        model.getPeriods().forEach(periodModel -> {
            ...
            if (periodModel instanceof LoanScheduleModelDisbursementPeriod disbursementPeriod) {
                ...
                remainingTotalOutstandingRef.set(remainingTotalOutstandingRef.get().subtract(downPaymentPeriod.getPrincipalDue().getAmount()));
    ...
    @java.lang.SuppressWarnings("all")
        public LoanSchedulePlan(final List<LoanSchedulePlanPeriod> periods, final CurrencyData currency, final int loanTermInDays, final BigDecimal totalDisbursedAmount, final BigDecimal totalPrincipalAmount, final BigDecimal totalInterestAmount, final BigDecimal totalFeeAmount, final BigDecimal totalPenaltyAmount, final BigDecimal totalRepaymentAmount, final BigDecimal totalOutstandingAmount) {
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (this$totalPrincipalAmount == null ? other$totalPrincipalAmount != null : !this$totalPrincipalAmount.equals(other$totalPrincipalAmount)) return false;
        ...
        if (this$totalInterestAmount == null ? other$totalInterestAmount != null : !this$totalInterestAmount.equals(other$totalInterestAmount)) return false;
        ...
        if (this$totalRepaymentAmount == null ? other$totalRepaymentAmount != null : !this$totalRepaymentAmount.equals(other$totalRepaymentAmount)) return false;
        ...
        if (this$totalOutstandingAmount == null ? other$totalOutstandingAmount != null : !this$totalOutstandingAmount.equals(other$totalOutstandingAmount)) return false;
        return true;
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return "LoanSchedulePlan(periods=" + this.getPeriods() + ", currency=" + this.getCurrency() + ", loanTermInDays=" + this.getLoanTermInDays() + ", totalDisbursedAmount=" + this.getTotalDisbursedAmount() + ", totalPrincipalAmount=" + this.getTotalPrincipalAmount() + ", totalInterestAmount=" + this.getTotalInterestAmount() + ", totalFeeAmount=" + this.getTotalFeeAmount() + ", totalPenaltyAmount=" + this.getTotalPenaltyAmount() + ", totalRepaymentAmount=" + this.getTotalRepaymentAmount() + ", totalOutstandingAmount=" + this.getTotalOutstandingAmount() + ")";
    }
}
