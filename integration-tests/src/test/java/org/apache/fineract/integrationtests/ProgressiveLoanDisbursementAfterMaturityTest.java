...
public class ProgressiveLoanDisbursementAfterMaturityTest extends FeignLoanTestBase {
    ...
    public void testSecondDisbursementAfterOriginalMaturityDate() {
        ...
        runAt("14 March 2024", () -> {
            ...
            verifyTransactions(loanId, transaction(487.58, "Disbursement", "14 March 2024"), transaction(121.9, "Down Payment", "14 March 2024"));
        ...
        runAt("25 March 2024", () -> {
            Long loanId = loanIdRef.get();
            makeLoanRepayment(loanId, "CreditBalanceRefund", "25 March 2024", 121.9);
            GetLoansLoanIdResponse loanDetails = getLoanDetails(loanId);
        ...
        runAt("1 April 2025", () -> {
            ...
            try {
                ...
                verifyTransactions(loanId, transaction(487.58, "Disbursement", "14 March 2024"), transaction(121.9, "Down Payment", "14 March 2024"), transaction(201.39, "Merchant Issued Refund", "24 March 2024"), transaction(286.19, "Merchant Issued Refund", "24 March 2024"), transaction(121.9, "Credit Balance Refund", "25 March 2024"), transaction(312.69, "Disbursement", "01 April 2025"), transaction(78.17, "Down Payment", "01 April 2025")); // 25% of 312.69
