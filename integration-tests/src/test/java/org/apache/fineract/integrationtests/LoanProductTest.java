...
public class LoanProductTest extends BaseLoanIntegrationTest {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LoanProductTest.class);
    ...
    public class IncomeCapitalizationTest {
        ...
        public void testIncomeCapitalizationEnabled() {
            ...
            final GetLoanProductsProductIdResponse loanProductsProductIdResponse = loanProductHelper.retrieveLoanProductById(loanProductsResponse.getResourceId());
            ...
            Assertions.assertEquals(LoanCapitalizedIncomeCalculationType.FLAT.getCode(), loanProductsProductIdResponse.getCapitalizedIncomeCalculationType().getCode());
            ...
            runAt("20241220", () -> {
                ...
                Assertions.assertEquals(LoanCapitalizedIncomeCalculationType.FLAT.getCode(), loanDetails.getCapitalizedIncomeCalculationType().getCode());
        ...
        public void testIncomeCapitalizationUpdateProduct() {
            ...
            Assertions.assertEquals(feeIncomeAccount.getAccountID().longValue(), loanProductsProductIdResponse.getAccountingMappings().getIncomeFromCapitalizationAccount().getId());
            Assertions.assertNotNull(loanProductsProductIdResponse.getCapitalizedIncomeType());
            Assertions.assertEquals(LoanCapitalizedIncomeType.FEE.getCode(), loanProductsProductIdResponse.getCapitalizedIncomeType().getCode());
            loanProductHelper.updateLoanProductById(loanProductsResponse.getResourceId(), new PutLoanProductsProductIdRequest().incomeFromCapitalizationAccountId(interestIncomeAccount.getAccountID().longValue()).capitalizedIncomeType(PutLoanProductsProductIdRequest.CapitalizedIncomeTypeEnum.INTEREST));
            GetLoanProductsProductIdResponse updatedLoanProductsProductIdResponse = loanProductHelper.retrieveLoanProductById(loanProductsResponse.getResourceId());
            ...
            Assertions.assertEquals(LoanCapitalizedIncomeCalculationType.FLAT.getCode(), updatedLoanProductsProductIdResponse.getCapitalizedIncomeCalculationType().getCode());
            Assertions.assertNotNull(updatedLoanProductsProductIdResponse.getCapitalizedIncomeStrategy());
            Assertions.assertEquals(LoanCapitalizedIncomeStrategy.EQUAL_AMORTIZATION.getCode(), updatedLoanProductsProductIdResponse.getCapitalizedIncomeStrategy().getCode());
            Assertions.assertNotNull(updatedLoanProductsProductIdResponse.getAccountingMappings());
            Assertions.assertEquals(interestIncomeAccount.getAccountID().longValue(), updatedLoanProductsProductIdResponse.getAccountingMappings().getIncomeFromCapitalizationAccount().getId());
            loanProductHelper.updateLoanProductById(loanProductsResponse.getResourceId(), new PutLoanProductsProductIdRequest().enableIncomeCapitalization(false));
            ...
            Assertions.assertEquals(LoanCapitalizedIncomeType.INTEREST.getCode(), updatedLoanProductsProductIdResponse.getCapitalizedIncomeType().getCode());
        }
    ...
    public class BuyDownFeeTest {
        ...
        public void testBuyDownFeeEnabled() {
            ...
            Assertions.assertEquals(LoanBuyDownFeeCalculationType.FLAT.getCode(), loanProductsProductIdResponse.getBuyDownFeeCalculationType().getCode());
        ...
        public void testBuyDownFeeDisabled() {
            final PostClientsResponse client = clientHelper.createClient(ClientHelper.defaultClientCreationRequest());
            final PostLoanProductsResponse loanProductsResponse = loanProductHelper.createLoanProduct(create4IProgressive().enableBuyDownFee(false).buyDownFeeCalculationType(PostLoanProductsRequest.BuyDownFeeCalculationTypeEnum.FLAT).buyDownFeeStrategy(PostLoanProductsRequest.BuyDownFeeStrategyEnum.EQUAL_AMORTIZATION).buyDownFeeIncomeType(PostLoanProductsRequest.BuyDownFeeIncomeTypeEnum.FEE).buyDownExpenseAccountId(buyDownExpenseAccount.getAccountID().longValue()).incomeFromBuyDownAccountId(feeIncomeAccount.getAccountID().longValue()));
            final GetLoanProductsProductIdResponse loanProductsProductIdResponse = loanProductHelper.retrieveLoanProductById(loanProductsResponse.getResourceId());
        ...
        public void testBuyDownFeeUpdateProduct() {
            ...
            Assertions.assertEquals(LoanBuyDownFeeIncomeType.FEE.getCode(), loanProductsProductIdResponse.getBuyDownFeeIncomeType().getCode());
            Assertions.assertNotNull(loanProductsProductIdResponse.getAccountingMappings());
            Assertions.assertEquals(buyDownExpenseAccount.getAccountID().longValue(), loanProductsProductIdResponse.getAccountingMappings().getBuyDownExpenseAccount().getId());
            Assertions.assertEquals(feeIncomeAccount.getAccountID().longValue(), loanProductsProductIdResponse.getAccountingMappings().getIncomeFromBuyDownAccount().getId());
            loanProductHelper.updateLoanProductById(loanProductsResponse.getResourceId(), new PutLoanProductsProductIdRequest().buyDownFeeIncomeType(PutLoanProductsProductIdRequest.BuyDownFeeIncomeTypeEnum.INTEREST).incomeFromBuyDownAccountId(interestIncomeAccount.getAccountID().longValue()));
            GetLoanProductsProductIdResponse updatedLoanProductsProductIdResponse = loanProductHelper.retrieveLoanProductById(loanProductsResponse.getResourceId());
            Assertions.assertEquals(Boolean.TRUE, updatedLoanProductsProductIdResponse.getEnableBuyDownFee());
            Assertions.assertEquals(LoanBuyDownFeeStrategy.EQUAL_AMORTIZATION.getCode(), updatedLoanProductsProductIdResponse.getBuyDownFeeStrategy().getCode());
            Assertions.assertNotNull(updatedLoanProductsProductIdResponse.getBuyDownFeeIncomeType());
            Assertions.assertEquals(LoanBuyDownFeeIncomeType.INTEREST.getCode(), updatedLoanProductsProductIdResponse.getBuyDownFeeIncomeType().getCode());
            Assertions.assertNotNull(updatedLoanProductsProductIdResponse.getAccountingMappings());
            Assertions.assertEquals(buyDownExpenseAccount.getAccountID().longValue(), updatedLoanProductsProductIdResponse.getAccountingMappings().getBuyDownExpenseAccount().getId());
            Assertions.assertEquals(interestIncomeAccount.getAccountID().longValue(), updatedLoanProductsProductIdResponse.getAccountingMappings().getIncomeFromBuyDownAccount().getId());
            loanProductHelper.updateLoanProductById(loanProductsResponse.getResourceId(), new PutLoanProductsProductIdRequest().enableBuyDownFee(false));
            updatedLoanProductsProductIdResponse = loanProductHelper.retrieveLoanProductById(loanProductsResponse.getResourceId());
            ...
            Assertions.assertEquals(LoanBuyDownFeeCalculationType.FLAT.getCode(), updatedLoanProductsProductIdResponse.getBuyDownFeeCalculationType().getCode());
        ...
        public void testBuyDownFeeCumulativeNotSupported() {
            Assertions.assertThrows(RuntimeException.class, () -> loanProductHelper.createLoanProduct(createOnePeriod30DaysPeriodicAccrualProduct(7.0).enableBuyDownFee(true).buyDownFeeCalculationType(PostLoanProductsRequest.BuyDownFeeCalculationTypeEnum.FLAT).buyDownFeeStrategy(PostLoanProductsRequest.BuyDownFeeStrategyEnum.EQUAL_AMORTIZATION).buyDownFeeIncomeType(PostLoanProductsRequest.BuyDownFeeIncomeTypeEnum.FEE).buyDownExpenseAccountId(buyDownExpenseAccount.getAccountID().longValue()).merchantBuyDownFee(true).incomeFromBuyDownAccountId(feeIncomeAccount.getAccountID().longValue())));
        }
        ...
        public void testBuyDownFeeEnabledIncomeFromBuyDownNotProvided() {
            Assertions.assertThrows(RuntimeException.class, () -> loanProductHelper.createLoanProduct(create4IProgressive().enableBuyDownFee(true).buyDownFeeCalculationType(PostLoanProductsRequest.BuyDownFeeCalculationTypeEnum.FLAT).buyDownFeeStrategy(PostLoanProductsRequest.BuyDownFeeStrategyEnum.EQUAL_AMORTIZATION).buyDownFeeIncomeType(PostLoanProductsRequest.BuyDownFeeIncomeTypeEnum.FEE).merchantBuyDownFee(true).buyDownExpenseAccountId(buyDownExpenseAccount.getAccountID().longValue())));
        }
    }
    ...
    public class WriteOffReasonsToExpenseMappings {
        ...
        public void testWriteOffReasonToExpenseAccountMapping_shouldFail_on_nonExistingGLAccount_And_nonExistingWriteOffReason() {
            try {
                loanProductHelper.createLoanProduct(create4IProgressive().addWriteOffReasonsToExpenseMappingsItem(new PostWriteOffReasonToExpenseAccountMappings().expenseAccountId("101230023").writeOffReasonCodeValueId("201230023")));
                Assertions.fail("Should have thrown an IllegalArgumentException");
            } catch (final RuntimeException ex) {
                Assertions.assertTrue(ex.getMessage().contains("GL Account with ID 101230023 does not exist or is not an Expense GL account"));
        ...
        public void testWriteOffReasonToExpenseAccountMapping_shouldFail_on_nonExistingGLAccount_And_Invalid_expenseAccountId() {
            try {
                loanProductHelper.createLoanProduct(create4IProgressive().addWriteOffReasonsToExpenseMappingsItem(new PostWriteOffReasonToExpenseAccountMappings().expenseAccountId("asdf323").writeOffReasonCodeValueId("111")));
                Assertions.fail("Should have thrown an IllegalArgumentException");
            } catch (final RuntimeException ex) {
                Assertions.assertTrue(ex.getMessage().contains("validation.msg.loanproduct.writeOffReasonsToExpenseMappings[0].expenseAccountId.not.a.number"));
                Assertions.assertTrue(ex.getMessage().contains("The parameter `writeOffReasonsToExpenseMappings[0].expenseAccountId` must be a number."));
            }
        }
        ...
        public void testWriteOffReasonToExpenseAccountMapping_shouldFail_on_nonExistingGLAccount_And_Invalid_writeOffReasonCodeValueId() {
            try {
                loanProductHelper.createLoanProduct(create4IProgressive().addWriteOffReasonsToExpenseMappingsItem(new PostWriteOffReasonToExpenseAccountMappings().expenseAccountId("111").writeOffReasonCodeValueId("asdf323")));
                Assertions.fail("Should have thrown an IllegalArgumentException");
            } catch (final RuntimeException ex) {
                log.info("Exception: {}", ex.getMessage());
                Assertions.assertTrue(ex.getMessage().contains("validation.msg.loanproduct.writeOffReasonsToExpenseMappings[0].writeOffReasonCodeValueId.not.a.number"));
                Assertions.assertTrue(ex.getMessage().contains("The parameter `writeOffReasonsToExpenseMappings[0].writeOffReasonCodeValueId` must be a number."));
            }
        }
        ...
        public void testWriteOffReasonsToExpenseMappings() {
            ...
            boolean isReasonCode1InTemplate = writeOffReasonOptions.stream().map(GetLoanProductsWriteOffReasonOptions::getId).anyMatch(id -> Objects.equals(id, reasonCode1));
            boolean isReasonCode2InTemplate = writeOffReasonOptions.stream().map(GetLoanProductsWriteOffReasonOptions::getId).anyMatch(id -> Objects.equals(id, reasonCode2));
            ...
            Long loanProductId = loanProductHelper.createLoanProduct(create4IProgressive().addWriteOffReasonsToExpenseMappingsItem(new PostWriteOffReasonToExpenseAccountMappings().expenseAccountId(expenseAccountId).writeOffReasonCodeValueId(reasonCodeId))).getResourceId();
            ...
            List<GetChargeOffReasonToExpenseAccountMappings> writeOffReasonToExpenseAccountMappings = getLoanProductsProductIdResponse.getWriteOffReasonsToExpenseMappings();
            ...
            List<GetLoanProductsWriteOffReasonOptions> writeOffReasonOptionsResultNonTemplate = getLoanProductsProductIdResponse.getWriteOffReasonOptions();
            ...
            loanProductHelper.updateLoanProductById(loanProductId, update4IProgressive(getLoanProductsProductId.getName(), getLoanProductsProductId.getShortName(), getLoanProductsProductId.getDelinquencyBucket().getId()).writeOffReasonsToExpenseMappings(List.of()));
            // Verify that get loan product API has the corresponding fields
    ...
    private Long createTestWriteOffReason() {
        PostCodeValueDataResponse response = okR(FineractClientHelper.getFineractClient().codeValues.createCodeValue(26L, new PostCodeValuesDataRequest().name(Utils.uniqueRandomStringGenerator("TestWriteOffReason_1_", 6)).description("Test write off reason value 1").isActive(true).position(0))).body();
