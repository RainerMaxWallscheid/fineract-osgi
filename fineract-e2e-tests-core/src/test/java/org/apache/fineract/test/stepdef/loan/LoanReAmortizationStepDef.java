...
public class LoanReAmortizationStepDef extends AbstractStepDef {
    ...
    public void createLoanReAmortization() {
        ...
        PostLoansLoanIdTransactionsResponse response = ok(() -> fineractClient.loanTransactions().handleCommandsLoanTransaction(loanId, reAmortizationRequest, Map.of("command", "reAmortize")));
    ...
    public void createLoanReAmortizationWithInterestHandlingShouldFail(final String reAmortizationInterestHandling) {
        ...
        final PostLoansLoanIdTransactionsRequest reAmortizationRequest = loanRequestFactory.defaultLoanReAmortizationRequest().reAmortizationInterestHandling(reAmortizationInterestHandling);
        fail(() -> fineractClient.loanTransactions().handleCommandsLoanTransaction(loanId, reAmortizationRequest, Map.of("command", "reAmortize")));
    }
    ...
    public void createLoanReAmortizationWithInterestHandling(final String reAmortizationInterestHandling) {
        ...
        final Long loanId = loanResponse.getLoanId();
        final PostLoansLoanIdTransactionsRequest reAmortizationRequest = loanRequestFactory.defaultLoanReAmortizationRequest().reAmortizationInterestHandling(reAmortizationInterestHandling);
        final PostLoansLoanIdTransactionsResponse response = ok(() -> fineractClient.loanTransactions().handleCommandsLoanTransaction(loanId, reAmortizationRequest, Map.of("command", "reAmortize")));
        testContext().set(TestContextKey.LOAN_REAMORTIZATION_RESPONSE, response);
    }
    ...
    public void createLoanReAmortizationByLoanExternalId() {
        ...
        PostLoansLoanIdTransactionsRequest reAmortizationRequest = loanRequestFactory.defaultLoanReAmortizationRequest();
        PostLoansLoanIdTransactionsResponse response = ok(() -> fineractClient.loanTransactions().handleCommandsLoanTransactionByLoanExternalId(loanExternalId, reAmortizationRequest, Map.of("command", "reAmortize")));
        testContext().set(TestContextKey.LOAN_REAMORTIZATION_RESPONSE, response);
    }
    ...
    public void undoLoanReAmortization() {
        PostLoansResponse loanResponse = testContext().get(TestContextKey.LOAN_CREATE_RESPONSE);
        long loanId = loanResponse.getLoanId();
        PostLoansLoanIdTransactionsResponse response = ok(() -> fineractClient.loanTransactions().handleCommandsLoanTransaction(loanId, new PostLoansLoanIdTransactionsRequest(), Map.of("command", "undoReAmortize")));
    ...
    public void createLoanReAmortizationFailsWithError(int errorCode) {
        ...
        CallFailedRuntimeException exception = fail(() -> fineractClient.loanTransactions().handleCommandsLoanTransaction(loanId, reAmortizationRequest, Map.of("command", "reAmortize")));
    ...
    public void reAmortizationWithInterestHandlingContractTerminatedLoanFailure(final String reAmortizationInterestHandling) {
        reAmortizationInterestHandlingLoanLoanFailure(reAmortizationInterestHandling, ErrorMessageHelper.reAmortizeContractTerminatedLoanFailure());
    }
    ...
    public void createReAmortizedPreviewByLoanExternalIdFailsWithErrorCode(int errorCode, final DataTable table) {
        ...
        CallFailedRuntimeException exception = fail(() -> fineractClient.loanTransactions().previewReAmortizeLoanScheduleByLoanExternalId(loanExternalId, queryParams));
    ...
    private void validateRepaymentScheduleTotal(final List<String> header, final LoanScheduleData repaymentSchedule, final List<String> expectedAmounts) {
    ...
    @java.lang.SuppressWarnings("all")
        public LoanReAmortizationStepDef(final FineractFeignClient fineractClient, final EventAssertion eventAssertion, final LoanRequestFactory loanRequestFactory) {
