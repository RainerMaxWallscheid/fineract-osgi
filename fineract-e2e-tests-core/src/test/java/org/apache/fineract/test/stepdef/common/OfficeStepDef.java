...
public class OfficeStepDef extends AbstractStepDef {
    ...
    public void createNewOffice() {
        final PostOfficesRequest request = //
        //
        //
        //
        //
        new PostOfficesRequest().name(Utils.randomStringGenerator("Office_", 5)).parentId(1L).openingDate(LocalDate.of(2000, 1, 1)).dateFormat("yyyy-MM-dd").locale("en");//
    ...
    @java.lang.SuppressWarnings("all")
        public OfficeStepDef(final FineractFeignClient fineractClient) {
