...
public class WorkingCapitalNearBreachConfigStepDef extends AbstractStepDef {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(WorkingCapitalNearBreachConfigStepDef.class);
    @Autowired
    ...
    public void adminCreatesWCNearBreachWithValues() {
        ...
        final CommandProcessingResult response = ok(() -> fineractFeignClient.workingCapitalNearBreaches().createWorkingCapitalNearBreach(request));
    ...
    public void checkCreatedNearBreachHasTheFollowingValues() {
        ...
        final WorkingCapitalNearBreachData data = ok(() -> fineractFeignClient.workingCapitalNearBreaches().retrieveWorkingCapitalNearBreach(id));
    ...
    public void createWCBreachWithInvalidDataFailed(final String fieldName, final String value, final String errorMessage) {
        final WorkingCapitalNearBreachRequest request = setWCNearBreachFieldValue(workingCapitalRequestFactory.defaultWorkingCapitalNearBreachRequest(), fieldName, value);
    ...
    public void adminCreatesWCNearBreachWithValuesForUpdate() {
        ...
        //
        workingCapitalRequestFactory.defaultWorkingCapitalNearBreachRequest().nearBreachFrequency(4).nearBreachFrequencyType(WorkingCapitalBreachFrequencyType.YEARS.getCode()).nearBreachThreshold(new BigDecimal("82.34")); //
        final CommandProcessingResult response = ok(() -> fineractFeignClient.workingCapitalNearBreaches().createWorkingCapitalNearBreach(request));
        assertThat(response).isNotNull();
        assertThat(response.getResourceId()).isNotNull();
    ...
    public void adminCreateWCNearBreachWithDuplicateNameFailure() {
        ...
        WorkingCapitalNearBreachRequest nearBreachRequestForUpdate = TestContext.INSTANCE.get(TestContextKey.WORKING_CAPITAL_NEAR_BREACH_CREATE_REQUEST_FOR_UPDATE);
        String name = nearBreachRequestForUpdate.getNearBreachName();
        WorkingCapitalNearBreachRequest breachRequest = workingCapitalRequestFactory.defaultWorkingCapitalNearBreachRequest().nearBreachName(name); //
    ...
    public void adminModifiesWCBreachWithValues() {
        ...
        //
        //
        workingCapitalRequestFactory.defaultWorkingCapitalNearBreachRequest().nearBreachName("NearBreach-WCL-" + Utils.randomStringGenerator(8)).nearBreachFrequency(4).nearBreachFrequencyType("MONTHS").nearBreachThreshold(new BigDecimal("59.8")); //
    ...
    public void adminUpdateWCBreachWithDuplicateNameFailure() {
        ...
        WorkingCapitalNearBreachRequest nearBreachRequestForUpdate = TestContext.INSTANCE.get(TestContextKey.WORKING_CAPITAL_NEAR_BREACH_CREATE_REQUEST);
        String name = nearBreachRequestForUpdate.getNearBreachName();
        WorkingCapitalNearBreachRequest nearBreachRequest =  //
        workingCapitalRequestFactory.defaultWorkingCapitalNearBreachRequest().nearBreachName(name); //
    ...
    public void adminDeleteWCBreachAssignedToWCLPFailure() {
        ...
        final CallFailedRuntimeException exception = fail(() -> fineractFeignClient.workingCapitalNearBreaches().deleteWorkingCapitalNearBreach(id));
    ...
    private WorkingCapitalNearBreachRequest setWCNearBreachFieldValue(final WorkingCapitalNearBreachRequest request, final String fieldName, String fieldValue) {
    ...
    private void checkCreateWCNearBreachWithInvalidDataFailure(final WorkingCapitalNearBreachRequest request, final String errorMessage, final int errorCode) {
        final CallFailedRuntimeException exception = fail(() -> fineractFeignClient.workingCapitalNearBreaches().createWorkingCapitalNearBreach(request));
    ...
    private void checkUpdateWCNearBreachWithInvalidDataFailure(final Long id, final WorkingCapitalNearBreachRequest request, final String errorMessage, final int errorCode) {
        final CallFailedRuntimeException exception = fail(() -> fineractFeignClient.workingCapitalNearBreaches().updateWorkingCapitalNearBreach(id, request));
        assertThat(exception.getStatus()).as(ErrorMessageHelper.incorrectExpectedValueInResponse()).isEqualTo(errorCode);
        assertThat(exception.getDeveloperMessage()).contains(errorMessage);
    }
    ...
    private void checkRetrieveWCNearBreachNotFoundFailure(final Long id) {
        final CallFailedRuntimeException exception = fail(() -> fineractFeignClient.workingCapitalNearBreaches().retrieveWorkingCapitalNearBreach(id));
    ...
    @java.lang.SuppressWarnings("all")
        public WorkingCapitalNearBreachConfigStepDef(final FineractFeignClient fineractFeignClient) {
