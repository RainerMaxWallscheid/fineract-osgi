...
public class CurrencyStepDef extends AbstractStepDef {
    ...
    public void currencyHasFollowingProperties(String currencyCode, DataTable table) {
        ...
        assertThat(currency.getName()).as(ErrorMessageHelper.wrongCurrencyField(currencyCode, "name", currency.getName(), expectedName)).isEqualTo(expectedName);
        assertThat(currency.getDisplaySymbol()).as(ErrorMessageHelper.wrongCurrencyField(currencyCode, "displaySymbol", currency.getDisplaySymbol(), expectedSymbol)).isEqualTo(expectedSymbol);
        assertThat(currency.getDecimalPlaces()).as(ErrorMessageHelper.wrongCurrencyField(currencyCode, "decimalPlaces", currency.getDecimalPlaces(), expectedDecimalPlaces)).isEqualTo(expectedDecimalPlaces);
        assertThat(currency.getNameCode()).as(ErrorMessageHelper.wrongCurrencyField(currencyCode, "nameCode", currency.getNameCode(), "currency." + currencyCode)).isEqualTo("currency." + currencyCode);
        assertThat(currency.getDisplayLabel()).as(ErrorMessageHelper.wrongCurrencyField(currencyCode, "displayLabel", currency.getDisplayLabel(), expectedName + " (" + expectedSymbol + ")")).isEqualTo(expectedName + " (" + expectedSymbol + ")");
    }
    ...
    public void returnedCurrencyListMatches(String expectedCodes) {
        ...
        assertThat(response.getCurrencies()).as(ErrorMessageHelper.wrongSelectedCurrencies(response.getCurrencies(), expected)).isEqualTo(expected);
    }
    ...
    @java.lang.SuppressWarnings("all")
        public CurrencyStepDef(final FineractFeignClient fineractClient) {
