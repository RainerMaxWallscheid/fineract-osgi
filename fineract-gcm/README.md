...
|----------------|------|-----|------|
| `fineract-gcm-api` | `api/` | `org.apache.fineract.gcm.api` | Config DTO + `NotificationConfigurationReadService` port |
| `fineract-gcm-impl` | `impl/` | `org.apache.fineract.gcm.impl` | Sender client + `NotificationSenderService`; Equinox `GcmOsgiBundleActivator` |
