...
| `fineract-springbatch-impl` | `impl/` | `org.apache.fineract.springbatch.impl` | Manager/worker configs (JMS/Kafka/Spring events), `PropertyServiceImpl`; Equinox DS `OSGI-INF/springbatch.xml` |
