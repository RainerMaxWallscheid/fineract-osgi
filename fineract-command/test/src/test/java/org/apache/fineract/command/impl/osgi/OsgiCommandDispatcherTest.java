...
class OsgiCommandDispatcherTest {

    @Test
    void dispatchWithoutHandlersThrows() {
        ...
        command.setPayload("x");
        assertThrows(CommandHandlerNotFoundException.class, () -> dispatcher.dispatch(command).get());
    }
