...
/**
 * Empty interoperation port for Equinox without Spring/JPA. Published by {@code OSGI-INF/interoperation.xml} (ADR-022
 * B6).
 */
public final class OsgiInteropService implements InteropService {
