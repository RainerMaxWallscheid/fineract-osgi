...
| `fineract-useradministration-impl` | `impl/` | `org.apache.fineract.useradministration.impl` | REST, handlers, write/read impls, password-policy entities, `UserAdministrationOsgiServiceRegistrar` |
