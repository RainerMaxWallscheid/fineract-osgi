...
class PaymentDetailOsgiServiceRegistrarTest {

    @Test
    @SuppressWarnings("unchecked")
    void afterPropertiesSet_withoutOsgi_doesNotThrow() {
        ObjectProvider<PaymentDetailWritePlatformService> w = mock(ObjectProvider.class);
        when(w.getIfAvailable()).thenReturn(null);
        var reg = new PaymentDetailOsgiServiceRegistrar(w);
