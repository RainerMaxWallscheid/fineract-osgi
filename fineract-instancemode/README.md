...
|----------------|------|-----|------|
| `fineract-instancemode-api` | `api/` | `org.apache.fineract.instancemode.api` | `InstanceModePort`, swagger request DTO, `FineractInstanceModeApiFilter` |
| `fineract-instancemode-impl` | `impl/` | `org.apache.fineract.instancemode.impl` | Test-profile REST resource; Equinox DS `OSGI-INF/instancemode.xml` |
