...
/**
 * Empty instance-mode port for Equinox without Spring/JPA. Published by {@code OSGI-INF/instancemode.xml} (ADR-022 B6).
 */
public final class OsgiInstanceModePort implements InstanceModePort {
