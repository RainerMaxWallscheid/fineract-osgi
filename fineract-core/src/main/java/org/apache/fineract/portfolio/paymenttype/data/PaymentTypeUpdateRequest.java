...
public class PaymentTypeUpdateRequest implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
        public static class PaymentTypeUpdateRequestBuilder {
        @java.lang.SuppressWarnings("all")
                private Long id;
        @java.lang.SuppressWarnings("all")
                private String name;
        ...
        @java.lang.SuppressWarnings("all")
                PaymentTypeUpdateRequestBuilder() {
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder id(final Long id) {
            this.id = id;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder name(final String name) {
            this.name = name;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder description(final String description) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder isCashPayment(final Boolean isCashPayment) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder position(final Long position) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder codeName(final String codeName) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder isSystemDefined(final Boolean isSystemDefined) {
        ...
        @java.lang.SuppressWarnings("all")
                public PaymentTypeUpdateRequest build() {
            Boolean isSystemDefined$value = this.isSystemDefined$value;
            if (!this.isSystemDefined$set) isSystemDefined$value = PaymentTypeUpdateRequest.$default$isSystemDefined();
            return new PaymentTypeUpdateRequest(this.id, this.name, this.description, this.isCashPayment, this.position, this.codeName, isSystemDefined$value);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
                public java.lang.String toString() {
            return "PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder(id=" + this.id + ", name=" + this.name + ", description=" + this.description + ", isCashPayment=" + this.isCashPayment + ", position=" + this.position + ", codeName=" + this.codeName + ", isSystemDefined$value=" + this.isSystemDefined$value + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
        public static PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder builder() {
        return new PaymentTypeUpdateRequest.PaymentTypeUpdateRequestBuilder();
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (!(o instanceof PaymentTypeUpdateRequest)) return false;
        final PaymentTypeUpdateRequest other = (PaymentTypeUpdateRequest) o;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return other instanceof PaymentTypeUpdateRequest;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
        return "PaymentTypeUpdateRequest(id=" + this.getId() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", isCashPayment=" + this.getIsCashPayment() + ", position=" + this.getPosition() + ", codeName=" + this.getCodeName() + ", isSystemDefined=" + this.getIsSystemDefined() + ")";
    }

    @java.lang.SuppressWarnings("all")
        public PaymentTypeUpdateRequest() {
        this.isSystemDefined = PaymentTypeUpdateRequest.$default$isSystemDefined();
    }

    @java.lang.SuppressWarnings("all")
        public PaymentTypeUpdateRequest(final Long id, final String name, final String description, final Boolean isCashPayment, final Long position, final String codeName, final Boolean isSystemDefined) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.isCashPayment = isCashPayment;
