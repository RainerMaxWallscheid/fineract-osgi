...
public class ClientIdentifierReadPlatformServiceImpl implements ClientIdentifierReadPlatformService {
    ...
    @java.lang.SuppressWarnings("all")
        public ClientIdentifierReadPlatformServiceImpl(final JdbcTemplate jdbcTemplate, final PlatformSecurityContext context) {
