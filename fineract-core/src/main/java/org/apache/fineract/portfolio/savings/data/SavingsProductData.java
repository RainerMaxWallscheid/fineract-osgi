...
public final class SavingsProductData implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
        public void setDepositAccountType(final String depositAccountType) {
