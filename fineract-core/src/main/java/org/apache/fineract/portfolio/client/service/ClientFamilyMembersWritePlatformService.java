...
public interface ClientFamilyMembersWritePlatformService {
    ...
    /** Bulk family members from create-client JSON ({@code familyMembers} array). */
    CommandProcessingResult addFamilyMembersDuringClientCreate(long clientId, JsonCommand command);
