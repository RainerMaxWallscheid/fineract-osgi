...
public final class AdHocSearchQueryData {
    ...
    public static AdHocSearchQueryData template(final Collection<LoanProductLookupData> loanProducts, final Collection<OfficeData> offices) {
    ...
    public static AdHocSearchQueryData matchedResult(final String officeName, final String loanProductName, final Integer count, final BigDecimal loanOutStanding, final Double percentage) {
        final Collection<LoanProductLookupData> loanProducts = null;
        final Collection<OfficeData> offices = null;
        return new AdHocSearchQueryData(officeName, loanProductName, count, loanOutStanding, percentage, loanProducts, offices);
    }

    private AdHocSearchQueryData(final String officeName, final String loanProductName, final Integer count, final BigDecimal loanOutStanding, final Double percentage, final Collection<LoanProductLookupData> loanProducts, final Collection<OfficeData> offices) {
