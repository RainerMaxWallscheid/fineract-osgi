...
public final class PostingPeriod {
    ...
    public static PostingPeriod createFrom(final LocalDateInterval periodInterval, final Money periodStartingBalance, final List<SavingsAccountTransactionDetailsForPostingPeriod> orderedListOfTransactions, final MonetaryCurrency currency, final SavingsCompoundingInterestPeriodType interestCompoundingPeriodType, final SavingsInterestCalculationType interestCalculationType, final BigDecimal interestRateAsFraction, final long daysInYear, final LocalDate upToInterestCalculationDate, Collection<Long> interestPostTransactions, boolean isInterestTransfer, final Money minBalanceForInterestCalculation, final boolean isSavingsInterestPostingAtCurrentPeriodEnd, final boolean isUserPosting, Integer financialYearBeginningMonth) {
        ...
        return createFrom(periodInterval, periodStartingBalance, orderedListOfTransactions, currency, interestCompoundingPeriodType, interestCalculationType, interestRateAsFraction, daysInYear, upToInterestCalculationDate, interestPostTransactions, isInterestTransfer, minBalanceForInterestCalculation, isSavingsInterestPostingAtCurrentPeriodEnd, overdraftInterestRateAsFraction, minOverdraftForInterestCalculation, isUserPosting, financialYearBeginningMonth);
    }
    ...
    public static PostingPeriod createFrom(final LocalDateInterval periodInterval, final Money periodStartingBalance, final List<SavingsAccountTransactionDetailsForPostingPeriod> orderedListOfTransactions, final MonetaryCurrency currency, final SavingsCompoundingInterestPeriodType interestCompoundingPeriodType, final SavingsInterestCalculationType interestCalculationType, final BigDecimal interestRateAsFraction, final long daysInYear, final LocalDate upToInterestCalculationDate, Collection<Long> interestPostTransactions, boolean isInterestTransfer, final Money minBalanceForInterestCalculation, final boolean isSavingsInterestPostingAtCurrentPeriodEnd, final BigDecimal overdraftInterestRateAsFraction, final Money minOverdraftForInterestCalculation, boolean isUserPosting, int financialYearBeginningMonth) {
        ...
        if (accountEndOfDayBalances.isEmpty()) {
            ...
            final EndOfDayBalance endOfDayBalance = EndOfDayBalance.from(balanceStartDate, openingDayBalance, closeOfDayBalance, numberOfDaysOfBalance);
            accountEndOfDayBalances.add(endOfDayBalance);
            closeOfDayBalance = endOfDayBalance.closingBalance();
            openingDayBalance = closeOfDayBalance;
        }
        final List<CompoundingPeriod> compoundingPeriods = compoundingPeriodsInPostingPeriod(periodInterval, interestCompoundingPeriodType, accountEndOfDayBalances, upToInterestCalculationDate, financialYearBeginningMonth);
    ...
    public static PostingPeriod createFromDTO(final LocalDateInterval periodInterval, final Money periodStartingBalance, final List<SavingsAccountTransactionData> orderedListOfTransactions, final MonetaryCurrency currency, final SavingsCompoundingInterestPeriodType interestCompoundingPeriodType, final SavingsInterestCalculationType interestCalculationType, final BigDecimal interestRateAsFraction, final long daysInYear, final LocalDate upToInterestCalculationDate, Collection<Long> interestPostTransactions, boolean isInterestTransfer, final Money minBalanceForInterestCalculation, final boolean isSavingsInterestPostingAtCurrentPeriodEnd, final BigDecimal overdraftInterestRateAsFraction, final Money minOverdraftForInterestCalculation, boolean isUserPosting, int financialYearBeginningMonth, final boolean isAllowOverdraft) {
        final List<EndOfDayBalance> accountEndOfDayBalances = new ArrayList<>();
        boolean interestTransfered = false;
        Money openingDayBalance = periodStartingBalance;
        Money closeOfDayBalance = openingDayBalance;
        for (final SavingsAccountTransactionData transaction : orderedListOfTransactions) {
            if (transaction.fallsWithin(periodInterval)) {
                ...
                final EndOfDayBalance endOfDayBalance = transaction.toEndOfDayBalanceBoundedBy(openingDayBalance, periodInterval, isAllowOverdraft);
                accountEndOfDayBalances.add(endOfDayBalance);
                closeOfDayBalance = endOfDayBalance.closingBalance();
                openingDayBalance = closeOfDayBalance;
            }
    ...
    public BigDecimal calculateInterest(final CompoundInterestValues compoundInterestValues) {
        ...
        for (final CompoundingPeriod compoundingPeriod : this.compoundingPeriods) {
            ...
            if (!SavingsCompoundingInterestPeriodType.DAILY.equals(this.interestCompoundingType)) {
                compoundingPeriodEndDate = determineInterestPeriodEndDateFrom(compoundingPeriod.getPeriodInterval().startDate(), this.interestCompoundingType, compoundingPeriod.getPeriodInterval().endDate(), this.getFinancialYearBeginningMonth());
            }
    ...
    private static List<CompoundingPeriod> compoundingPeriodsInPostingPeriod(final LocalDateInterval postingPeriodInterval, final SavingsCompoundingInterestPeriodType interestPeriodType, final List<EndOfDayBalance> allEndOfDayBalances, final LocalDate upToInterestCalculationDate, int financialYearBeginningMonth) {
        ...
        case MONTHLY: 
            ...
            while (!DateUtils.isAfter(periodStartDate, postingPeriodEndDate) && !DateUtils.isAfter(periodEndDate, postingPeriodEndDate)) {
        ...
        case QUATERLY: 
            ...
            while (!DateUtils.isAfter(periodStartDate, qPostingPeriodEndDate) && !DateUtils.isAfter(periodEndDate, qPostingPeriodEndDate)) {
                periodEndDate = determineInterestPeriodEndDateFrom(periodStartDate, interestPeriodType, upToInterestCalculationDate, financialYearBeginningMonth);
        ...
        case BI_ANNUAL: 
            ...
            periodStartDate = postingPeriodInterval.startDate();
            periodEndDate = periodStartDate;
            while (!DateUtils.isAfter(periodStartDate, bPostingPeriodEndDate) && !DateUtils.isAfter(periodEndDate, bPostingPeriodEndDate)) {
                periodEndDate = determineInterestPeriodEndDateFrom(periodStartDate, interestPeriodType, upToInterestCalculationDate, financialYearBeginningMonth);
        ...
        case ANNUAL: 
            ...
            periodStartDate = postingPeriodInterval.startDate();
            periodEndDate = periodStartDate;
            while (!DateUtils.isAfter(periodStartDate, aPostingPeriodEndDate) && !DateUtils.isAfter(periodEndDate, aPostingPeriodEndDate)) {
                periodEndDate = determineInterestPeriodEndDateFrom(periodStartDate, interestPeriodType, upToInterestCalculationDate, financialYearBeginningMonth);
    ...
    private static LocalDate determineInterestPeriodEndDateFrom(final LocalDate periodStartDate, final SavingsCompoundingInterestPeriodType interestPeriodType, final LocalDate upToInterestCalculationDate, int financialYearBeginningMonth) {
    ...
    private static LocalDate getPeriodEndDate(LocalDate periodEndDate, int previousMonth, int periodsInMonth, LocalDate periodStartDate) {
        ...
        if (notInRange) {
            periodEndDate = LocalDate.of(year + 1, monthSet.first(), DateUtils.getBusinessLocalDate().withMonth(monthSet.first()).lengthOfMonth());
        }
        return periodEndDate;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public void setInterestEarnedUnrounded(final BigDecimal interestEarnedUnrounded) {
        this.interestEarnedUnrounded = interestEarnedUnrounded;
    }

    @java.lang.SuppressWarnings("all")
        public void setInterestEarnedRounded(final Money interestEarnedRounded) {
        this.interestEarnedRounded = interestEarnedRounded;
    }

    @java.lang.SuppressWarnings("all")
        public void setInterestTransfered(final boolean interestTransfered) {
        this.interestTransfered = interestTransfered;
    }

    @java.lang.SuppressWarnings("all")
        public void setUserPosting(final boolean isUserPosting) {
        this.isUserPosting = isUserPosting;
    }

    @java.lang.SuppressWarnings("all")
        public void setMinOverdraftForInterestCalculation(final Money minOverdraftForInterestCalculation) {
        this.minOverdraftForInterestCalculation = minOverdraftForInterestCalculation;
    }

    @java.lang.SuppressWarnings("all")
        public void setFinancialYearBeginningMonth(final Integer financialYearBeginningMonth) {
        this.financialYearBeginningMonth = financialYearBeginningMonth;
    }

    @java.lang.SuppressWarnings("all")
        public void setOverdraftInterest(final boolean overdraftInterest) {
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return this.interestCompoundingType;
    }

    @java.lang.SuppressWarnings("all")
        public BigDecimal getInterestRateAsFraction() {
        return this.interestRateAsFraction;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public LocalDate getDateOfPostingTransaction() {
        return this.dateOfPostingTransaction;
    }

    @java.lang.SuppressWarnings("all")
        public BigDecimal getInterestEarnedUnrounded() {
        return this.interestEarnedUnrounded;
    }

    @java.lang.SuppressWarnings("all")
        public Money getInterestEarnedRounded() {
        return this.interestEarnedRounded;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public SavingsInterestCalculationType getInterestCalculationType() {
        return this.interestCalculationType;
    }

    @java.lang.SuppressWarnings("all")
        public Money getMinBalanceForInterestCalculation() {
        return this.minBalanceForInterestCalculation;
    }

    @java.lang.SuppressWarnings("all")
        public BigDecimal getOverdraftInterestRateAsFraction() {
        return this.overdraftInterestRateAsFraction;
    }

    @java.lang.SuppressWarnings("all")
        public Money getMinOverdraftForInterestCalculation() {
