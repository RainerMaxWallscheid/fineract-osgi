...
public abstract class RecurringDepositAccountBusinessEvent extends AbstractBusinessEvent<PortfolioAccountEventData> {

    private static final String CATEGORY = "Deposit";

    public RecurringDepositAccountBusinessEvent(PortfolioAccountEventData value) {
        super(value);
    }
