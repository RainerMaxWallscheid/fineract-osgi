...
public class DataValidatorBuilder {
    ...
    public DataValidatorBuilder andNotBlank(final String linkedParameterName, final String linkedValue) {
        ...
        if (StringUtils.isBlank(linkedValue)) {
            String validationErrorCode = "validation.msg." + this.resource + "." + linkedParameterName + ".cannot.be.empty.when." + this.parameter + ".is.populated";
            String defaultEnglishMessage = "The parameter `" + linkedParameterName + "` cannot be empty when " + this.parameter + " is populated.";
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, linkedParameterName, linkedValue, this.value);
    ...
    public void failWithCode(final String errorCode, final Object... defaultUserMessageArgs) {
        ...
        final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, "Failed data validation due to: " + errorCode + ".", this.parameter, this.value, defaultUserMessageArgs);
        this.dataValidationErrors.add(error);
    }
    ...
    public void failWithCodeNoParameterAddedToErrorCode(final String errorCode, final Object... defaultUserMessageArgs) {
        ...
        final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value, defaultUserMessageArgs);
        this.dataValidationErrors.add(error);
    }
    ...
    public DataValidatorBuilder notNull() {
        if (this.value == null && !this.ignoreNullValue) {
            ...
            final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".").append(this.parameter);
            ...
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(), defaultEnglishMessage, realParameterName, this.arrayIndex);
            this.dataValidationErrors.add(error);
        }
        return this;
    }
    ...
    public DataValidatorBuilder notExceedingLengthOf(final Integer maxLength) {
        ...
        if (this.value != null && this.value.toString().trim().length() > maxLength) {
            ...
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, maxLength, this.value.toString());
            this.dataValidationErrors.add(error);
        }
        return this;
    }
    ...
    public DataValidatorBuilder inMinMaxRange(final Integer min, final Integer max) {
        ...
        if (this.value != null) {
            ...
            if (number < min || number > max) {
                ...
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, number, min, max);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public DataValidatorBuilder isOneOfTheseValues(final Object... values) {
        ...
        if (this.value == null || !rawValuesList.contains(this.value)) {
            ...
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value, values);
            this.dataValidationErrors.add(error);
        }
        return this;
    }
    ...
    public DataValidatorBuilder isOneOfTheseStringValues(final List<String> valuesList) {
        ...
        if (this.value == null || !valuesListLowercase.contains(this.value.toString().toLowerCase())) {
            ...
            String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".is.not.one.of.expected.enumerations";
            String defaultEnglishMessage = "The parameter `" + this.parameter + "` must be one of [ " + valuesListStr + " ] " + ".";
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value, valuesList);
            this.dataValidationErrors.add(error);
        }
        return this;
    }
    ...
    public DataValidatorBuilder positiveAmount() {
        ...
        if (this.value != null) {
            ...
            if (number.compareTo(BigDecimal.ZERO) <= 0) {
                ...
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, number, 0);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public DataValidatorBuilder integerGreaterThanNumber(Integer number) {
        ...
        if (this.value != null) {
            ...
            if (intValue < number + 1) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".not.greater.than.specified.number";
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` must be greater than " + number;
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, intValue, number);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public DataValidatorBuilder integerEqualToOrGreaterThanNumber(Integer number) {
        ...
        if (this.value != null) {
            ...
            if (intValue < number) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".not.equal.to.or.greater.than.specified.number";
    ...
    public DataValidatorBuilder integerInMultiplesOfNumber(Integer number) {
        ...
        if (this.value != null) {
            ...
            if (intValue < number || intValue % number != 0) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".not.in.multiples.of.specified.number";
    ...
    public DataValidatorBuilder longGreaterThanNumber(Long number) {
        ...
        if (this.value != null) {
            ...
            if (longValue < number + 1) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".not.greater.than.specified.number";
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` must be greater than " + number;
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, longValue, number);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public DataValidatorBuilder longGreaterThanNumber(String paramName, Long number, int index) {
        ...
        if (this.value != null) {
            final long longValue = Long.parseLong(this.value.toString());
            if (longValue < number + 1) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".not.greater.than.specified." + paramName + ".at Index." + index;
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` must be greater than " + number;
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, longValue, number);
                this.dataValidationErrors.add(error);
            }
    ...
    public DataValidatorBuilder inValidValue(final String parameterValueCode, final Object invalidValue) {
        ...
        final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, invalidValue);
        this.dataValidationErrors.add(error);
        return this;
    }
    ...
    public DataValidatorBuilder mustBeBlankWhenParameterProvided(final String parameterName, final Object parameterValue) {
        ...
        if (this.value != null && StringUtils.isBlank(this.value.toString()) && parameterValue != null && StringUtils.isNotBlank(parameterValue.toString())) {
            return this;
        }
        String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".cannot.also.be.provided.when." + parameterName + ".is.populated";
        String defaultEnglishMessage = "The parameter `" + this.parameter + "` cannot also be provided when `" + parameterName + "` is populated.";
        final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value, parameterName, parameterValue);
        this.dataValidationErrors.add(error);
        return this;
    }
    ...
    public DataValidatorBuilder mustBeBlankWhenParameterProvidedIs(final String parameterName, final Object parameterValue) {
        ...
        String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".cannot.also.be.provided.when." + parameterName + ".is." + parameterValue;
        String defaultEnglishMessage = "The parameter `" + this.parameter + "` cannot also be provided when `" + parameterName + "` is " + parameterValue;
        final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value, parameterName, parameterValue);
        this.dataValidationErrors.add(error);
        return this;
    }
    ...
    public DataValidatorBuilder cantBeBlankWhenParameterProvidedIs(final String parameterName, final Object parameterValue) {
        ...
        String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".must.be.provided.when." + parameterName + ".is." + parameterValue;
        String defaultEnglishMessage = "The parameter `" + this.parameter + "` must be provided when `" + parameterName + "` is " + parameterValue;
        final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value, parameterName, parameterValue);
        this.dataValidationErrors.add(error);
        return this;
    }
    ...
    public DataValidatorBuilder compareMinimumAndMaximumAmounts(final BigDecimal minimumBalance, final BigDecimal maximumBalance) {
        if (minimumBalance != null && maximumBalance != null) {
            if (maximumBalance.compareTo(minimumBalance) < 0) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".is.not.within.expected.range";
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` minimum amount " + minimumBalance + " should less than the maximum amount " + maximumBalance + ".";
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, minimumBalance, maximumBalance);
                this.dataValidationErrors.add(error);
                return this;
            }
        }
    ...
    public DataValidatorBuilder inMinAndMaxAmountRange(final BigDecimal minimumAmount, final BigDecimal maximumAmount) {
        if (minimumAmount != null && maximumAmount != null && this.value != null) {
            ...
            if (amount.compareTo(minimumAmount) < 0 || amount.compareTo(maximumAmount) > 0) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".amount.is.not.within.min.max.range";
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` amount " + amount + " must be between " + minimumAmount + " and " + maximumAmount + " .";
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, amount, minimumAmount, maximumAmount);
                this.dataValidationErrors.add(error);
                return this;
            }
        }
    ...
    public DataValidatorBuilder notLessThanMin(final BigDecimal min) {
        if (min != null && this.value != null) {
            ...
            if (amount.compareTo(min) < 0) {
                ...
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` value " + amount + " must not be less than the minimum value " + min;
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, amount, min);
                this.dataValidationErrors.add(error);
                return this;
            }
        }
    ...
    public DataValidatorBuilder notGreaterThanMax(final BigDecimal max) {
        if (max != null && this.value != null) {
            ...
            if (amount.compareTo(max) > 0) {
                ...
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` value " + amount + " must not be more than maximum value " + max;
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, amount, max);
                this.dataValidationErrors.add(error);
                return this;
            }
        }
    ...
    public DataValidatorBuilder compareMinAndMaxOfTwoBigDecmimalNos(final BigDecimal min, final BigDecimal max) {
        if (min != null && max != null && max.compareTo(min) < 0) {
            ...
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, min, max);
            this.dataValidationErrors.add(error);
            return this;
        }
        return this;
    ...
    public DataValidatorBuilder isValidRecurringRule(final String recurringRule) {
        if (StringUtils.isNotBlank(recurringRule)) {
            try {
                ...
                final ApiParameterError error = ApiParameterError.parameterError("validation.msg.invalid.recurring.rule", "The Recurring Rule value: " + recurringRule + " is not valid.", this.parameter, recurringRule);
                this.dataValidationErrors.add(error);
                return this;
            } catch (final ParseException e) {
                final ApiParameterError error = ApiParameterError.parameterError("validation.msg.recurring.rule.parsing.error", "Error in parsing the Recurring Rule value: " + recurringRule + ".", this.parameter, recurringRule);
                this.dataValidationErrors.add(error);
                return this;
            }
        }
    ...
    public DataValidatorBuilder notLessThanMin(final Integer min) {
        ...
        if (this.value != null && min != null) {
            ...
            if (number < min) {
                ...
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, number, min);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public DataValidatorBuilder notGreaterThanMax(final Integer max) {
        ...
        if (this.value != null && max != null) {
            ...
            if (number > max) {
                ...
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, number, max);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public DataValidatorBuilder matchesRegularExpression(final String expression) {
        ...
        if (this.value != null && !this.value.toString().matches(expression)) {
            ...
            String defaultEnglishMessage = "The parameter `" + this.parameter + "` must match the provided regular expression [ " + expression + " ] " + ".";
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value, expression);
            this.dataValidationErrors.add(error);
        }
        return this;
    }
    ...
    public DataValidatorBuilder matchesRegularExpression(final String expression, final String Message) {
        ...
        if (this.value != null && !this.value.toString().matches(expression)) {
            String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".does.not.match.regexp";
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, Message, this.parameter, this.value, expression);
            this.dataValidationErrors.add(error);
        }
        return this;
    }
    ...
    public DataValidatorBuilder validatePhoneNumber() {
        ...
        if (validationErr) {
            ...
            String defaultEnglishMessage = "The parameter `" + this.parameter + "` is in invalid format, should contain \'-\',\'+\',\'()\' and numbers only.";
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, this.value);
            this.dataValidationErrors.add(error);
        }
        return this;
    ...
    public DataValidatorBuilder validateDateAfter(final LocalDate date) {
        ...
        if (this.value != null && date != null) {
            ...
            if (DateUtils.isAfter(date, dateVal)) {
                ...
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, dateVal, date);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public DataValidatorBuilder validateDateAfterOrEqual(final LocalDate date) {
        ...
        if (this.value != null && date != null) {
            ...
            if (DateUtils.isBefore(dateVal, date)) {
                ...
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` must be greater than or equal to the provided date: " + date;
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, dateVal, date);
                this.dataValidationErrors.add(error);
            }
        }
    ...
    public DataValidatorBuilder validateDateBeforeOrEqual(final LocalDate date) {
        ...
        if (this.value != null && date != null) {
            ...
            if (DateUtils.isAfter(dateVal, date)) {
                String validationErrorCode = "validation.msg." + this.resource + "." + this.parameter + ".is.greater.than.date";
                String defaultEnglishMessage = "The parameter `" + this.parameter + "` must be less than or equal to the provided date: " + date;
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, dateVal, date);
                this.dataValidationErrors.add(error);
            }
        }
    ...
    public DataValidatorBuilder scaleNotGreaterThan(Integer scale) {
        ...
        if (value.scale() > scale.intValue()) {
            ...
            String defaultEnglishMessage = "The parameter `" + this.parameter + "` value " + value + " decimal place must not be more than " + scale + " places";
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, value, scale);
            this.dataValidationErrors.add(error);
            return this;
        }
        return this;
    ...
    public DataValidatorBuilder validDateTimeFormatPattern() {
        ...
        if (this.value != null && this.value instanceof String pattern && !StringUtils.isBlank(pattern)) {
            try {
                ...
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode, defaultEnglishMessage, this.parameter, pattern);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    public static ApiParameterError buildValidationParameterApiError(final String resource, final String parameterName, final String errorCode, final String errorMessage, final Object... defaultUserMessageArgs) {
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return this.dataValidationErrors;
    }
}
