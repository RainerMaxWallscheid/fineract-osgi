...
public class ApiGlobalErrorResponse {
    ...
    public static ApiGlobalErrorResponse create(int statusCode, String msgCode, String developerMessage, String defaultUserMessage, List<ApiParameterError> errors) {
    ...
    public static ApiGlobalErrorResponse unAuthenticated() {
        return create(SC_UNAUTHORIZED, "error.msg.not.authenticated", "Invalid authentication details were passed in api request.", "Unauthenticated. Please login.");
    }

    public static ApiGlobalErrorResponse invalidTenantIdentifier() {
        return create(SC_UNAUTHORIZED, "error.msg.invalid.tenant.identifier", "Invalid tenant details were passed in api request.", "Invalid tenant identifier provided with request.");
    }

    public static ApiGlobalErrorResponse invalidInstanceTypeMethod(final String method) {
        return create(SC_METHOD_NOT_ALLOWED, "error.msg.invalid.instance.type", "Invalid instance type called in api request for the method " + method, "Invalid method " + method + " used with request to this instance type.");
    }
    ...
    public static ApiGlobalErrorResponse unAuthorized(final String defaultUserMessage) {
        ...
        return create(SC_FORBIDDEN, msgCode, "The user associated with credentials passed on this request does not have sufficient privileges to perform this action.", "Insufficient privileges to perform this action.", errors);
    }
    ...
    public static ApiGlobalErrorResponse domainRuleViolation(final String globalisationMessageCode, final String defaultUserMessage, final Object... defaultUserMessageArgs) {
        ...
        return create(SC_FORBIDDEN, "validation.msg.domain.rule.violation", "Request was understood but caused a domain rule violation.", "Errors contain reason for domain rule violation.", errors);
    }

    public static ApiGlobalErrorResponse notImplemented(final String globalisationMessageCode, final String defaultUserMessage, final Object... defaultUserMessageArgs) {
        final List<ApiParameterError> errors = new ArrayList<>();
        errors.add(ApiParameterError.generalError(globalisationMessageCode, defaultUserMessage, defaultUserMessageArgs));
        return create(SC_NOT_IMPLEMENTED, "validation.msg.not.implemented", "Request was understood but not implemented.", "Errors contain reason for not implemented violation.", errors);
    }
    ...
    public static ApiGlobalErrorResponse dataIntegrityError(final String globalisationMessageCode, final String defaultUserMessage, final String parameterName, final Object... defaultUserMessageArgs) {
        ...
        errors.add(ApiParameterError.parameterError(globalisationMessageCode, developerMessage, defaultUserMessage, parameterName, defaultUserMessageArgs));
    ...
    public static ApiGlobalErrorResponse badClientRequest(final String globalisationMessageCode, final String defaultUserMessage, final List<ApiParameterError> errors) {
        return create(SC_BAD_REQUEST, globalisationMessageCode, "The request was invalid. This typically will happen due to validation errors which are provided.", defaultUserMessage, errors);
    }
     ...
     */
    @java.lang.SuppressWarnings("all")
        protected void setDeveloperMessage(final String developerMessage) {
     ...
     */
    @java.lang.SuppressWarnings("all")
        protected void setHttpStatusCode(final String httpStatusCode) {
     ...
     */
    @java.lang.SuppressWarnings("all")
        protected void setDefaultUserMessage(final String defaultUserMessage) {
     ...
     */
    @java.lang.SuppressWarnings("all")
        protected void setUserMessageGlobalisationCode(final String userMessageGlobalisationCode) {
     ...
     */
    @java.lang.SuppressWarnings("all")
        protected void setErrors(final List<ApiParameterError> errors) {
        this.errors = errors;
    }
}
