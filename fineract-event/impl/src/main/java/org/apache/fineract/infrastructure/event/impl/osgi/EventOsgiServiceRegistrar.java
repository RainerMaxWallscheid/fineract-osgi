...
public class EventOsgiServiceRegistrar implements InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() {
        try {
            ...
            final Object bundle = getBundle.invoke(null, EventOsgiServiceRegistrar.class);
            if (bundle == null) {
                return;
            }
            ...
            LOG.warn("Failed to register event OSGi services: {}", ex.toString());
        }
    }
    ...
    private <T> void register(final Object context, final Class<T> type, final T service) throws ReflectiveOperationException {
        ...
        props.put("provider", "fineract-event-impl");
