...
/**
 * Empty notification-event port for Equinox without Spring/JPA.
 * Published by {@code OSGI-INF/event-notification.xml} (ADR-022 B6).
 */
public final class OsgiPortfolioNotificationEventPort implements PortfolioNotificationEventPort {
