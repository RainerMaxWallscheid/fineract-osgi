...
@Service
public class CodeValueAssociationBridge {

    public CodeValueAssociationBridge(final CodeValuePersistablePort port) {
        CodeValueAssociation.setPersistablePort(port);
    }
}
