...
public class StateTransitionWorkingCapitalLoanByExternalIdCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        final CommandProcessingResult commandProcessingResult = workingCapitalLoanApiResource.stateTransitionByExternalId(loanExternalId, command, request.getBody());
    ...
    @java.lang.SuppressWarnings("all")
        public StateTransitionWorkingCapitalLoanByExternalIdCommandStrategy(final WorkingCapitalLoanApiResource workingCapitalLoanApiResource, final DefaultToApiJsonSerializer<CommandProcessingResult> toApiJsonSerializer) {
