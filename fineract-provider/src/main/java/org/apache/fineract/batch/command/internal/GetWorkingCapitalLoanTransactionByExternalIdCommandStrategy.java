...
public class GetWorkingCapitalLoanTransactionByExternalIdCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        final WorkingCapitalLoanTransactionData workingCapitalLoanTransactionData = workingCapitalLoanTransactionsApiResource.retrieveTransactionByExternalLoanIdAndTransactionExternalId(loanExternalId, transactionExternalId);
    ...
    @java.lang.SuppressWarnings("all")
        public GetWorkingCapitalLoanTransactionByExternalIdCommandStrategy(final WorkingCapitalLoanTransactionsApiResource workingCapitalLoanTransactionsApiResource, final DefaultToApiJsonSerializer<CommandProcessingResult> toApiJsonSerializer) {
