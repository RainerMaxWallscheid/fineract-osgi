...
public class CreateWorkingCapitalTransactionByLoanExternalIdCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(BatchRequest request, UriInfo uriInfo) {
        ...
        final CommandProcessingResult commandProcessingResult = workingCapitalLoanTransactionsApiResource.executeLoanTransactionByExternalId(loanExternalId, command, request.getBody());
    ...
    @java.lang.SuppressWarnings("all")
        public CreateWorkingCapitalTransactionByLoanExternalIdCommandStrategy(final WorkingCapitalLoanTransactionsApiResource workingCapitalLoanTransactionsApiResource, final DefaultToApiJsonSerializer<CommandProcessingResult> toApiJsonSerializer) {
