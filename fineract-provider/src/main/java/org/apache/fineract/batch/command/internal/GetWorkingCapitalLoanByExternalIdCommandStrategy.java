...
public class GetWorkingCapitalLoanByExternalIdCommandStrategy implements CommandStrategy {
    ...
    @java.lang.SuppressWarnings("all")
        public GetWorkingCapitalLoanByExternalIdCommandStrategy(final WorkingCapitalLoanApiResource workingCapitalLoanApiResource, final DefaultToApiJsonSerializer<CommandProcessingResult> toApiJsonSerializer) {
