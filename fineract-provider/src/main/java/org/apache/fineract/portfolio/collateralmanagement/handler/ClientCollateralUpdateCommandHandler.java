...
public class ClientCollateralUpdateCommandHandler implements CommandHandler<ClientCollateralUpdateRequest, ClientCollateralUpdateResponse> {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ClientCollateralUpdateCommandHandler.class);
    ...
    @java.lang.SuppressWarnings("all")
        public ClientCollateralUpdateCommandHandler(final ClientCollateralManagementWriteService writeService) {
