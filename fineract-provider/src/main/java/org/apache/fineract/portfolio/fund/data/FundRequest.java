...
public class FundRequest implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (!(o instanceof FundRequest)) return false;
        final FundRequest other = (FundRequest) o;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return other instanceof FundRequest;
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return "FundRequest(name=" + this.getName() + ", externalId=" + this.getExternalId() + ")";
    }
