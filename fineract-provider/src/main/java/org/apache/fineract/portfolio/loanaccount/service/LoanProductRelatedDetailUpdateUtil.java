...
public class LoanProductRelatedDetailUpdateUtil {
    public Map<String, Object> updateLoanRepaymentSchedule(final LoanProductRelatedDetail loanRepaymentScheduleDetail, final JsonCommand command, final AprCalculator aprCalculator) {
        ...
        if (command.isChangeInStringParameterNamed(loanScheduleTypeParamName, loanRepaymentScheduleDetail.getLoanScheduleType().toString())) {
        ...
        if (command.isChangeInStringParameterNamed(loanScheduleProcessingTypeParamName, loanRepaymentScheduleDetail.getLoanScheduleProcessingType().toString())) {
            LoanScheduleProcessingType newLoanScheduleProcessingType = LoanScheduleProcessingType.valueOf(command.stringValueOfParameterNamed(loanScheduleProcessingTypeParamName));
        ...
        if (command.isChangeInIntegerParameterNamed(repaymentFrequencyTypeParamName, loanRepaymentScheduleDetail.getRepaymentPeriodFrequencyType().getValue())) {
        ...
        if (command.isChangeInIntegerParameterNamed(amortizationTypeParamName, loanRepaymentScheduleDetail.getAmortizationMethod().getValue())) {
        ...
        if (command.isChangeInBigDecimalParameterNamed(inArrearsToleranceParamName, loanRepaymentScheduleDetail.getInArrearsTolerance().getAmount())) {
        ...
        if (command.isChangeInBigDecimalParameterNamed(interestRatePerPeriodParamName, loanRepaymentScheduleDetail.getNominalInterestRatePerPeriod())) {
        ...
        final int interestPeriodFrequencyType = loanRepaymentScheduleDetail.getInterestPeriodFrequencyType() == null ? PeriodFrequencyType.INVALID.getValue() : loanRepaymentScheduleDetail.getInterestPeriodFrequencyType().getValue();
        ...
        if (command.isChangeInIntegerParameterNamed(interestCalculationPeriodTypeParamName, loanRepaymentScheduleDetail.getInterestCalculationPeriodMethod().getValue())) {
        ...
        if (command.isChangeInBooleanParameterNamed(LoanProductConstants.ALLOW_PARTIAL_PERIOD_INTEREST_CALCUALTION_PARAM_NAME, loanRepaymentScheduleDetail.isAllowPartialPeriodInterestCalculation())) {
        ...
        if (command.isChangeInIntegerParameterNamed(graceOnPrincipalPaymentParamName, loanRepaymentScheduleDetail.getGraceOnPrincipalPayment())) {
        ...
        if (command.isChangeInIntegerParameterNamed(recurringMoratoriumOnPrincipalPeriodsParamName, loanRepaymentScheduleDetail.getRecurringMoratoriumOnPrincipalPeriods())) {
        ...
        if (command.isChangeInIntegerParameterNamed(graceOnInterestPaymentParamName, loanRepaymentScheduleDetail.getGraceOnInterestPayment())) {
        ...
        if (command.isChangeInIntegerParameterNamed(graceOnInterestChargedParamName, loanRepaymentScheduleDetail.getGraceOnInterestCharged())) {
        ...
        if (command.isChangeInIntegerParameterNamed(LoanProductConstants.GRACE_ON_ARREARS_AGEING_PARAMETER_NAME, loanRepaymentScheduleDetail.getGraceOnArrearsAgeing())) {
        ...
        if (command.isChangeInIntegerParameterNamed(LoanProductConstants.DAYS_IN_MONTH_TYPE_PARAMETER_NAME, loanRepaymentScheduleDetail.getDaysInMonthType())) {
        ...
        if (command.isChangeInIntegerParameterNamed(LoanProductConstants.DAYS_IN_YEAR_TYPE_PARAMETER_NAME, loanRepaymentScheduleDetail.getDaysInYearType())) {
        ...
        if (command.parameterExists(LoanProductConstants.DAYS_IN_YEAR_CUSTOM_STRATEGY_TYPE_PARAMETER_NAME)) {
            final DaysInYearCustomStrategyType newValue = DaysInYearCustomStrategyType.valueOf(command.stringValueOfParameterNamed(LoanProductConstants.DAYS_IN_YEAR_CUSTOM_STRATEGY_TYPE_PARAMETER_NAME));
        ...
        if (command.isChangeInBooleanParameterNamed(LoanProductConstants.IS_INTEREST_RECALCULATION_ENABLED_PARAMETER_NAME, loanRepaymentScheduleDetail.isInterestRecalculationEnabled())) {
        ...
        if (command.isChangeInBooleanParameterNamed(LoanProductConstants.IS_EQUAL_AMORTIZATION_PARAM, loanRepaymentScheduleDetail.isEqualAmortization())) {
        ...
        if (command.isChangeInBooleanParameterNamed(LoanProductConstants.INTEREST_RECOGNITION_ON_DISBURSEMENT_DATE, loanRepaymentScheduleDetail.isInterestRecognitionOnDisbursementDate())) {
        ...
        if (command.isChangeInBooleanParameterNamed(LoanProductConstants.ENABLE_INCOME_CAPITALIZATION_PARAM_NAME, loanRepaymentScheduleDetail.isEnableIncomeCapitalization())) {
            final boolean newValue = command.booleanPrimitiveValueOfParameterNamed(LoanProductConstants.ENABLE_INCOME_CAPITALIZATION_PARAM_NAME);
        ...
        if (command.parameterExists(LoanProductConstants.CAPITALIZED_INCOME_CALCULATION_TYPE_PARAM_NAME)) {
            final LoanCapitalizedIncomeCalculationType newValue = command.enumValueOfParameterNamed(LoanProductConstants.CAPITALIZED_INCOME_CALCULATION_TYPE_PARAM_NAME, LoanCapitalizedIncomeCalculationType.class);
        ...
        if (command.parameterExists(LoanProductConstants.CAPITALIZED_INCOME_STRATEGY_PARAM_NAME)) {
            final LoanCapitalizedIncomeStrategy newValue = command.enumValueOfParameterNamed(LoanProductConstants.CAPITALIZED_INCOME_STRATEGY_PARAM_NAME, LoanCapitalizedIncomeStrategy.class);
        ...
        if (command.parameterExists(LoanProductConstants.CAPITALIZED_INCOME_TYPE_PARAM_NAME)) {
            final LoanCapitalizedIncomeType newValue = command.enumValueOfParameterNamed(LoanProductConstants.CAPITALIZED_INCOME_TYPE_PARAM_NAME, LoanCapitalizedIncomeType.class);
        ...
        if (command.isChangeInBooleanParameterNamed(LoanProductConstants.ENABLE_BUY_DOWN_FEE_PARAM_NAME, loanRepaymentScheduleDetail.isEnableBuyDownFee())) {
        ...
        if (command.parameterExists(LoanProductConstants.BUY_DOWN_FEE_CALCULATION_TYPE_PARAM_NAME)) {
            final LoanBuyDownFeeCalculationType newValue = command.enumValueOfParameterNamed(LoanProductConstants.BUY_DOWN_FEE_CALCULATION_TYPE_PARAM_NAME, LoanBuyDownFeeCalculationType.class);
        ...
        if (command.parameterExists(LoanProductConstants.BUY_DOWN_FEE_STRATEGY_PARAM_NAME)) {
            final LoanBuyDownFeeStrategy newValue = command.enumValueOfParameterNamed(LoanProductConstants.BUY_DOWN_FEE_STRATEGY_PARAM_NAME, LoanBuyDownFeeStrategy.class);
        ...
        if (command.parameterExists(LoanProductConstants.BUY_DOWN_FEE_INCOME_TYPE_PARAM_NAME)) {
            final LoanBuyDownFeeIncomeType newValue = command.enumValueOfParameterNamed(LoanProductConstants.BUY_DOWN_FEE_INCOME_TYPE_PARAM_NAME, LoanBuyDownFeeIncomeType.class);
        ...
        if (command.isChangeInBooleanParameterNamed(LoanProductConstants.MERCHANT_BUY_DOWN_FEE_PARAM_NAME, loanRepaymentScheduleDetail.isMerchantBuyDownFee())) {
    ...
    public void updateInterestRateDerivedFields(final LoanProductRelatedDetail loanRepaymentScheduleDetail, final AprCalculator aprCalculator) {
