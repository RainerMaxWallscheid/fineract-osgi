...
public class InterestRateChartSlabsWriteServiceImpl implements InterestRateChartSlabsWriteService {
    ...
    public InterestRateChartSlabsCreateResponse createInterestRateChartSlab(InterestRateChartSlabsCreateRequest request) {
        ...
        final BigDecimal annualInterestRate = request.getAnnualInterestRate() != null ? BigDecimal.valueOf(request.getAnnualInterestRate()) : null;
        final InterestRateChartSlabFields slabFields = InterestRateChartSlabFields.createNew(request.getDescription(), periodType, request.getFromPeriod(), request.getToPeriod(), null, null, annualInterestRate, null);
    ...
    private void assembleIncentives(List<InterestRateChartSlabsCreateRequest.Incentive> incentives, InterestRateChartSlab interestRateChartSlab) {
        for (InterestRateChartSlabsCreateRequest.Incentive incentive : incentives) {
            final InterestIncentivesFields fields = InterestIncentivesFields.createNew(incentive.getEntityType(), incentive.getAttributeName(), incentive.getConditionType(), incentive.getAttributeValue(), incentive.getIncentiveType(), incentive.getAmount(), null);
    ...
    @java.lang.SuppressWarnings("all")
        public InterestRateChartSlabsWriteServiceImpl(final InterestRateChartRepositoryWrapper interestRateChartRepository, final InterestRateChartSlabRepository chartSlabRepository) {
