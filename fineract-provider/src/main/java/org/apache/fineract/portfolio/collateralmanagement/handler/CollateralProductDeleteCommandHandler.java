...
@Component
public class CollateralProductDeleteCommandHandler implements CommandHandler<CollateralProductDeleteRequest, CollateralProductDeleteResponse> {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CollateralProductDeleteCommandHandler.class);
    ...
    @java.lang.SuppressWarnings("all")
        public CollateralProductDeleteCommandHandler(final CollateralManagementWriteService writeService) {
