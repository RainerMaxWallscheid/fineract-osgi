...
public class FixedDepositAccountApplicationApprovalUndoCommandHandler implements NewCommandSourceHandler {
    ...
    @java.lang.SuppressWarnings("all")
        public FixedDepositAccountApplicationApprovalUndoCommandHandler(final DepositApplicationProcessWritePlatformService depositAccountWritePlatformService) {
