...
public class NotesApiResource {
    ...
    @Operation(summary = "Retrieve a Resource\'s description", description = """
        ...
        """)
    public List<NoteData> retrieveNotesByResource(@PathParam("resourceType") final String resourceType, @PathParam("resourceId") final Long resourceId) {
    ...
    @Operation(summary = "Retrieve a Resource Note", description = """
        ...
        """)
    public NoteData retrieveNote(@PathParam("resourceType") final String resourceType, @PathParam("resourceId") final Long resourceId, @PathParam("noteId") final Long noteId) {
    ...
    @Operation(summary = "Add a Resource Note", description = """
        ...
        - groups/1/notes
        """)
    public NoteCreateResponse addNewNote(@PathParam("resourceType") final String resourceType, @PathParam("resourceId") final Long resourceId, @Valid final NoteCreateRequest request) {
    ...
    @Operation(summary = "Update a Resource Note", description = """
        ...
        """)
    public NoteUpdateResponse updateNote(@PathParam("resourceType") final String resourceType, @PathParam("resourceId") final Long resourceId, @PathParam("noteId") final Long noteId, @Valid final NoteUpdateRequest request) {
        final var type = NoteType.fromApiUrl(resourceType);
        if (type == null) {
            throw new NoteResourceNotSupportedException(resourceType);
        }
    ...
    @Operation(summary = "Delete a Resource Note", description = """
        ...
        """)
    public NoteDeleteResponse deleteNote(@PathParam("resourceType") final String resourceType, @PathParam("resourceId") final Long resourceId, @PathParam("noteId") final Long noteId) {
        final var type = NoteType.fromApiUrl(resourceType);
        if (type == null) {
            throw new NoteResourceNotSupportedException(resourceType);
        }
    ...
    @java.lang.SuppressWarnings("all")
        public NotesApiResource(final NoteReadPlatformService readPlatformService, final CommandDispatcher dispatcher) {
