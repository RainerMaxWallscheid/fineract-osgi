...
public class ShareProductDropdownReadPlatformServiceImpl implements ShareProductDropdownReadPlatformService {
    ...
    public Collection<EnumOptionData> retrieveLockinPeriodFrequencyTypeOptions() {
        final List<EnumOptionData> allowedLockinPeriodFrequencyTypeOptions = Arrays.asList(SharesEnumerations.lockinPeriodFrequencyType(SharePeriodFrequencyType.DAYS), SharesEnumerations.lockinPeriodFrequencyType(SharePeriodFrequencyType.WEEKS), SharesEnumerations.lockinPeriodFrequencyType(SharePeriodFrequencyType.MONTHS), SharesEnumerations.lockinPeriodFrequencyType(SharePeriodFrequencyType.YEARS));
    ...
    public Collection<EnumOptionData> retrieveMinimumActivePeriodFrequencyTypeOptions() {
        final List<EnumOptionData> minimumActivePeriodFrequencyTypeOptions = Arrays.asList(SharesEnumerations.lockinPeriodFrequencyType(SharePeriodFrequencyType.DAYS));
        return minimumActivePeriodFrequencyTypeOptions;
    }

    @java.lang.SuppressWarnings("all")
        public ShareProductDropdownReadPlatformServiceImpl() {
    }
}
