...
@Component
public class InterestRateChartSlabsUpdateCommandHandler implements CommandHandler<InterestRateChartSlabsUpdateRequest, InterestRateChartSlabsUpdateResponse> {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(InterestRateChartSlabsUpdateCommandHandler.class);
    ...
    @java.lang.SuppressWarnings("all")
        public InterestRateChartSlabsUpdateCommandHandler(final InterestRateChartSlabsWriteService writePlatformService) {
