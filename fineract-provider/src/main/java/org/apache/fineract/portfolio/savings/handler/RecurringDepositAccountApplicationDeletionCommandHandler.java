...
public class RecurringDepositAccountApplicationDeletionCommandHandler implements NewCommandSourceHandler {
    ...
    @java.lang.SuppressWarnings("all")
        public RecurringDepositAccountApplicationDeletionCommandHandler(final DepositApplicationProcessWritePlatformService depositAccountWritePlatformService) {
