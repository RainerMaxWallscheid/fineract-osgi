...
public class LoanCollateralDeleteCommandHandler implements CommandHandler<LoanCollateralDeleteRequest, LoanCollateralDeleteResponse> {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LoanCollateralDeleteCommandHandler.class);
    ...
    @java.lang.SuppressWarnings("all")
        public LoanCollateralDeleteCommandHandler(final LoanCollateralManagementWriteService writeService) {
