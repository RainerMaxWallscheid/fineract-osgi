 ...
 * {@code TaxCatalogPort}, {@code ContentStoreService}, {@code CashierTxnValidationPort}, and
 * {@code LoanOriginatorReadPlatformService} are {@code @Primary} lookup façades when Equinox is on — Boot consumers
