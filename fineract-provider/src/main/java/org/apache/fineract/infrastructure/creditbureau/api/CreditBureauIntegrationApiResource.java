...
public class CreditBureauIntegrationApiResource {
    ...
    @RequestBody(description = "Fetch credit report", content = {@Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = Object.class))})
    ...
    @RequestBody(description = "Upload credit report", content = {@Content(mediaType = MediaType.MULTIPART_FORM_DATA, schema = @Schema(implementation = UploadRequest.class))})
    public String addCreditReport(@FormDataParam("file") final File creditReport, @FormDataParam("file") InputStream uploadedInputStream, @FormDataParam("file") final UriInfo uriInfo, @FormDataParam("file") FormDataContentDisposition fileDetail, @QueryParam("creditBureauId") @Parameter(description = "creditBureauId") final Long creditBureauId) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public String saveCreditReport(@Parameter(hidden = true) final String apiRequestBodyAsJson, @QueryParam("creditBureauId") @Parameter(description = "creditBureauId") final Long creditBureauId, @QueryParam("nationalId") @Parameter(description = "nationalId") final String nationalId) {
        final CommandWrapper commandRequest =  //
        // apiRequestBodyAsJson is
        // a creditReport
        new CommandWrapperBuilder().saveCreditReport(creditBureauId, nationalId).withJson(apiRequestBodyAsJson).build(); //
        final CommandProcessingResult result = this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
        return this.toCreditReportApiJsonSerializer.serialize(result);
    }
    ...
    @Produces({MediaType.APPLICATION_JSON})
    public String getSavedCreditReport(@PathParam("creditBureauId") @Parameter(description = "creditBureauId") final Long creditBureauId, @Context final UriInfo uriInfo) {
