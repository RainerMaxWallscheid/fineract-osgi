...
public class ConfigurationDomainServiceJpa implements ConfigurationDomainService {
    ...
    public List<String> getAllowedLoanStatusesForExternalAssetTransfer() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ALLOWED_LOAN_STATUSES_FOR_EXTERNAL_ASSET_TRANSFER);
    ...
    public List<String> getAllowedLoanStatusesOfDelayedSettlementForExternalAssetTransfer() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ALLOWED_LOAN_STATUSES_OF_DELAYED_SETTLEMENT_FOR_EXTERNAL_ASSET_TRANSFER);
        return List.of(property.getStringValue().split(","));
    }
    ...
    public boolean isRescheduleFutureRepaymentsEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.RESCHEDULE_FUTURE_REPAYMENTS);
    ...
    public boolean allowTransactionsOnHolidayEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ALLOW_TRANSACTIONS_ON_HOLIDAY);
        return property.isEnabled();
    }

    @Override
    public boolean allowTransactionsOnNonWorkingDayEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ALLOW_TRANSACTIONS_ON_NON_WORKING_DAY);
        return property.isEnabled();
    }

    @Override
    public boolean isConstraintApproachEnabledForDatatables() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.CONSTRAINT_APPROACH_FOR_DATATABLES);
        return property.isEnabled();
    }
    ...
    public Long retrievePenaltyWaitPeriod() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.PENALTY_WAIT_PERIOD);
        return property.getValue();
    }

    @Override
    public Long retrieveGraceOnPenaltyPostingPeriod() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.GRACE_ON_PENALTY_POSTING);
        return property.getValue();
    }

    @Override
    public boolean isPasswordForcedResetEnable() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.FORCE_PASSWORD_RESET_DAYS);
        return property.isEnabled();
    }
    ...
    public Long retrieveOpeningBalancesContraAccount() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.OFFICE_OPENING_BALANCES_CONTRA_ACCOUNT);
        return property.getValue();
    }

    @Override
    public boolean isSavingsInterestPostingAtCurrentPeriodEnd() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.SAVINGS_INTEREST_POSTING_CURRENT_PERIOD_END);
        return property.isEnabled();
    }

    @Override
    public Integer retrieveFinancialYearBeginningMonth() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.FINANCIAL_YEAR_BEGINNING_MONTH);
        if (property.isEnabled()) {
    ...
    public Integer retrieveMinAllowedClientsInGroup() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.MIN_CLIENTS_IN_GROUP);
        if (property.isEnabled()) {
            return property.getValue().intValue();
        }
        return null;
    ...
    public Integer retrieveMaxAllowedClientsInGroup() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.MAX_CLIENTS_IN_GROUP);
        if (property.isEnabled()) {
            return property.getValue().intValue();
        }
        return null;
    ...
    public boolean isMeetingMandatoryForJLGLoans() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.MEETINGS_MANDATORY_FOR_JLG_LOANS);
        return property.isEnabled();
    }
    ...
    public boolean isBackdatePenaltiesEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.BACKDATE_PENALTIES_ENABLED);
        return property.isEnabled();
    }

    @Override
    public boolean isOrganisationstartDateEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ORGANISATION_START_DATE);
        return property.isEnabled();
    }
    ...
    public boolean isPaymentTypeApplicableForDisbursementCharge() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.PAYMENT_TYPE_APPLICABLE_FOR_DISBURSEMENT_CHARGES);
        return property.isEnabled();
    }
    ...
    public boolean isFirstRepaymentDateAfterRescheduleAllowedOnHoliday() {
        return getGlobalConfigurationPropertyData(GlobalConfigurationConstants.LOAN_RESCHEDULE_IS_FIRST_PAYDAY_ALLOWED_ON_HOLIDAY).isEnabled();
    }

    @Override
    public boolean isInterestToBeRecoveredFirstWhenGreaterThanEMI() {
        return getGlobalConfigurationPropertyData(GlobalConfigurationConstants.IS_INTEREST_TO_BE_RECOVERED_FIRST_WHEN_GREATER_THAN_EMI).isEnabled();
    }

    @Override
    public boolean isPrincipalCompoundingDisabledForOverdueLoans() {
        return getGlobalConfigurationPropertyData(GlobalConfigurationConstants.IS_PRINCIPAL_COMPOUNDING_DISABLED_FOR_OVERDUE_LOANS).isEnabled();
    }

    @Override
    public Long retreivePeriodInNumberOfDaysForSkipMeetingDate() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.SKIP_REPAYMENT_ON_FIRST_DAY_OF_MONTH);
        return property.getValue();
    }

    @Override
    public boolean isInterestChargedFromDateSameAsDisbursementDate() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.INTEREST_CHARGED_FROM_DATE_SAME_AS_DISBURSAL_DATE);
        return property.isEnabled();
    }

    @Override
    public boolean isChangeEmiIfRepaymentDateSameAsDisbursementDateEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.CHANGE_EMI_IF_REPAYMENT_DATE_SAME_AS_DISBURSEMENT_DATE);
        return property.isEnabled();
    }
    ...
    public boolean retrievePivotDateConfig() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ALLOW_BACKDATED_TRANSACTION_BEFORE_INTEREST_POSTING);
        return !property.isEnabled();
    }

    @Override
    public boolean isRelaxingDaysConfigForPivotDateEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ALLOW_BACKDATED_TRANSACTION_BEFORE_INTEREST_POSTING_DATE_FOR_DAYS);
        return property.isEnabled();
    }
    ...
    public String getAccountMappingForPaymentType() {
        ...
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ACCOUNT_MAPPING_FOR_PAYMENT_TYPE);
        if (property.isEnabled()) {
    ...
    public String getAccountMappingForCharge() {
        ...
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ACCOUNT_MAPPING_FOR_CHARGE);
        if (property.isEnabled()) {
            String value = property.getStringValue();
            if (StringUtils.isBlank(value)) {
                return defaultValue;
    ...
    public boolean isNextDayFixedDepositInterestTransferEnabledForPeriodEnd() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.FIXED_DEPOSIT_TRANSFER_INTEREST_NEXT_DAY_FOR_PERIOD_END_POSTING);
        return property.isEnabled();
    }
    ...
    public boolean isReversalTransactionAllowed() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ENABLE_POST_REVERSAL_TXNS_FOR_REVERSE_TRANSACTIONS);
        return property.isEnabled();
    }

    @Override
    public Long retrieveExternalEventsPurgeDaysCriteria() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.PURGE_EXTERNAL_EVENTS_OLDER_THAN_DAYS);
        return property.getValue();
    }

    @Override
    public Long retrieveProcessedCommandsPurgeDaysCriteria() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.PURGE_PROCESSED_COMMANDS_OLDER_THAN_DAYS);
        return property.getValue();
    }

    @Override
    public Long retrieveRepaymentDueDays() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.DAYS_BEFORE_REPAYMENT_IS_DUE);
        return property.getValue();
    }

    @Override
    public Long retrieveRepaymentOverdueDays() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.DAYS_AFTER_REPAYMENT_IS_OVERDUE);
        return property.getValue();
    }

    @Override
    public boolean isExternalIdAutoGenerationEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ENABLE_AUTO_GENERATED_EXTERNAL_ID);
        return property.isEnabled();
    }
    ...
    public boolean isCOBBulkEventEnabled() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ENABLE_COB_BULK_EVENT);
        return property.isEnabled();
    }

    @Override
    public Long retrieveExternalEventBatchSize() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.EXTERNAL_EVENT_BATCH_SIZE);
        return property.getValue();
    }

    @Override
    public String retrieveReportExportS3FolderName() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.REPORT_EXPORT_S3_FOLDER_NAME);
    ...
    public String getAccrualDateConfigForCharge() {
        ...
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.CHARGE_ACCRUAL_DATE);
        String value = property.getStringValue();
        if (StringUtils.isBlank(value)) {
            return defaultValue;
        }
    ...
    public String getNextPaymentDateConfigForLoan() {
        ...
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.NEXT_PAYMENT_DUE_DATE);
        String value = property.getStringValue();
        if (StringUtils.isBlank(value)) {
            return defaultValue;
        }
    ...
    public String getAssetOwnerTransferOustandingInterestStrategy() {
        return getGlobalConfigurationPropertyData(GlobalConfigurationConstants.ASSET_OWNER_TRANSFER_OUTSTANDING_INTEREST_CALCULATION_STRATEGY).getStringValue();
    }
    ...
    public Integer getPasswordReuseRestrictionCount() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.PASSWORD_REUSE_CHECK_HISTORY_COUNT);
        if (!property.isEnabled()) {
            return null;
        }
    ...
    public Integer retrieveMaxLoginRetries() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.MAX_LOGIN_RETRY_ATTEMPTS);
    ...
    public String getIncomeExpenseGlAccounts() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.INCOME_EXPENSE_GL_ACCOUNTS);
        return property.getStringValue();
    }

    @Override
    public String getRetainedEarningGlAccount() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.RETAINED_EARNING_GL_ACCOUNT);
        return property.getStringValue();
    }

    @Override
    public Long getLastDayOfFinancialYear() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.LAST_DAY_OF_FINANCIAL_YEAR);
        return property.getValue();
    }

    @Override
    public Long getLastMonthOfFinancialYear() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.LAST_MONTH_OF_FINANCIAL_YEAR);
        return property.getValue();
    }

    @Override
    public String getRetainedEarningUsedByReportName() {
        final GlobalConfigurationPropertyData property = getGlobalConfigurationPropertyData(GlobalConfigurationConstants.RETAINED_EARNING_USED_BY_REPORT_NAME);
        return property.getStringValue();
    }
