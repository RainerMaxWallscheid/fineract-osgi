...
public class SmsCampaignMapper implements RowMapper<SmsCampaignData> {
    ...
    public SmsCampaignData mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        final SmsCampaignTimeLine smsCampaignTimeLine = new SmsCampaignTimeLine(submittedOnDate, submittedByUsername, activatedOnDate, activatedByUsername, closedOnDate, closedByUsername);
        ...
        return SmsCampaignData.instance(id, campaignName, campaignTypeEnum, triggerTypeEnum, runReportId, reportName, paramValue, status, message, nextTriggerDate, lastTriggerDate, smsCampaignTimeLine, recurrenceStartDate, recurrence, providerId, isNotification);
    }
