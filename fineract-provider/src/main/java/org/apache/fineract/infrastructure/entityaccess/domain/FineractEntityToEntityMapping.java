...
public class FineractEntityToEntityMapping extends AbstractPersistableCustom<Long> {
     ...
     */
    @java.lang.SuppressWarnings("all")
        public FineractEntityToEntityMapping setRelationId(final FineractEntityRelation relationId) {
     ...
     */
    @java.lang.SuppressWarnings("all")
        public FineractEntityToEntityMapping setFromId(final Long fromId) {
        this.fromId = fromId;
        return this;
    }
     ...
     */
    @java.lang.SuppressWarnings("all")
        public FineractEntityToEntityMapping setToId(final Long toId) {
        this.toId = toId;
        return this;
    }
     ...
     */
    @java.lang.SuppressWarnings("all")
        public FineractEntityToEntityMapping setStartDate(final LocalDate startDate) {
     ...
     */
    @java.lang.SuppressWarnings("all")
        public FineractEntityToEntityMapping setEndDate(final LocalDate endDate) {
