...
public class ReportsApiResource {
    private static final Set<String> RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList("id", "reportName", "reportType", "reportSubType", "reportCategory", "description", "reportSql", "coreReport", "useReport", "reportParameters"));
    ...
    public String updateReport(@PathParam("id") @Parameter(description = "id") final Long id, @Parameter(hidden = true) final String apiRequestBodyAsJson) {
    ...
    @java.lang.SuppressWarnings("all")
        public ReportsApiResource(final PlatformSecurityContext context, final ToApiJsonSerializer<ReportData> toApiJsonSerializer, final ReadReportingService readReportingService, final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService, final ApiRequestParameterHelper apiRequestParameterHelper, final ReportingProcessServiceProvider reportingProcessServiceProvider) {
