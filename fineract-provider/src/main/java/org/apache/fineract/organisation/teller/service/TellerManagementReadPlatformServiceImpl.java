...
public class TellerManagementReadPlatformServiceImpl implements TellerManagementReadPlatformService {
    ...
    private static final class TellerMapper implements RowMapper<TellerData> {
        ...
        public TellerData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            return TellerData.instance(id, officeId, debitAccountId, creditAccountId, tellerName, description, startDate, endDate, tellerStatus, officeName, null, null);
        }
    }
    ...
    public CashierTransactionData retrieveCashierTxnTemplate(Long cashierId) {
        ...
        return CashierTransactionData.template(cashierId, tellerId, tellerName, officeId, officeName, cashierName, cashierData, startDate, endDate, currencyOptions);
    }

    @Override
    public CashierTransactionsWithSummaryData retrieveCashierTransactionsWithSummary(final Long cashierId, final boolean includeAllTellers, final LocalDate fromDate, final LocalDate toDate, final String currencyCode, final SearchParameters searchParameters) {
        ...
        final Page<CashierTransactionData> cashierTransactions = retrieveCashierTransactions(cashierId, includeAllTellers, fromDate, toDate, currencyCode, searchParameters);
        CashierTransactionData cashierTxnTemplate = retrieveCashierTxnTemplate(cashierId);
        CashierTransactionsWithSummaryData txnsWithSummary = CashierTransactionsWithSummaryData.instance(cashierTransactions, allocAmount, cashInAmount, cashOutAmount, settleAmount, cashierTxnTemplate.getOfficeName(), cashierTxnTemplate.getTellerId(), cashierTxnTemplate.getTellerName(), cashierTxnTemplate.getCashierId(), cashierTxnTemplate.getCashierName());
        return txnsWithSummary;
    }

    @Override
    public Page<CashierTransactionData> retrieveCashierTransactions(final Long cashierId, final boolean includeAllTellers, final LocalDate fromDate, final LocalDate toDate, final String currencyCode, final SearchParameters searchParameters) {
        sqlValidator.validate(searchParameters.getOrderBy());
        sqlValidator.validate(searchParameters.getSortOrder());
        final String nextDay = sqlGenerator.incrementDateByOneDay("c.end_date");
    ...
    private static final class CashierMapper implements RowMapper<CashierData> {
        ...
        public CashierData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            return CashierData.instance(id, null, null, staffId, staffName, tellerId, tellerName, description, startDate, endDate, fullDay, startTime, endTime);
        }
    }
    ...
    private static final class CashierTransactionMapper implements RowMapper<CashierTransactionData> {
        ...
        public String loansTxnSchema() {
            ...
            sqlBuilder.append(" left join r_enum_value renum on loan_txn.transaction_type_enum = renum.enum_id and renum.enum_name = \'loan_transaction_type_enum\' ");
        ...
        public String clientTxnSchema() {
            ...
            sqlBuilder.append(" concat (renum.enum_value, \', Client:\', cl.id, \'-\', cl.account_no, \',Client:\', cl.id, \'-\',cl.display_name) as txn_note, ");
            ...
            sqlBuilder.append(" left join r_enum_value renum on cli_txn.transaction_type_enum = renum.enum_id AND renum.enum_name = \'client_transaction_type_enum\' ");
        ...
        public CashierTransactionData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            return CashierTransactionData.instance(id, cashierId, txnType, txnAmount, txnDate, txnNote, entityType, entityId, createdDate, officeId, officeName, tellerId, tellerName, cashierName, null, null, null);
        }
    }
