...
public class SetLoanDelinquencyTagsBusinessStep implements LoanCOBBusinessStep {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SetLoanDelinquencyTagsBusinessStep.class);
    ...
    public Loan execute(Loan loan) {
        ...
        measure(new Runnable() {
            ...
            public void run() {
                try {
                    log.debug("Starting delinquency tag processing for loan with Id [{}], account number [{}], external Id [{}]", loan.getId(), loan.getAccountNumber(), externalId);
                    ...
                    log.error("Received [{}] exception while processing delinquency tag for loan with Id [{}], account number [{}], external Id [{}]", re.getMessage(), loan.getId(), loan.getAccountNumber(), externalId, re);
                    throw re;
                } finally {
            ...
            log.debug("Ending delinquency tag processing for loan with Id [{}], account number [{}], external Id [{}], finished in [{}]ms", loan.getId(), loan.getAccountNumber(), externalId, duration.toMillis());
        });
        return loan;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public SetLoanDelinquencyTagsBusinessStep(final LoanAccountDomainService loanAccountDomainService, final DelinquencyEffectivePauseHelper delinquencyEffectivePauseHelper, final DelinquencyReadPlatformService delinquencyReadPlatformService, final BusinessEventNotifierService businessEventNotifierService) {
