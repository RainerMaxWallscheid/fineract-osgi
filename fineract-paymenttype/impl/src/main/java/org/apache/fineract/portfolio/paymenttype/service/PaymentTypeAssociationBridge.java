...
@Service
public class PaymentTypeAssociationBridge {

    public PaymentTypeAssociationBridge(final PaymentTypePersistablePort port) {
        PaymentTypeAssociation.setPersistablePort(port);
    }
}
