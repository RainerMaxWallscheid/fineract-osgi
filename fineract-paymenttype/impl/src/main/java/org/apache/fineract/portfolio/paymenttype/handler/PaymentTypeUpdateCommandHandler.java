...
public class PaymentTypeUpdateCommandHandler implements CommandHandler<PaymentTypeUpdateRequest, PaymentTypeUpdateResponse> {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PaymentTypeUpdateCommandHandler.class);
    ...
    @java.lang.SuppressWarnings("all")
        public PaymentTypeUpdateCommandHandler(final PaymentTypeWriteService paymentTypeWriteService) {
