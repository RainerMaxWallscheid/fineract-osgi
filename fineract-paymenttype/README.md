...
| `fineract-paymenttype-impl` | `impl/` | `org.apache.fineract.paymenttype.impl` | REST, handlers, MapStruct mappers, services, starter; Equinox DS `OSGI-INF/paymenttype.xml` |
