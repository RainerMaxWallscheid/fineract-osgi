...
public class MixReportXBRLBuilder {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MixReportXBRLBuilder.class);
    ...
    private Element addTaxonomy(final Element rootElement, final MixTaxonomyData taxonomy, final BigDecimal value, final Date startDate, final Date endDate, Integer instantScenarioCounter, Integer durationScenarioCounter, final Map<MixReportXBRLContextData, String> contextMap) {
        ...
        if (dimension != null) {
            ...
            if (dims.size() == 2) {
                context = new MixReportXBRLContextData().setDimensionType(dims.get(0)).setDimension(dims.get(1)).setPeriodType(taxonomy.getType().equals(MixTaxonomyData.BALANCE_SHEET) || taxonomy.getType().equals(MixTaxonomyData.PORTFOLIO) ? 0 : 1);
            }
        }
        if (context == null) {
            context = new MixReportXBRLContextData().setPeriodType(taxonomy.getType().equals(MixTaxonomyData.BALANCE_SHEET) || taxonomy.getType().equals(MixTaxonomyData.PORTFOLIO) ? 0 : 1);
        }
        if (!contextMap.containsKey(context)) {
            ...
            final String contextRefID = context.getPeriodType() == 0 ? "As_Of_" + endDateStr + instantScenarioCounter : "Duration_" + startDateStr + "_To_" + endDateStr + durationScenarioCounter;
    ...
    private void addContexts(final Element root, final Date startDate, final Date endDate, final Map<MixReportXBRLContextData, String> contextMap) {
    ...
    @java.lang.SuppressWarnings("all")
        public MixReportXBRLBuilder(final MixReportXBRLNamespaceReadService readNamespaceService) {
