...
| `fineract-mix-impl` | `impl/` | `org.apache.fineract.mix.impl` | JPA domain, REST, MapStruct, XBRL builder; Equinox `MixOsgiBundleActivator` (empty catalog, lowest ranking) |
