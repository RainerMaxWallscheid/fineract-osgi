...
public class UpdateExternalAssetOwnerLoanProductAttributeHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        ...
        return externalAssetOwnerLoanProductAttributesWriteService.updateExternalAssetOwnerLoanProductAttribute(command, attributeKey, attributeValue);
    }

    @java.lang.SuppressWarnings("all")
        public UpdateExternalAssetOwnerLoanProductAttributeHandler(final FromJsonHelper fromApiJsonHelper, final ExternalAssetOwnerLoanProductAttributesWriteService externalAssetOwnerLoanProductAttributesWriteService) {
