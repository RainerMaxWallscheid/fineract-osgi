...
public class RecurringDepositAccountApplicationSubmittalCommandHandler implements NewCommandSourceHandler {
    ...
    @java.lang.SuppressWarnings("all")
        public RecurringDepositAccountApplicationSubmittalCommandHandler(final DepositApplicationProcessWritePlatformService depositAccountWritePlatformService) {
