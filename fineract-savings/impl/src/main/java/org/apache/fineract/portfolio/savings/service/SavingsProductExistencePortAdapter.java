...
@Service
public class SavingsProductExistencePortAdapter implements SavingsProductExistencePort {

    private final SavingsProductRepository savingsProductRepository;

    public SavingsProductExistencePortAdapter(final SavingsProductRepository savingsProductRepository) {
