...
public class SavingsAccountTransactionsApiResource {
    ...
    private String retrieveTemplate(final Long savingsId, final String savingsExternalIdStr, final UriInfo uriInfo) {
        ...
        SavingsAccountTransactionData savingsAccount = this.savingsAccountReadPlatformService.retrieveDepositTransactionTemplate(resolvedSavingsId, DepositAccountType.SAVINGS_DEPOSIT);
        ...
        return this.toApiJsonSerializer.serialize(settings, savingsAccount, SavingsApiSetConstants.SAVINGS_TRANSACTION_RESPONSE_DATA_PARAMETERS);
    }
    ...
    public String retrieveOne(@PathParam("savingsId") final Long savingsId, @PathParam("transactionId") final Long transactionId, @Context final UriInfo uriInfo) {
    ...
    public String retrieveOne(@PathParam("savingsExternalId") final String savingsExternalId, @PathParam("transactionId") final Long transactionId, @Context final UriInfo uriInfo) {
    ...
    private String retrieveOne(final Long savingsId, final String savingsExternalIdStr, final Long transactionId, final String transactionExternalIdStr, final UriInfo uriInfo) {
        ...
        return this.toApiJsonSerializer.serialize(settings, transactionData, SavingsApiSetConstants.SAVINGS_TRANSACTION_RESPONSE_DATA_PARAMETERS);
    }
    ...
    public String retrieveOne(@PathParam("savingsId") final Long savingsId, @PathParam("transactionExternalId") final String transactionExternalId, @Context final UriInfo uriInfo) {
    ...
    public String retrieveOne(@PathParam("savingsExternalId") final String savingsExternalId, @PathParam("transactionExternalId") final String transactionExternalId, @Context final UriInfo uriInfo) {
    ...
    public String searchTransactions(@PathParam("savingsId") @Parameter(description = "savings account id") final Long savingsId, @QueryParam("fromDate") @Parameter(description = "minimum value date (inclusive)", example = "2023-08-08") final String fromDate, @QueryParam("toDate") @Parameter(description = "maximum value date (inclusive)", example = "2023-08-15") final String toDate, @QueryParam("fromSubmittedDate") @Parameter(description = "minimum booking date (inclusive)", example = "2023-08-08") final String fromSubmittedDate, @QueryParam("toSubmittedDate") @Parameter(description = "maximum booking date (inclusive)", example = "2023-08-15") final String toSubmittedDate, @QueryParam("fromAmount") @Parameter(description = "minimum transaction amount (inclusive)", example = "1000") final BigDecimal fromAmount, @QueryParam("toAmount") @Parameter(description = "maximum transaction amount (inclusive)", example = "50000000") final BigDecimal toAmount, @QueryParam("types") @Parameter(description = "transaction types", example = "1,2,4,20,21") final String types, @QueryParam("credit") @Parameter(description = "credit") final Boolean credit, @QueryParam("debit") @Parameter(description = "debit") final Boolean debit, @QueryParam("offset") @Parameter(description = "offset") final Integer offset, @QueryParam("limit") @Parameter(description = "limit") final Integer limit, @QueryParam("orderBy") @Parameter(description = "sort properties", example = "createdDate,transactionDate,id") final String orderBy, @QueryParam("sortOrder") @Parameter(description = "sort direction") final Sort.Direction sortOrder, @QueryParam("locale") @Parameter(description = "locale") final String localeString, @QueryParam("dateFormat") @Parameter(description = "date format", example = "yyyy-MM-dd") String dateFormat) {
        return searchTransactions(savingsId, null, fromDate, toDate, fromSubmittedDate, toSubmittedDate, fromAmount, toAmount, types, credit, debit, offset, limit, orderBy, sortOrder, localeString, dateFormat);
    }
    ...
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.SavingsAccountTransactionsSearchResponse.class)))
    public String searchTransactions(@PathParam("savingsExternalId") @Parameter(description = "savings account external ID") final String savingsExternalId, @QueryParam("fromDate") @Parameter(description = "minimum value date (inclusive)", example = "2023-08-08") final String fromDate, @QueryParam("toDate") @Parameter(description = "maximum value date (inclusive)", example = "2023-08-15") final String toDate, @QueryParam("fromSubmittedDate") @Parameter(description = "minimum booking date (inclusive)", example = "2023-08-08") final String fromSubmittedDate, @QueryParam("toSubmittedDate") @Parameter(description = "maximum booking date (inclusive)", example = "2023-08-15") final String toSubmittedDate, @QueryParam("fromAmount") @Parameter(description = "minimum transaction amount (inclusive)", example = "1000") final BigDecimal fromAmount, @QueryParam("toAmount") @Parameter(description = "maximum transaction amount (inclusive)", example = "50000000") final BigDecimal toAmount, @QueryParam("types") @Parameter(description = "transaction types", example = "1,2,4,20,21") final String types, @QueryParam("credit") @Parameter(description = "credit") final Boolean credit, @QueryParam("debit") @Parameter(description = "debit") final Boolean debit, @QueryParam("offset") @Parameter(description = "offset") final Integer offset, @QueryParam("limit") @Parameter(description = "limit") final Integer limit, @QueryParam("orderBy") @Parameter(description = "sort properties", example = "createdDate,transactionDate,id") final String orderBy, @QueryParam("sortOrder") @Parameter(description = "sort direction") final Sort.Direction sortOrder, @QueryParam("locale") @Parameter(description = "locale") final String localeString, @QueryParam("dateFormat") @Parameter(description = "date format", example = "yyyy-MM-dd") final String dateFormat) {
        return searchTransactions(null, savingsExternalId, fromDate, toDate, fromSubmittedDate, toSubmittedDate, fromAmount, toAmount, types, credit, debit, offset, limit, orderBy, sortOrder, localeString, dateFormat);
    }

    private String searchTransactions(final Long savingsId, final String savingsExternalIdStr, final String fromDate, final String toDate, final String fromSubmittedDate, final String toSubmittedDate, final BigDecimal fromAmount, final BigDecimal toAmount, final String types, final Boolean credit, final Boolean debit, final Integer offset, final Integer limit, final String orderBy, final Sort.Direction sortOrder, final String localeString, final String dateFormat) {
        final Long resolvedSavingsId = getResolvedSavingsId(savingsId, ExternalIdFactory.produce(savingsExternalIdStr));
        final Locale locale = localeString == null ? null : JsonParserHelper.localeFromString(localeString);
        TransactionSearchRequest searchParameters = new TransactionSearchRequest().accountId(resolvedSavingsId).fromDate(fromDate, dateFormat, locale).toDate(toDate, dateFormat, locale).fromSubmittedDate(fromSubmittedDate, dateFormat, locale).toSubmittedDate(toSubmittedDate, dateFormat, locale).fromAmount(fromAmount).toAmount(toAmount).types(types).credit(credit).debit(debit).pageable(offset, limit, orderBy, sortOrder);
        Page<SavingsAccountTransactionData> transactionsData = transactionsSearchService.searchTransactions(resolvedSavingsId, searchParameters);
    ...
    public String advancedQuery(@PathParam("savingsId") @Parameter(description = "savingsId") final Long savingsId, PagedLocalRequest<AdvancedQueryRequest> queryRequest, @Context final UriInfo uriInfo) {
    ...
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = List.class)))
    public String advancedQuery(@PathParam("savingsExternalId") @Parameter(description = "savings account external ID") final String savingsExternalId, PagedLocalRequest<AdvancedQueryRequest> queryRequest, @Context final UriInfo uriInfo) {
        return advancedQuery(null, savingsExternalId, queryRequest, uriInfo);
    }

    private String advancedQuery(final Long savingsId, final String savingsExternalIdStr, final PagedLocalRequest<AdvancedQueryRequest> queryRequest, final UriInfo uriInfo) {
        final Long resolvedSavingsId = getResolvedSavingsId(savingsId, ExternalIdFactory.produce(savingsExternalIdStr));
    ...
    public String transaction(@PathParam("savingsId") final Long savingsId, @QueryParam("command") final String commandParam, final String apiRequestBodyAsJson) {
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountTransactionsRequest.class)))
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountTransactionsResponse.class)))
    public String transaction(@PathParam("savingsExternalId") final String savingsExternalId, @QueryParam("command") final String commandParam, final String apiRequestBodyAsJson) {
        return transaction(null, savingsExternalId, commandParam, apiRequestBodyAsJson);
    }

    private String transaction(final Long savingsId, final String savingsExternalIdStr, final String commandParam, final String apiRequestBodyAsJson) {
        final Long resolvedSavingsId = getResolvedSavingsId(savingsId, ExternalIdFactory.produce(savingsExternalIdStr));
        ...
        final CommandWrapper commandRequest = switch (StringUtils.trimToEmpty(commandParam)) {
            ...
            default -> throw new UnrecognizedQueryParamException("command", commandParam, "deposit", "withdrawal", "force-withdrawal", SavingsApiConstants.COMMAND_HOLD_AMOUNT);
        };
    ...
    public String adjustTransaction(@PathParam("savingsId") final Long savingsId, @PathParam("transactionId") final Long transactionId, @QueryParam("command") final String commandParam, final String apiRequestBodyAsJson) {
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountBulkReversalTransactionsRequest.class)))
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountBulkReversalTransactionsRequest.class))))
    public String adjustTransaction(@PathParam("savingsExternalId") final String savingsExternalId, @PathParam("transactionId") final Long transactionId, @QueryParam("command") final String commandParam, final String apiRequestBodyAsJson) {
        return adjustTransaction(null, savingsExternalId, transactionId, null, commandParam, apiRequestBodyAsJson);
    }

    private String adjustTransaction(final Long savingsId, final String savingsExternalIdStr, final Long transactionId, final String transactionExternalIdStr, final String commandParam, final String apiRequestBodyAsJson) {
        final Long resolvedSavingsId = getResolvedSavingsId(savingsId, ExternalIdFactory.produce(savingsExternalIdStr));
        final Long resolvedTransactionId = getResolvedSavingsTransactionId(resolvedSavingsId, transactionId, ExternalIdFactory.produce(transactionExternalIdStr));
        ...
        final CommandWrapper commandRequest = switch (StringUtils.trimToEmpty(commandParam)) {
            case SavingsApiConstants.COMMAND_UNDO_TRANSACTION -> builder.undoSavingsAccountTransaction(resolvedSavingsId, resolvedTransactionId).build();
            case SavingsApiConstants.COMMAND_REVERSE_TRANSACTION -> builder.reverseSavingsAccountTransaction(resolvedSavingsId, resolvedTransactionId).build();
            case SavingsApiConstants.COMMAND_ADJUST_TRANSACTION -> builder.adjustSavingsAccountTransaction(resolvedSavingsId, resolvedTransactionId).build();
            case SavingsApiConstants.COMMAND_RELEASE_AMOUNT -> builder.releaseAmount(resolvedSavingsId, resolvedTransactionId).build();
            default -> throw new UnrecognizedQueryParamException("command", commandParam, SavingsApiConstants.COMMAND_UNDO_TRANSACTION, SavingsApiConstants.COMMAND_ADJUST_TRANSACTION, SavingsApiConstants.COMMAND_RELEASE_AMOUNT, SavingsApiConstants.COMMAND_REVERSE_TRANSACTION);
        };
        final CommandProcessingResult result = this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
        return this.toApiJsonSerializer.serialize(result);
    }
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountBulkReversalTransactionsRequest.class)))
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountBulkReversalTransactionsRequest.class))))
    public String adjustTransaction(@PathParam("savingsId") final Long savingsId, @PathParam("transactionExternalId") final String transactionExternalId, @QueryParam("command") final String commandParam, final String apiRequestBodyAsJson) {
    ...
    @RequestBody(required = true, content = @Content(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountBulkReversalTransactionsRequest.class)))
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = SavingsAccountTransactionsApiResourceSwagger.PostSavingsAccountBulkReversalTransactionsRequest.class))))
    public String adjustTransaction(@PathParam("savingsExternalId") final String savingsExternalId, @PathParam("transactionExternalId") final String transactionExternalId, @QueryParam("command") final String commandParam, final String apiRequestBodyAsJson) {
    ...
    private Long getResolvedSavingsTransactionId(final Long resolvedSavingsId, final Long transactionId, final ExternalId externalTransactionId) {
