...
public class PayDueSavingsChargesTasklet implements Tasklet {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PayDueSavingsChargesTasklet.class);
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        log.debug("{}: Records affected by applyDueChargesForSavings: {}", ThreadLocalContextUtil.getTenant().getName(), chargesDueData.size());
    ...
    @java.lang.SuppressWarnings("all")
        public PayDueSavingsChargesTasklet(final SavingsAccountChargeReadPlatformService savingsAccountChargeReadPlatformService, final SavingsAccountWritePlatformService savingsAccountWritePlatformService) {
