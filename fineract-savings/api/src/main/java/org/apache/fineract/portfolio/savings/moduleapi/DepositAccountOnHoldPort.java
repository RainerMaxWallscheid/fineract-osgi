 ...
 * must not depend on leftover {@code DepositAccountOnHoldTransaction} /
 * {@code SavingsAccount} graphs.
 */
public interface DepositAccountOnHoldPort {

    Object hold(Long savingsAccountId, BigDecimal amount, LocalDate date);
