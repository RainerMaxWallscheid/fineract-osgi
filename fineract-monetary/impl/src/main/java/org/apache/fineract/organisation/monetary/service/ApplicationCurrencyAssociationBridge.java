...
@Service
public class ApplicationCurrencyAssociationBridge {

    public ApplicationCurrencyAssociationBridge(final ApplicationCurrencyPersistablePort port) {
        ApplicationCurrencyAssociation.setPersistablePort(port);
    }
}
