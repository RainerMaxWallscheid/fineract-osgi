...
public class Base64EncoderContentProcessor implements ContentProcessor {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(Base64EncoderContentProcessor.class);
    ...
    public ContentProcessorContext process(final ContentProcessorContext ctx) {
        final Integer bufferSize = ctx.getParameter(BASE64_ENCODE_PARAM_BUFFER_SIZE, Integer.class, requireNonNullElse(properties.getContent().getDefaultBufferSize(), 8192));
    ...
    @java.lang.SuppressWarnings("all")
        public Base64EncoderContentProcessor(final ContentStreamPort pipe, final FineractProperties properties) {
        this.pipe = pipe;
