...
public class DocumentCreateResponse implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
        public static class DocumentCreateResponseBuilder {
        @java.lang.SuppressWarnings("all")
                private Long resourceId;
        @java.lang.SuppressWarnings("all")
                private String resourceIdentifier;
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateResponse.DocumentCreateResponseBuilder resourceId(final Long resourceId) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateResponse.DocumentCreateResponseBuilder resourceIdentifier(final String resourceIdentifier) {
        ...
        @java.lang.SuppressWarnings("all")
            ...
            return new DocumentCreateResponse(this.resourceId, this.resourceIdentifier);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
                public java.lang.String toString() {
            return "DocumentCreateResponse.DocumentCreateResponseBuilder(resourceId=" + this.resourceId + ", resourceIdentifier=" + this.resourceIdentifier + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
        public static DocumentCreateResponse.DocumentCreateResponseBuilder builder() {
        return new DocumentCreateResponse.DocumentCreateResponseBuilder();
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (!(o instanceof DocumentCreateResponse)) return false;
        final DocumentCreateResponse other = (DocumentCreateResponse) o;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return other instanceof DocumentCreateResponse;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
        return "DocumentCreateResponse(resourceId=" + this.getResourceId() + ", resourceIdentifier=" + this.getResourceIdentifier() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
        public DocumentCreateResponse(final Long resourceId, final String resourceIdentifier) {
        this.resourceId = resourceId;
        this.resourceIdentifier = resourceIdentifier;
    }
}
