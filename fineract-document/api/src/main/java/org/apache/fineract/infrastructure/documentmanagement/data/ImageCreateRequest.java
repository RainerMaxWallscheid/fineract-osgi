...
public class ImageCreateRequest implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
        public static class ImageCreateRequestBuilder {
        @java.lang.SuppressWarnings("all")
                private String entityType;
        @java.lang.SuppressWarnings("all")
                private Long entityId;
         ...
         */
        @java.lang.SuppressWarnings("all")
                public ImageCreateRequest.ImageCreateRequestBuilder entityType(final String entityType) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public ImageCreateRequest.ImageCreateRequestBuilder entityId(final Long entityId) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public ImageCreateRequest.ImageCreateRequestBuilder fileName(final String fileName) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public ImageCreateRequest.ImageCreateRequestBuilder size(final Long size) {
            this.size = size;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public ImageCreateRequest.ImageCreateRequestBuilder type(final String type) {
            this.type = type;
            return this;
        }
        ...
        @JsonIgnore
        @java.lang.SuppressWarnings("all")
                public ImageCreateRequest.ImageCreateRequestBuilder stream(final InputStream stream) {
            this.stream = stream;
            return this;
        }
        ...
        @java.lang.SuppressWarnings("all")
            ...
            return new ImageCreateRequest(this.entityType, this.entityId, this.fileName, this.size, this.type, this.stream);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
                public java.lang.String toString() {
            return "ImageCreateRequest.ImageCreateRequestBuilder(entityType=" + this.entityType + ", entityId=" + this.entityId + ", fileName=" + this.fileName + ", size=" + this.size + ", type=" + this.type + ", stream=" + this.stream + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
        public static ImageCreateRequest.ImageCreateRequestBuilder builder() {
        return new ImageCreateRequest.ImageCreateRequestBuilder();
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (!(o instanceof ImageCreateRequest)) return false;
        final ImageCreateRequest other = (ImageCreateRequest) o;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return other instanceof ImageCreateRequest;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
        return "ImageCreateRequest(entityType=" + this.getEntityType() + ", entityId=" + this.getEntityId() + ", fileName=" + this.getFileName() + ", size=" + this.getSize() + ", type=" + this.getType() + ", stream=" + this.getStream() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
        public ImageCreateRequest(final String entityType, final Long entityId, final String fileName, final Long size, final String type, final InputStream stream) {
        this.entityType = entityType;
        this.entityId = entityId;
        this.fileName = fileName;
        this.size = size;
