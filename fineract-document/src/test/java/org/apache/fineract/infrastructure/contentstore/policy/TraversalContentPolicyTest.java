...
class TraversalContentPolicyTest {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TraversalContentPolicyTest.class);
    @Autowired
    private TraversalContentPolicy traversalContentPolicy;

    @Test
    void pathTraversal() {
        var paths = List.of("/tmp/../17/michael.vorburger-crepes.jpg", "../17/michael.vorburger-crepes.jpg", "/tmp/..//17//michael.vorburger-crepes.jpg", "/tmp/..//17/michael.vorburger-crepes.jpg", "..//17/michael.vorburger-crepes.jpg", "../../../../../../../../../../tmp/michael.vorburger-crepes.jpg", "/tmp/../../../../../../../../../../tmp/image-text-wrong-content.jsp", "../../../../../../../../../../tmp/image-text-wrong-content.jsp", "/test/../tmp/image-text-wrong-content.jsp");
        paths.forEach(path -> {
