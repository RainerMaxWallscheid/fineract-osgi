...
class ContentProcessorTest {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ContentProcessorTest.class);
    @Autowired
    ...
    private void write(ContentProcessorContext ctx, String fileName) {
        try (
            ...
            var out = Files.newOutputStream(java.nio.file.Path.of("build/" + fileName))) {
            is.transferTo(out);
        } catch (Exception e) {
