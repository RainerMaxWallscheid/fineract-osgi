...
public class ImageDeleteResponse implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
        public static class ImageDeleteResponseBuilder {
        @java.lang.SuppressWarnings("all")
                private Long resourceId;
        @java.lang.SuppressWarnings("all")
                private String resourceIdentifier;
         ...
         */
        @java.lang.SuppressWarnings("all")
                public ImageDeleteResponse.ImageDeleteResponseBuilder resourceId(final Long resourceId) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public ImageDeleteResponse.ImageDeleteResponseBuilder resourceIdentifier(final String resourceIdentifier) {
            this.resourceIdentifier = resourceIdentifier;
            return this;
        }

        @java.lang.SuppressWarnings("all")
                public ImageDeleteResponse build() {
            return new ImageDeleteResponse(this.resourceId, this.resourceIdentifier);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
                public java.lang.String toString() {
            return "ImageDeleteResponse.ImageDeleteResponseBuilder(resourceId=" + this.resourceId + ", resourceIdentifier=" + this.resourceIdentifier + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
        public static ImageDeleteResponse.ImageDeleteResponseBuilder builder() {
        return new ImageDeleteResponse.ImageDeleteResponseBuilder();
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (!(o instanceof ImageDeleteResponse)) return false;
        final ImageDeleteResponse other = (ImageDeleteResponse) o;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return other instanceof ImageDeleteResponse;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
        return "ImageDeleteResponse(resourceId=" + this.getResourceId() + ", resourceIdentifier=" + this.getResourceIdentifier() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
        public ImageDeleteResponse(final Long resourceId, final String resourceIdentifier) {
        this.resourceId = resourceId;
        this.resourceIdentifier = resourceIdentifier;
    }
}
