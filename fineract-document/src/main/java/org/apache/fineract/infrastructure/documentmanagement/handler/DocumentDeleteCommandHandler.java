...
public class DocumentDeleteCommandHandler implements CommandHandler<DocumentDeleteRequest, DocumentDeleteResponse> {
    @java.lang.SuppressWarnings("all")
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DocumentDeleteCommandHandler.class);
    ...
    @java.lang.SuppressWarnings("all")
        public DocumentDeleteCommandHandler(final DocumentWritePlatformService writePlatformService) {
