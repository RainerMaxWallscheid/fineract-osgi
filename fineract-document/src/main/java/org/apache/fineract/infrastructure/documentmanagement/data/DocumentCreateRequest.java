...
public class DocumentCreateRequest implements Serializable {
    ...
    @java.lang.SuppressWarnings("all")
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder entityType(final String entityType) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder entityId(final Long entityId) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder name(final String name) {
            this.name = name;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder description(final String description) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder fileName(final String fileName) {
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder size(final Long size) {
            this.size = size;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder type(final String type) {
            this.type = type;
            return this;
        }
        ...
        @JsonIgnore
        @java.lang.SuppressWarnings("all")
                public DocumentCreateRequest.DocumentCreateRequestBuilder stream(final InputStream stream) {
            this.stream = stream;
            return this;
        }
        ...
        @java.lang.SuppressWarnings("all")
            ...
            return new DocumentCreateRequest(this.entityType, this.entityId, this.name, this.description, this.fileName, this.size, this.type, this.stream);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
                public java.lang.String toString() {
            return "DocumentCreateRequest.DocumentCreateRequestBuilder(entityType=" + this.entityType + ", entityId=" + this.entityId + ", name=" + this.name + ", description=" + this.description + ", fileName=" + this.fileName + ", size=" + this.size + ", type=" + this.type + ", stream=" + this.stream + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
        public static DocumentCreateRequest.DocumentCreateRequestBuilder builder() {
        return new DocumentCreateRequest.DocumentCreateRequestBuilder();
    }
    ...
    @java.lang.SuppressWarnings("all")
        ...
        if (!(o instanceof DocumentCreateRequest)) return false;
        final DocumentCreateRequest other = (DocumentCreateRequest) o;
    ...
    @java.lang.SuppressWarnings("all")
        ...
        return other instanceof DocumentCreateRequest;
    }
    ...
    @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
        return "DocumentCreateRequest(entityType=" + this.getEntityType() + ", entityId=" + this.getEntityId() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", fileName=" + this.getFileName() + ", size=" + this.getSize() + ", type=" + this.getType() + ", stream=" + this.getStream() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
        public DocumentCreateRequest(final String entityType, final Long entityId, final String name, final String description, final String fileName, final Long size, final String type, final InputStream stream) {
        this.entityType = entityType;
        this.entityId = entityId;
        this.name = name;
        this.description = description;
